...
int main(int argc, char *argv[]){
  ...
  3c:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
  43:	00 
  ...
  72:	75 19                	jne    8d <main+0x8d>
            printf(1,"thread_create fails\n");
  74:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
  7b:	00 
  ...
  aa:	75 19                	jne    c5 <main+0xc5>
            printf(1,"thread_create fails\n");
  ac:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
  b3:	00 
  ...
  e2:	75 19                	jne    fd <main+0xfd>
            printf(1,"thread_create fails\n");
  e4:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
  eb:	00 
 ...
 11a:	75 19                	jne    135 <main+0x135>
            printf(1,"thread_create fails\n");
 11c:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
 123:	00 
 ...
 13f:	a1 f8 10 00 00       	mov    0x10f8,%eax
 144:	89 44 24 08          	mov    %eax,0x8(%esp)
 148:	c7 44 24 04 f1 0c 00 	movl   $0xcf1,0x4(%esp)
 14f:	00 
 ...
 189:	75 19                	jne    1a4 <main+0x1a4>
            printf(1,"thread_create fails\n");
 18b:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
 192:	00 
 ...
 1c1:	75 19                	jne    1dc <main+0x1dc>
            printf(1,"thread_create fails\n");
 1c3:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
 1ca:	00 
 ...
 1f9:	75 19                	jne    214 <main+0x214>
            printf(1,"thread_create fails\n");
 1fb:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
 202:	00 
 ...
 231:	75 19                	jne    24c <main+0x24c>
            printf(1,"thread_create fails\n");
 233:	c7 44 24 04 dc 0c 00 	movl   $0xcdc,0x4(%esp)
 23a:	00 
 ...
 256:	a1 f8 10 00 00       	mov    0x10f8,%eax
 25b:	89 44 24 08          	mov    %eax,0x8(%esp)
 25f:	c7 44 24 04 09 0d 00 	movl   $0xd09,0x4(%esp)
 266:	00 
...
//    printf(1,"\n n = %d\n",n);
    n++;
 27e:	a1 f8 10 00 00       	mov    0x10f8,%eax
 283:	83 c0 01             	add    $0x1,%eax
 286:	a3 f8 10 00 00       	mov    %eax,0x10f8
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 639:	0f b6 80 fc 10 00 00 	movzbl 0x10fc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 796:	75 09                	jne    7a1 <printf+0x101>
          s = "(null)";
 798:	c7 45 f4 22 0d 00 00 	movl   $0xd22,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 862:	a1 1c 11 00 00       	mov    0x111c,%eax
...
free(void *ap)
{
 ...
 92d:	a3 1c 11 00 00       	mov    %eax,0x111c
}
 932:	c9                   	leave  
 933:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 980:	e8 ce fe ff ff       	call   853 <free>
  return freep;
 985:	a1 1c 11 00 00       	mov    0x111c,%eax
}
 98a:	c9                   	leave  
 98b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 99e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 9a1:	a1 1c 11 00 00       	mov    0x111c,%eax
 9a6:	89 45 f0             	mov    %eax,-0x10(%ebp)
 9a9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 9ad:	75 23                	jne    9d2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 9af:	c7 45 f0 14 11 00 00 	movl   $0x1114,-0x10(%ebp)
 9b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9b9:	a3 1c 11 00 00       	mov    %eax,0x111c
 9be:	a1 1c 11 00 00       	mov    0x111c,%eax
 9c3:	a3 14 11 00 00       	mov    %eax,0x1114
    base.s.size = 0;
 9c8:	c7 05 18 11 00 00 00 	movl   $0x0,0x1118
 9cf:	00 00 00 
  }
 ...
 a25:	a3 1c 11 00 00       	mov    %eax,0x111c
      return (void*)(p + 1);
 ...
 a30:	eb 38                	jmp    a6a <malloc+0xde>
    ...
    if(p == freep)
 a32:	a1 1c 11 00 00       	mov    0x111c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 b10:	c7 44 24 04 29 0d 00 	movl   $0xd29,0x4(%esp)
 b17:	00 
 ...
 b55:	c7 44 24 04 37 0d 00 	movl   $0xd37,0x4(%esp)
 b5c:	00 
 ...
 b81:	c7 44 24 04 44 0d 00 	movl   $0xd44,0x4(%esp)
 b88:	00 
...
int random(int max){
 ...
 b9f:	a1 10 11 00 00       	mov    0x1110,%eax
 ba4:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 baa:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 baf:	a3 10 11 00 00       	mov    %eax,0x1110
    return (int)(rands % max);
 bb4:	a1 10 11 00 00       	mov    0x1110,%eax
