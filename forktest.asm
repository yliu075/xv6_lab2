...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    102f:	c7 44 24 04 50 14 00 	movl   $0x1450,0x4(%esp)
    1036:	00 
    ...
    1062:	e8 16 03 00 00       	call   137d <exit>
{
  ...
  if(n == N){
    ...
    1084:	00 
    1085:	c7 44 24 04 5c 14 00 	movl   $0x145c,0x4(%esp)
    108c:	00 
  ...
  for(; n > 0; n--){
    ...
    10a9:	c7 44 24 04 7b 14 00 	movl   $0x147b,0x4(%esp)
    10b0:	00 
  ...
  if(wait() != -1){
    ...
    10d6:	c7 44 24 04 8f 14 00 	movl   $0x148f,0x4(%esp)
    10dd:	00 
  ...
  printf(1, "fork test OK\n");
    10ef:	c7 44 24 04 a2 14 00 	movl   $0x14a2,0x4(%esp)
    10f6:	00 
...
0000142d <tsleep>:
SYSCALL(tsleep)
    142d:	b8 18 00 00 00       	mov    $0x18,%eax
    1432:	cd 40                	int    $0x40
    1434:	c3                   	ret    

00001435 <twakeup>:
SYSCALL(twakeup)
    1435:	b8 19 00 00 00       	mov    $0x19,%eax
    143a:	cd 40                	int    $0x40
    143c:	c3                   	ret    

0000143d <thread_yield>:
SYSCALL(thread_yield)
    143d:	b8 1a 00 00 00       	mov    $0x1a,%eax
    1442:	cd 40                	int    $0x40
    1444:	c3                   	ret    

00001445 <thread_yield3>:
