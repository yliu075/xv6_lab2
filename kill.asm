...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 b3 0a 00 	movl   $0xab3,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	0f b6 80 80 0e 00 00 	movzbl 0xe80(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 56d:	75 09                	jne    578 <printf+0x101>
          s = "(null)";
 56f:	c7 45 f4 c7 0a 00 00 	movl   $0xac7,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 639:	a1 a0 0e 00 00       	mov    0xea0,%eax
...
free(void *ap)
{
 ...
 704:	a3 a0 0e 00 00       	mov    %eax,0xea0
}
 709:	c9                   	leave  
 70a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 757:	e8 ce fe ff ff       	call   62a <free>
  return freep;
 75c:	a1 a0 0e 00 00       	mov    0xea0,%eax
}
 761:	c9                   	leave  
 762:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 775:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 778:	a1 a0 0e 00 00       	mov    0xea0,%eax
 77d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 780:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 784:	75 23                	jne    7a9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 786:	c7 45 f0 98 0e 00 00 	movl   $0xe98,-0x10(%ebp)
 78d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 790:	a3 a0 0e 00 00       	mov    %eax,0xea0
 795:	a1 a0 0e 00 00       	mov    0xea0,%eax
 79a:	a3 98 0e 00 00       	mov    %eax,0xe98
    base.s.size = 0;
 79f:	c7 05 9c 0e 00 00 00 	movl   $0x0,0xe9c
 7a6:	00 00 00 
  }
 ...
 7fc:	a3 a0 0e 00 00       	mov    %eax,0xea0
      return (void*)(p + 1);
 ...
 807:	eb 38                	jmp    841 <malloc+0xde>
    ...
    if(p == freep)
 809:	a1 a0 0e 00 00       	mov    0xea0,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8e7:	c7 44 24 04 ce 0a 00 	movl   $0xace,0x4(%esp)
 8ee:	00 
 ...
 92c:	c7 44 24 04 dc 0a 00 	movl   $0xadc,0x4(%esp)
 933:	00 
 ...
 958:	c7 44 24 04 e9 0a 00 	movl   $0xae9,0x4(%esp)
 95f:	00 
...
int random(int max){
 ...
 976:	a1 94 0e 00 00       	mov    0xe94,%eax
 97b:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 981:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 986:	a3 94 0e 00 00       	mov    %eax,0xe94
    return (int)(rands % max);
 98b:	a1 94 0e 00 00       	mov    0xe94,%eax
