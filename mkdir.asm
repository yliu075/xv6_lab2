...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 db 0a 00 	movl   $0xadb,0x4(%esp)
  16:	00 
  ...
  66:	c7 44 24 04 f2 0a 00 	movl   $0xaf2,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 438:	0f b6 80 c8 0e 00 00 	movzbl 0xec8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 595:	75 09                	jne    5a0 <printf+0x101>
          s = "(null)";
 597:	c7 45 f4 0e 0b 00 00 	movl   $0xb0e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 e8 0e 00 00       	mov    0xee8,%eax
...
free(void *ap)
{
 ...
 72c:	a3 e8 0e 00 00       	mov    %eax,0xee8
}
 731:	c9                   	leave  
 732:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 77f:	e8 ce fe ff ff       	call   652 <free>
  return freep;
 784:	a1 e8 0e 00 00       	mov    0xee8,%eax
}
 789:	c9                   	leave  
 78a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a0:	a1 e8 0e 00 00       	mov    0xee8,%eax
 7a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ac:	75 23                	jne    7d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7ae:	c7 45 f0 e0 0e 00 00 	movl   $0xee0,-0x10(%ebp)
 7b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b8:	a3 e8 0e 00 00       	mov    %eax,0xee8
 7bd:	a1 e8 0e 00 00       	mov    0xee8,%eax
 7c2:	a3 e0 0e 00 00       	mov    %eax,0xee0
    base.s.size = 0;
 7c7:	c7 05 e4 0e 00 00 00 	movl   $0x0,0xee4
 7ce:	00 00 00 
  }
 ...
 824:	a3 e8 0e 00 00       	mov    %eax,0xee8
      return (void*)(p + 1);
 ...
 82f:	eb 38                	jmp    869 <malloc+0xde>
    ...
    if(p == freep)
 831:	a1 e8 0e 00 00       	mov    0xee8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 90f:	c7 44 24 04 15 0b 00 	movl   $0xb15,0x4(%esp)
 916:	00 
 ...
 954:	c7 44 24 04 23 0b 00 	movl   $0xb23,0x4(%esp)
 95b:	00 
 ...
 980:	c7 44 24 04 30 0b 00 	movl   $0xb30,0x4(%esp)
 987:	00 
...
int random(int max){
 ...
 99e:	a1 dc 0e 00 00       	mov    0xedc,%eax
 9a3:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 9a9:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 9ae:	a3 dc 0e 00 00       	mov    %eax,0xedc
    return (int)(rands % max);
 9b3:	a1 dc 0e 00 00       	mov    0xedc,%eax
 9b8:	8b 4d 08             	mov    0x8(%ebp),%ecx
 9bb:	ba 00 00 00 00       	mov    $0x0,%edx
 9c0:	f7 f1                	div    %ecx
...
void init_q(struct queue *q){
 ...
 9df:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
 9e6:	5d                   	pop    %ebp
 9e7:	c3                   	ret    
...
void add_q(struct queue *q, int v){
 ...
 9f5:	e8 91 fd ff ff       	call   78b <malloc>
...
int empty_q(struct queue *q){
 ...
 a52:	75 07                	jne    a5b <empty_q+0x13>
        return 1;
 a54:	b8 01 00 00 00       	mov    $0x1,%eax
 a59:	eb 05                	jmp    a60 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
 ...
 a6e:	e8 d5 ff ff ff       	call   a48 <empty_q>
 a73:	85 c0                	test   %eax,%eax
 a75:	75 5d                	jne    ad4 <pop_q+0x72>
       val = q->head->value; 
 ...
 ab9:	75 14                	jne    acf <pop_q+0x6d>
            q->head = 0;
 abb:	8b 45 08             	mov    0x8(%ebp),%eax
 abe:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
 ac5:	8b 45 08             	mov    0x8(%ebp),%eax
 ac8:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
 acf:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ad2:	eb 05                	jmp    ad9 <pop_q+0x77>
    }
    return -1;
 ad4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 ad9:	c9                   	leave  
 ada:	c3                   	ret    
