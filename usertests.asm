...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       ...
       b:	c7 44 24 04 82 44 00 	movl   $0x4482,0x4(%esp)
      12:	00 
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 6c 44 00 00 	movl   $0x446c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 5c 63 00 00       	mov    0x635c,%eax
      3d:	c7 44 24 04 8d 44 00 	movl   $0x448d,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 a0 44 00 00 	movl   $0x44a0,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 5c 63 00 00       	mov    0x635c,%eax
      7f:	c7 44 24 04 ad 44 00 	movl   $0x44ad,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 5c 63 00 00       	mov    0x635c,%eax
      99:	c7 44 24 04 cb 44 00 	movl   $0x44cb,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 5c 63 00 00       	mov    0x635c,%eax
      b6:	c7 44 24 04 d9 44 00 	movl   $0x44d9,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 ea 44 00 00 	movl   $0x44ea,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 5c 63 00 00       	mov    0x635c,%eax
      e8:	c7 44 24 04 f0 44 00 	movl   $0x44f0,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 5c 63 00 00       	mov    0x635c,%eax
     109:	c7 44 24 04 0b 45 00 	movl   $0x450b,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 27 45 00 	movl   $0x4527,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 5c 63 00 00       	mov    0x635c,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 34 45 00 	movl   $0x4534,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 58 45 00 	movl   $0x4558,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 5c 63 00 00       	mov    0x635c,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 64 45 00 	movl   $0x4564,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 5c 63 00 00       	mov    0x635c,%eax
     1b3:	c7 44 24 04 88 45 00 	movl   $0x4588,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 ea 44 00 00 	movl   $0x44ea,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 5c 63 00 00       	mov    0x635c,%eax
     1f0:	c7 44 24 04 93 45 00 	movl   $0x4593,0x4(%esp)
     1f7:	00 
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 5c 63 00 00       	mov    0x635c,%eax
     22e:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 5c 63 00 00       	mov    0x635c,%eax
     248:	c7 44 24 04 c7 45 00 	movl   $0x45c7,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 ea 44 00 00 	movl   $0x44ea,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 5c 63 00 00       	mov    0x635c,%eax
     27a:	c7 44 24 04 da 45 00 	movl   $0x45da,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 5c 63 00 00       	mov    0x635c,%eax
     294:	c7 44 24 04 e7 45 00 	movl   $0x45e7,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 5c 63 00 00       	mov    0x635c,%eax
     2ae:	c7 44 24 04 fc 45 00 	movl   $0x45fc,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 5c 63 00 00       	mov    0x635c,%eax
     2cb:	c7 44 24 04 10 46 00 	movl   $0x4610,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 20 46 00 00 	movl   $0x4620,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 5c 63 00 00       	mov    0x635c,%eax
     2fd:	c7 44 24 04 24 46 00 	movl   $0x4624,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 5c 63 00 00       	mov    0x635c,%eax
     34c:	8b 55 f4             	mov    -0xc(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 3e 46 00 	movl   $0x463e,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 20 46 00 00 	movl   $0x4620,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 5c 63 00 00       	mov    0x635c,%eax
     3a3:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3ec:	a1 5c 63 00 00       	mov    0x635c,%eax
     3f1:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f4:	89 54 24 08          	mov    %edx,0x8(%esp)
     3f8:	c7 44 24 04 75 46 00 	movl   $0x4675,0x4(%esp)
     3ff:	00 
  ...
  if(unlink("big") < 0){
     419:	c7 04 24 20 46 00 00 	movl   $0x4620,(%esp)
     ...
     438:	a1 5c 63 00 00       	mov    0x635c,%eax
     43d:	8b 55 f4             	mov    -0xc(%ebp),%edx
     440:	89 54 24 08          	mov    %edx,0x8(%esp)
     444:	c7 44 24 04 92 46 00 	movl   $0x4692,0x4(%esp)
     44b:	00 
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     49a:	a1 5c 63 00 00       	mov    0x635c,%eax
     49f:	c7 44 24 04 c4 46 00 	movl   $0x46c4,0x4(%esp)
     4a6:	00 
  ...
  printf(stdout, "big files ok\n");
     4b4:	a1 5c 63 00 00       	mov    0x635c,%eax
     4b9:	c7 44 24 04 d7 46 00 	movl   $0x46d7,0x4(%esp)
     4c0:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4d1:	a1 5c 63 00 00       	mov    0x635c,%eax
     4d6:	c7 44 24 04 e8 46 00 	movl   $0x46e8,0x4(%esp)
     4dd:	00 
     4de:	89 04 24             	mov    %eax,(%esp)
     4e1:	e8 e2 38 00 00       	call   3dc8 <printf>

  name[0] = 'a';
     4e6:	c6 05 40 ab 00 00 61 	movb   $0x61,0xab40
  name[2] = '\0';
     4ed:	c6 05 42 ab 00 00 00 	movb   $0x0,0xab42
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     503:	a2 41 ab 00 00       	mov    %al,0xab41
    fd = open(name, O_CREATE|O_RDWR);
     508:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50f:	00 
     510:	c7 04 24 40 ab 00 00 	movl   $0xab40,(%esp)
  ...
  name[0] = 'a';
     534:	c6 05 40 ab 00 00 61 	movb   $0x61,0xab40
  name[2] = '\0';
     53b:	c6 05 42 ab 00 00 00 	movb   $0x0,0xab42
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     551:	a2 41 ab 00 00       	mov    %al,0xab41
    unlink(name);
     556:	c7 04 24 40 ab 00 00 	movl   $0xab40,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56c:	a1 5c 63 00 00       	mov    0x635c,%eax
     571:	c7 44 24 04 10 47 00 	movl   $0x4710,0x4(%esp)
     578:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     589:	a1 5c 63 00 00       	mov    0x635c,%eax
     58e:	c7 44 24 04 36 47 00 	movl   $0x4736,0x4(%esp)
     595:	00 
     596:	89 04 24             	mov    %eax,(%esp)
     599:	e8 2a 38 00 00       	call   3dc8 <printf>

  if(mkdir("dir0") < 0){
     59e:	c7 04 24 42 47 00 00 	movl   $0x4742,(%esp)
     5a5:	e8 d6 36 00 00       	call   3c80 <mkdir>
     5aa:	85 c0                	test   %eax,%eax
     5ac:	79 1a                	jns    5c8 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ae:	a1 5c 63 00 00       	mov    0x635c,%eax
     5b3:	c7 44 24 04 47 47 00 	movl   $0x4747,0x4(%esp)
     5ba:	00 
  ...
  if(chdir("dir0") < 0){
     5c8:	c7 04 24 42 47 00 00 	movl   $0x4742,(%esp)
     5cf:	e8 b4 36 00 00       	call   3c88 <chdir>
     5d4:	85 c0                	test   %eax,%eax
     5d6:	79 1a                	jns    5f2 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d8:	a1 5c 63 00 00       	mov    0x635c,%eax
     5dd:	c7 44 24 04 55 47 00 	movl   $0x4755,0x4(%esp)
     5e4:	00 
  ...
  if(chdir("..") < 0){
     5f2:	c7 04 24 68 47 00 00 	movl   $0x4768,(%esp)
     5f9:	e8 8a 36 00 00       	call   3c88 <chdir>
     5fe:	85 c0                	test   %eax,%eax
     600:	79 1a                	jns    61c <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     602:	a1 5c 63 00 00       	mov    0x635c,%eax
     607:	c7 44 24 04 6b 47 00 	movl   $0x476b,0x4(%esp)
     60e:	00 
  ...
  if(unlink("dir0") < 0){
     61c:	c7 04 24 42 47 00 00 	movl   $0x4742,(%esp)
     623:	e8 40 36 00 00       	call   3c68 <unlink>
     628:	85 c0                	test   %eax,%eax
     62a:	79 1a                	jns    646 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62c:	a1 5c 63 00 00       	mov    0x635c,%eax
     631:	c7 44 24 04 7c 47 00 	movl   $0x477c,0x4(%esp)
     638:	00 
  ...
  printf(stdout, "mkdir test\n");
     646:	a1 5c 63 00 00       	mov    0x635c,%eax
     64b:	c7 44 24 04 36 47 00 	movl   $0x4736,0x4(%esp)
     652:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     663:	a1 5c 63 00 00       	mov    0x635c,%eax
     668:	c7 44 24 04 90 47 00 	movl   $0x4790,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 50 37 00 00       	call   3dc8 <printf>
  if(exec("echo", echoargv) < 0){
     678:	c7 44 24 04 48 63 00 	movl   $0x6348,0x4(%esp)
     67f:	00 
     680:	c7 04 24 6c 44 00 00 	movl   $0x446c,(%esp)
     687:	e8 c4 35 00 00       	call   3c50 <exec>
     68c:	85 c0                	test   %eax,%eax
     68e:	79 1a                	jns    6aa <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     690:	a1 5c 63 00 00       	mov    0x635c,%eax
     695:	c7 44 24 04 9b 47 00 	movl   $0x479b,0x4(%esp)
     69c:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6c1:	c7 44 24 04 ad 47 00 	movl   $0x47ad,0x4(%esp)
     6c8:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     71c:	81 c2 40 8b 00 00    	add    $0x8b40,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     73b:	00 
     73c:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     743:	00 
     ...
     753:	c7 44 24 04 bc 47 00 	movl   $0x47bc,0x4(%esp)
     75a:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7ac:	05 40 8b 00 00       	add    $0x8b40,%eax
     ...
     7c9:	c7 44 24 04 ca 47 00 	movl   $0x47ca,0x4(%esp)
     7d0:	00 
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     812:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     819:	00 
    ...
    if(total != 5 * 1033){
     ...
     83f:	c7 44 24 04 d8 47 00 	movl   $0x47d8,0x4(%esp)
     846:	00 
  ...
  printf(1, "pipe1 ok\n");
     868:	c7 44 24 04 fe 47 00 	movl   $0x47fe,0x4(%esp)
     86f:	00 
    ...
    printf(1, "fork() failed\n");
     87e:	c7 44 24 04 ef 47 00 	movl   $0x47ef,0x4(%esp)
     885:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89f:	c7 44 24 04 08 48 00 	movl   $0x4808,0x4(%esp)
     8a6:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     901:	00 
     902:	c7 44 24 04 12 48 00 	movl   $0x4812,0x4(%esp)
     909:	00 
     ...
     917:	c7 44 24 04 14 48 00 	movl   $0x4814,0x4(%esp)
     91e:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94d:	00 
     94e:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     955:	00 
    ...
    printf(1, "preempt read error");
     963:	c7 44 24 04 28 48 00 	movl   $0x4828,0x4(%esp)
     96a:	00 
  ...
  printf(1, "kill... ");
     984:	c7 44 24 04 3b 48 00 	movl   $0x483b,0x4(%esp)
     98b:	00 
  ...
  printf(1, "wait... ");
     9b9:	c7 44 24 04 44 48 00 	movl   $0x4844,0x4(%esp)
     9c0:	00 
  ...
  printf(1, "preempt ok\n");
     9dc:	c7 44 24 04 4d 48 00 	movl   $0x484d,0x4(%esp)
     9e3:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0d:	79 16                	jns    a25 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0f:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
     a16:	00 
    ...
    if(pid){
     ...
     a35:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
     a3c:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a5a:	c7 44 24 04 76 48 00 	movl   $0x4876,0x4(%esp)
     a61:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a76:	c7 44 24 04 83 48 00 	movl   $0x4883,0x4(%esp)
     a7d:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b06:	c7 44 24 04 8d 48 00 	movl   $0x488d,0x4(%esp)
     b0d:	00 
    ...
    printf(1, "mem ok\n");
     b35:	c7 44 24 04 a7 48 00 	movl   $0x48a7,0x4(%esp)
     b3c:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b98:	c7 44 24 04 c8 48 00 	movl   $0x48c8,0x4(%esp)
     b9f:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c0a:	c7 44 24 04 f4 48 00 	movl   $0x48f4,0x4(%esp)
     c11:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     c4f:	00 
     c50:	c7 04 24 be 48 00 00 	movl   $0x48be,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c65:	c7 44 24 04 14 49 00 	movl   $0x4914,0x4(%esp)
     c6c:	00 
  ...
  unlink("sharedfd");
     cf6:	c7 04 24 be 48 00 00 	movl   $0x48be,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d14:	c7 44 24 04 3f 49 00 	movl   $0x493f,0x4(%esp)
     d1b:	00 
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d38:	c7 44 24 04 4c 49 00 	movl   $0x494c,0x4(%esp)
     d3f:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d59:	c7 44 24 04 61 49 00 	movl   $0x4961,0x4(%esp)
     d60:	00 
     d61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d68:	e8 5b 30 00 00       	call   3dc8 <printf>

  unlink("f1");
     d6d:	c7 04 24 70 49 00 00 	movl   $0x4970,(%esp)
     d74:	e8 ef 2e 00 00       	call   3c68 <unlink>
  unlink("f2");
     d79:	c7 04 24 73 49 00 00 	movl   $0x4973,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d93:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
     d9a:	00 
  ...
  fname = pid ? "f1" : "f2";
     ...
     db2:	b8 70 49 00 00       	mov    $0x4970,%eax
     db7:	eb 05                	jmp    dbe <twofiles+0x6b>
     db9:	b8 73 49 00 00       	mov    $0x4973,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ddd:	c7 44 24 04 76 49 00 	movl   $0x4976,0x4(%esp)
     de4:	00 
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e14:	c7 04 24 40 8b 00 00 	movl   $0x8b40,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e30:	00 
     e31:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     e38:	00 
     ...
     e57:	c7 44 24 04 85 49 00 	movl   $0x4985,0x4(%esp)
     e5e:	00 
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea7:	b8 70 49 00 00       	mov    $0x4970,%eax
     eac:	eb 05                	jmp    eb3 <twofiles+0x160>
     eae:	b8 73 49 00 00       	mov    $0x4973,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     edb:	05 40 8b 00 00       	add    $0x8b40,%eax
     ...
     efa:	74 19                	je     f15 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     efc:	c7 44 24 04 96 49 00 	movl   $0x4996,0x4(%esp)
     f03:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f2e:	00 
     f2f:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
     f36:	00 
    ...
    if(total != 12*500){
     ...
     f66:	c7 44 24 04 a2 49 00 	movl   $0x49a2,0x4(%esp)
     f6d:	00 
  ...
  unlink("f1");
     f8d:	c7 04 24 70 49 00 00 	movl   $0x4970,(%esp)
     f94:	e8 cf 2c 00 00       	call   3c68 <unlink>
  unlink("f2");
     f99:	c7 04 24 73 49 00 00 	movl   $0x4973,(%esp)
     fa0:	e8 c3 2c 00 00       	call   3c68 <unlink>

  printf(1, "twofiles ok\n");
     fa5:	c7 44 24 04 b3 49 00 	movl   $0x49b3,0x4(%esp)
     fac:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fc1:	c7 44 24 04 c0 49 00 	movl   $0x49c0,0x4(%esp)
     fc8:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fe3:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
     fea:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1044:	79 19                	jns    105f <createdelete+0xa4>
      printf(1, "create failed\n");
    1046:	c7 44 24 04 76 49 00 	movl   $0x4976,0x4(%esp)
    104d:	00 
    ...
    109b:	c7 44 24 04 d3 49 00 	movl   $0x49d3,0x4(%esp)
    10a2:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    111a:	c7 44 24 04 e4 49 00 	movl   $0x49e4,0x4(%esp)
    1121:	00 
    ...
    114c:	c7 44 24 04 08 4a 00 	movl   $0x4a08,0x4(%esp)
    1153:	00 
    ...
    11b2:	c7 44 24 04 e4 49 00 	movl   $0x49e4,0x4(%esp)
    11b9:	00 
    ...
    11e4:	c7 44 24 04 08 4a 00 	movl   $0x4a08,0x4(%esp)
    11eb:	00 
  ...
  printf(1, "createdelete ok\n");
    1256:	c7 44 24 04 28 4a 00 	movl   $0x4a28,0x4(%esp)
    125d:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1272:	c7 44 24 04 39 4a 00 	movl   $0x4a39,0x4(%esp)
    1279:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    128d:	00 
    128e:	c7 04 24 4a 4a 00 00 	movl   $0x4a4a,(%esp)
  ...
  if(fd < 0){
    ...
    12a3:	c7 44 24 04 55 4a 00 	movl   $0x4a55,0x4(%esp)
    12aa:	00 
  ...
  write(fd, "hello", 5);
    ...
    12c3:	00 
    12c4:	c7 44 24 04 6f 4a 00 	movl   $0x4a6f,0x4(%esp)
    12cb:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e9:	00 
    12ea:	c7 04 24 4a 4a 00 00 	movl   $0x4a4a,(%esp)
  ...
  if(fd < 0){
    ...
    12ff:	c7 44 24 04 75 4a 00 	movl   $0x4a75,0x4(%esp)
    1306:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1385:	00 
    1386:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    138d:	00 
    ...
    139e:	c7 44 24 04 ab 4a 00 	movl   $0x4aab,0x4(%esp)
    13a5:	00 
  ...
  if(buf[0] != 'h'){
    13b7:	0f b6 05 40 8b 00 00 	movzbl 0x8b40,%eax
    13be:	3c 68                	cmp    $0x68,%al
    13c0:	74 19                	je     13db <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13c2:	c7 44 24 04 c2 4a 00 	movl   $0x4ac2,0x4(%esp)
    13c9:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13e2:	00 
    13e3:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    13ea:	00 
    ...
    13fb:	c7 44 24 04 d9 4a 00 	movl   $0x4ad9,0x4(%esp)
    1402:	00 
  ...
  unlink("unlinkread");
    141f:	c7 04 24 4a 4a 00 00 	movl   $0x4a4a,(%esp)
    1426:	e8 3d 28 00 00       	call   3c68 <unlink>
  printf(1, "unlinkread ok\n");
    142b:	c7 44 24 04 f2 4a 00 	movl   $0x4af2,0x4(%esp)
    1432:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    1490:	c7 44 24 04 13 4b 00 	movl   $0x4b13,0x4(%esp)
    1497:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14b0:	00 
    14b1:	c7 44 24 04 6f 4a 00 	movl   $0x4a6f,0x4(%esp)
    14b8:	00 
    ...
    14c9:	c7 44 24 04 26 4b 00 	movl   $0x4b26,0x4(%esp)
    14d0:	00 
  ...
  if(link("lf1", "lf2") < 0){
    14ed:	c7 44 24 04 0f 4b 00 	movl   $0x4b0f,0x4(%esp)
    14f4:	00 
    14f5:	c7 04 24 0b 4b 00 00 	movl   $0x4b0b,(%esp)
    14fc:	e8 77 27 00 00       	call   3c78 <link>
    1501:	85 c0                	test   %eax,%eax
    1503:	79 19                	jns    151e <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1505:	c7 44 24 04 38 4b 00 	movl   $0x4b38,0x4(%esp)
    150c:	00 
  ...
  fd = open("lf2", 0);
    ...
    1562:	00 
    1563:	c7 04 24 0f 4b 00 00 	movl   $0x4b0f,(%esp)
  ...
  if(fd < 0){
    ...
    1578:	c7 44 24 04 75 4b 00 	movl   $0x4b75,0x4(%esp)
    157f:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1598:	00 
    1599:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    15a0:	00 
    ...
    15b1:	c7 44 24 04 86 4b 00 	movl   $0x4b86,0x4(%esp)
    15b8:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    15d5:	c7 44 24 04 0f 4b 00 	movl   $0x4b0f,0x4(%esp)
    15dc:	00 
    15dd:	c7 04 24 0f 4b 00 00 	movl   $0x4b0f,(%esp)
    15e4:	e8 8f 26 00 00       	call   3c78 <link>
    15e9:	85 c0                	test   %eax,%eax
    15eb:	78 19                	js     1606 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ed:	c7 44 24 04 97 4b 00 	movl   $0x4b97,0x4(%esp)
    15f4:	00 
  ...
  unlink("lf2");
    1606:	c7 04 24 0f 4b 00 00 	movl   $0x4b0f,(%esp)
    160d:	e8 56 26 00 00       	call   3c68 <unlink>
  if(link("lf2", "lf1") >= 0){
    1612:	c7 44 24 04 0b 4b 00 	movl   $0x4b0b,0x4(%esp)
    1619:	00 
    161a:	c7 04 24 0f 4b 00 00 	movl   $0x4b0f,(%esp)
    1621:	e8 52 26 00 00       	call   3c78 <link>
    1626:	85 c0                	test   %eax,%eax
    1628:	78 19                	js     1643 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    162a:	c7 44 24 04 b8 4b 00 	movl   $0x4bb8,0x4(%esp)
    1631:	00 
  ...
  if(link(".", "lf1") >= 0){
    1643:	c7 44 24 04 0b 4b 00 	movl   $0x4b0b,0x4(%esp)
    164a:	00 
    164b:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
    1652:	e8 21 26 00 00       	call   3c78 <link>
    1657:	85 c0                	test   %eax,%eax
    1659:	78 19                	js     1674 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    165b:	c7 44 24 04 dd 4b 00 	movl   $0x4bdd,0x4(%esp)
    1662:	00 
  ...
  printf(1, "linktest ok\n");
    1674:	c7 44 24 04 f9 4b 00 	movl   $0x4bf9,0x4(%esp)
    167b:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1690:	c7 44 24 04 06 4c 00 	movl   $0x4c06,0x4(%esp)
    1697:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1703:	c7 04 24 16 4c 00 00 	movl   $0x4c16,(%esp)
    ...
    1746:	c7 04 24 16 4c 00 00 	movl   $0x4c16,(%esp)
    ...
    1777:	c7 44 24 04 19 4c 00 	movl   $0x4c19,0x4(%esp)
    177e:	00 
  ...
  fd = open(".", 0);
    ...
    17db:	00 
    17dc:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    183e:	c7 44 24 04 35 4c 00 	movl   $0x4c35,0x4(%esp)
    1845:	00 
    ...
    1870:	c7 44 24 04 4e 4c 00 	movl   $0x4c4e,0x4(%esp)
    1877:	00 
  ...
  if(n != 40){
    ...
    18cb:	c7 44 24 04 6c 4c 00 	movl   $0x4c6c,0x4(%esp)
    18d2:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1905:	79 19                	jns    1920 <concreate+0x296>
      printf(1, "fork failed\n");
    1907:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
    190e:	00 
  ...
  printf(1, "concreate ok\n");
    1a27:	c7 44 24 04 9d 4c 00 	movl   $0x4c9d,0x4(%esp)
    1a2e:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a43:	c7 44 24 04 ab 4c 00 	movl   $0x4cab,0x4(%esp)
    1a4a:	00 
    1a4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a52:	e8 71 23 00 00       	call   3dc8 <printf>

  unlink("x");
    1a57:	c7 04 24 12 48 00 00 	movl   $0x4812,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a71:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
    1a78:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1adf:	00 
    1ae0:	c7 04 24 12 48 00 00 	movl   $0x4812,(%esp)
    ...
    1b11:	75 16                	jne    1b29 <linkunlink+0xec>
      link("cat", "x");
    1b13:	c7 44 24 04 12 48 00 	movl   $0x4812,0x4(%esp)
    1b1a:	00 
    1b1b:	c7 04 24 bc 4c 00 00 	movl   $0x4cbc,(%esp)
    1b22:	e8 51 21 00 00       	call   3c78 <link>
    1b27:	eb 0c                	jmp    1b35 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b29:	c7 04 24 12 48 00 00 	movl   $0x4812,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b55:	c7 44 24 04 c0 4c 00 	movl   $0x4cc0,0x4(%esp)
    1b5c:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1bae:	c7 44 24 04 df 4c 00 	movl   $0x4cdf,0x4(%esp)
    1bb5:	00 
  ...
  unlink("bd");
    1c48:	c7 04 24 dc 4c 00 00 	movl   $0x4cdc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9c:	c7 44 24 04 09 4d 00 	movl   $0x4d09,0x4(%esp)
    1ca3:	00 
  ...
  printf(1, "bigdir ok\n");
    1cc2:	c7 44 24 04 1e 4d 00 	movl   $0x4d1e,0x4(%esp)
    1cc9:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	00 
    1d2f:	c7 04 24 54 4d 00 00 	movl   $0x4d54,(%esp)
  ...
  if(fd < 0){
    ...
    1d44:	c7 44 24 04 5a 4d 00 	movl   $0x4d5a,0x4(%esp)
    1d4b:	00 
  ...
  write(fd, "ff", 2);
    ...
    1d64:	00 
    1d65:	c7 44 24 04 36 4d 00 	movl   $0x4d36,0x4(%esp)
    1d6c:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddc:	00 
    1ddd:	c7 04 24 b8 4d 00 00 	movl   $0x4db8,(%esp)
  ...
  if(fd < 0){
    ...
    1df2:	c7 44 24 04 c1 4d 00 	movl   $0x4dc1,0x4(%esp)
    1df9:	00 
  ...
  write(fd, "FF", 2);
    ...
    1e12:	00 
    1e13:	c7 44 24 04 d9 4d 00 	movl   $0x4dd9,0x4(%esp)
    1e1a:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e38:	00 
    1e39:	c7 04 24 dc 4d 00 00 	movl   $0x4ddc,(%esp)
  ...
  if(fd < 0){
    ...
    1e4e:	c7 44 24 04 e8 4d 00 	movl   $0x4de8,0x4(%esp)
    1e55:	00 
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6e:	00 
    1e6f:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    1e76:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8b:	0f b6 05 40 8b 00 00 	movzbl 0x8b40,%eax
    1e92:	3c 66                	cmp    $0x66,%al
    1e94:	74 19                	je     1eaf <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e96:	c7 44 24 04 01 4e 00 	movl   $0x4e01,0x4(%esp)
    1e9d:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eba:	c7 44 24 04 1c 4e 00 	movl   $0x4e1c,0x4(%esp)
    1ec1:	00 
    1ec2:	c7 04 24 b8 4d 00 00 	movl   $0x4db8,(%esp)
    1ec9:	e8 aa 1d 00 00       	call   3c78 <link>
    1ece:	85 c0                	test   %eax,%eax
    1ed0:	74 19                	je     1eeb <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ed2:	c7 44 24 04 28 4e 00 	movl   $0x4e28,0x4(%esp)
    1ed9:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ff0:	00 
    1ff1:	c7 04 24 1c 4e 00 00 	movl   $0x4e1c,(%esp)
  ...
  if(fd < 0){
    ...
    2006:	c7 44 24 04 e6 4e 00 	movl   $0x4ee6,0x4(%esp)
    200d:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2026:	00 
    2027:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    202e:	00 
    ...
    203f:	c7 44 24 04 fe 4e 00 	movl   $0x4efe,0x4(%esp)
    2046:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2189:	c7 44 24 04 d5 4f 00 	movl   $0x4fd5,0x4(%esp)
    2190:	00 
    2191:	c7 04 24 41 4f 00 00 	movl   $0x4f41,(%esp)
    2198:	e8 db 1a 00 00       	call   3c78 <link>
    219d:	85 c0                	test   %eax,%eax
    219f:	75 19                	jne    21ba <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    21a1:	c7 44 24 04 e0 4f 00 	movl   $0x4fe0,0x4(%esp)
    21a8:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21ba:	c7 44 24 04 d5 4f 00 	movl   $0x4fd5,0x4(%esp)
    21c1:	00 
    21c2:	c7 04 24 66 4f 00 00 	movl   $0x4f66,(%esp)
    21c9:	e8 aa 1a 00 00       	call   3c78 <link>
    21ce:	85 c0                	test   %eax,%eax
    21d0:	75 19                	jne    21eb <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21d2:	c7 44 24 04 04 50 00 	movl   $0x5004,0x4(%esp)
    21d9:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21eb:	c7 44 24 04 1c 4e 00 	movl   $0x4e1c,0x4(%esp)
    21f2:	00 
    21f3:	c7 04 24 54 4d 00 00 	movl   $0x4d54,(%esp)
    21fa:	e8 79 1a 00 00       	call   3c78 <link>
    21ff:	85 c0                	test   %eax,%eax
    2201:	75 19                	jne    221c <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2203:	c7 44 24 04 28 50 00 	movl   $0x5028,0x4(%esp)
    220a:	00 
  ...
  printf(1, "subdir ok\n");
    2408:	c7 44 24 04 6d 51 00 	movl   $0x516d,0x4(%esp)
    240f:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2424:	c7 44 24 04 78 51 00 	movl   $0x5178,0x4(%esp)
    242b:	00 
    242c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2433:	e8 90 19 00 00       	call   3dc8 <printf>

  unlink("bigwrite");
    2438:	c7 04 24 87 51 00 00 	movl   $0x5187,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2457:	00 
    2458:	c7 04 24 87 51 00 00 	movl   $0x5187,(%esp)
    ...
    246d:	c7 44 24 04 90 51 00 	movl   $0x5190,0x4(%esp)
    2474:	00 
    ...
    2496:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    249d:	00 
    ...
    24c2:	c7 44 24 04 a8 51 00 	movl   $0x51a8,0x4(%esp)
    24c9:	00 
    ...
    unlink("bigwrite");
    24f0:	c7 04 24 87 51 00 00 	movl   $0x5187,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2510:	c7 44 24 04 ba 51 00 	movl   $0x51ba,0x4(%esp)
    2517:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    2569:	c7 44 24 04 dd 51 00 	movl   $0x51dd,0x4(%esp)
    2570:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    259a:	c7 04 24 40 8b 00 00 	movl   $0x8b40,(%esp)
    25a1:	e8 c5 14 00 00       	call   3a6b <memset>
    if(write(fd, buf, 600) != 600){
    25a6:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ad:	00 
    25ae:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    25b5:	00 
    ...
    25c8:	c7 44 24 04 f3 51 00 	movl   $0x51f3,0x4(%esp)
    25cf:	00 
  ...
  fd = open("bigfile", 0);
    ...
    25fd:	00 
    25fe:	c7 04 24 d5 51 00 00 	movl   $0x51d5,(%esp)
  ...
  if(fd < 0){
    ...
    2613:	c7 44 24 04 09 52 00 	movl   $0x5209,0x4(%esp)
    261a:	00 
  ...
  for(i = 0; ; i++){
    ...
    2641:	00 
    2642:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    2649:	00 
    ...
    265e:	c7 44 24 04 1e 52 00 	movl   $0x521e,0x4(%esp)
    2665:	00 
  ...
  if(total != 20*600){
    ...
    26a1:	c7 44 24 04 33 52 00 	movl   $0x5233,0x4(%esp)
    26a8:	00 
    ...
    26ba:	0f b6 05 40 8b 00 00 	movzbl 0x8b40,%eax
    ...
    26d4:	0f b6 05 6b 8c 00 00 	movzbl 0x8c6b,%eax
    ...
    26ec:	74 19                	je     2707 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    26ee:	c7 44 24 04 47 52 00 	movl   $0x5247,0x4(%esp)
    26f5:	00 
  ...
  if(total != 20*600){
    ...
    2716:	c7 44 24 04 60 52 00 	movl   $0x5260,0x4(%esp)
    271d:	00 
  ...
  unlink("bigfile");
    272f:	c7 04 24 d5 51 00 00 	movl   $0x51d5,(%esp)
    2736:	e8 2d 15 00 00       	call   3c68 <unlink>

  printf(1, "bigfile test ok\n");
    273b:	c7 44 24 04 7a 52 00 	movl   $0x527a,0x4(%esp)
    2742:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c4:	00 
    27c5:	c7 04 24 18 53 00 00 	movl   $0x5318,(%esp)
  ...
  if(fd < 0){
    ...
    27da:	c7 44 24 04 48 53 00 	movl   $0x5348,0x4(%esp)
    27e1:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2805:	00 
    2806:	c7 04 24 88 53 00 00 	movl   $0x5388,(%esp)
  ...
  if(fd < 0){
    ...
    281b:	c7 44 24 04 b8 53 00 	movl   $0x53b8,0x4(%esp)
    2822:	00 
  ...
  printf(1, "fourteen ok\n");
    2891:	c7 44 24 04 91 54 00 	movl   $0x5491,0x4(%esp)
    2898:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2a09:	c7 44 24 04 57 55 00 	movl   $0x5557,0x4(%esp)
    2a10:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a25:	c7 44 24 04 61 55 00 	movl   $0x5561,0x4(%esp)
    2a2c:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a40:	00 
    2a41:	c7 04 24 6e 55 00 00 	movl   $0x556e,(%esp)
  ...
  if(fd < 0){
    ...
    2a56:	c7 44 24 04 76 55 00 	movl   $0x5576,0x4(%esp)
    2a5d:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aaa:	00 
    2aab:	c7 04 24 a7 55 00 00 	movl   $0x55a7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ac0:	c7 44 24 04 b2 55 00 	movl   $0x55b2,0x4(%esp)
    2ac7:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae0:	00 
    2ae1:	c7 04 24 a7 55 00 00 	movl   $0x55a7,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2af6:	c7 44 24 04 b2 55 00 	movl   $0x55b2,0x4(%esp)
    2afd:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2b61:	c7 44 24 04 a7 55 00 	movl   $0x55a7,0x4(%esp)
    2b68:	00 
    2b69:	c7 04 24 0b 56 00 00 	movl   $0x560b,(%esp)
    2b70:	e8 03 11 00 00       	call   3c78 <link>
    2b75:	85 c0                	test   %eax,%eax
    2b77:	75 19                	jne    2b92 <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b79:	c7 44 24 04 14 56 00 	movl   $0x5614,0x4(%esp)
    2b80:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2bc2:	00 
    2bc3:	c7 04 24 db 4b 00 00 	movl   $0x4bdb,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd8:	c7 44 24 04 4c 56 00 	movl   $0x564c,0x4(%esp)
    2bdf:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c27:	c7 44 24 04 6b 56 00 	movl   $0x566b,0x4(%esp)
    2c2e:	00 
  ...
  printf(1, "dir vs file OK\n");
    2c4b:	c7 44 24 04 7f 56 00 	movl   $0x567f,0x4(%esp)
    2c52:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c67:	c7 44 24 04 8f 56 00 	movl   $0x568f,0x4(%esp)
    2c6e:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2cd9:	c7 04 24 ce 56 00 00 	movl   $0x56ce,(%esp)
    2ce0:	e8 9b 0f 00 00       	call   3c80 <mkdir>
    link("README", "");
    2ce5:	c7 44 24 04 ce 56 00 	movl   $0x56ce,0x4(%esp)
    2cec:	00 
    2ced:	c7 04 24 0b 56 00 00 	movl   $0x560b,(%esp)
    2cf4:	e8 7f 0f 00 00       	call   3c78 <link>
    fd = open("", O_CREATE);
    2cf9:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2d00:	00 
    2d01:	c7 04 24 ce 56 00 00 	movl   $0x56ce,(%esp)
    ...
    2d28:	00 
    2d29:	c7 04 24 cf 56 00 00 	movl   $0x56cf,(%esp)
    ...
    unlink("xx");
    2d49:	c7 04 24 cf 56 00 00 	movl   $0x56cf,(%esp)
  ...
  chdir("/");
    2d63:	c7 04 24 f2 54 00 00 	movl   $0x54f2,(%esp)
    2d6a:	e8 19 0f 00 00       	call   3c88 <chdir>
  printf(1, "empty file name OK\n");
    2d6f:	c7 44 24 04 d2 56 00 	movl   $0x56d2,0x4(%esp)
    2d76:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d8b:	c7 44 24 04 e6 56 00 	movl   $0x56e6,0x4(%esp)
    2d92:	00 
    ...
    2dbe:	e8 55 0e 00 00       	call   3c18 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd9:	c7 44 24 04 f4 56 00 	movl   $0x56f4,0x4(%esp)
    2de0:	00 
  ...
  for(; n > 0; n--){
    ...
    2dfd:	c7 44 24 04 16 57 00 	movl   $0x5716,0x4(%esp)
    2e04:	00 
  ...
  if(wait() != -1){
    ...
    2e2a:	c7 44 24 04 2a 57 00 	movl   $0x572a,0x4(%esp)
    2e31:	00 
  ...
  printf(1, "fork test OK\n");
    2e43:	c7 44 24 04 3d 57 00 	movl   $0x573d,0x4(%esp)
    2e4a:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e63:	a1 5c 63 00 00       	mov    0x635c,%eax
    2e68:	c7 44 24 04 4b 57 00 	movl   $0x574b,0x4(%esp)
    2e6f:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eb6:	a1 5c 63 00 00       	mov    0x635c,%eax
    ...
    2ed0:	c7 44 24 04 56 57 00 	movl   $0x5756,0x4(%esp)
    2ed7:	00 
  ...
  if(pid < 0){
    ...
    2f0f:	a1 5c 63 00 00       	mov    0x635c,%eax
    2f14:	c7 44 24 04 71 57 00 	movl   $0x5771,0x4(%esp)
    2f1b:	00 
  ...
  if(c != a + 1){
    ...
    2f52:	a1 5c 63 00 00       	mov    0x635c,%eax
    2f57:	c7 44 24 04 88 57 00 	movl   $0x5788,0x4(%esp)
    2f5e:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2fb0:	a1 5c 63 00 00       	mov    0x635c,%eax
    2fb5:	c7 44 24 04 a4 57 00 	movl   $0x57a4,0x4(%esp)
    2fbc:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ffb:	a1 5c 63 00 00       	mov    0x635c,%eax
    3000:	c7 44 24 04 e2 57 00 	movl   $0x57e2,0x4(%esp)
    3007:	00 
  ...
  if(c != a - 4096){
    ...
    3031:	a1 5c 63 00 00       	mov    0x635c,%eax
    ...
    3044:	c7 44 24 04 00 58 00 	movl   $0x5800,0x4(%esp)
    304b:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3098:	a1 5c 63 00 00       	mov    0x635c,%eax
    ...
    30ab:	c7 44 24 04 38 58 00 	movl   $0x5838,0x4(%esp)
    30b2:	00 
  ...
  if(*lastaddr == 99){
    ...
    30ca:	a1 5c 63 00 00       	mov    0x635c,%eax
    30cf:	c7 44 24 04 60 58 00 	movl   $0x5860,0x4(%esp)
    30d6:	00 
  ...
  if(c != a){
    ...
    3119:	a1 5c 63 00 00       	mov    0x635c,%eax
    ...
    312c:	c7 44 24 04 90 58 00 	movl   $0x5890,0x4(%esp)
    3133:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3160:	a1 5c 63 00 00       	mov    0x635c,%eax
    3165:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
    316c:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31e1:	c7 44 24 04 ad 47 00 	movl   $0x47ad,0x4(%esp)
    31e8:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3244:	00 
    3245:	c7 44 24 04 12 48 00 	movl   $0x4812,0x4(%esp)
    324c:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e5:	a1 5c 63 00 00       	mov    0x635c,%eax
    32ea:	c7 44 24 04 ca 58 00 	movl   $0x58ca,0x4(%esp)
    32f1:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    332b:	a1 5c 63 00 00       	mov    0x635c,%eax
    3330:	c7 44 24 04 e5 58 00 	movl   $0x58e5,0x4(%esp)
    3337:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3371:	a1 5c 63 00 00       	mov    0x635c,%eax
    3376:	c7 44 24 04 f3 58 00 	movl   $0x58f3,0x4(%esp)
    337d:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e3:	c7 04 24 02 59 00 00 	movl   $0x5902,(%esp)
    33ea:	e8 89 08 00 00       	call   3c78 <link>
    33ef:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f2:	74 1a                	je     340e <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f4:	a1 5c 63 00 00       	mov    0x635c,%eax
    33f9:	c7 44 24 04 0d 59 00 	movl   $0x590d,0x4(%esp)
    3400:	00 
  ...
  printf(stdout, "validate ok\n");
    3421:	a1 5c 63 00 00       	mov    0x635c,%eax
    3426:	c7 44 24 04 26 59 00 	movl   $0x5926,0x4(%esp)
    342d:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343e:	a1 5c 63 00 00       	mov    0x635c,%eax
    3443:	c7 44 24 04 33 59 00 	movl   $0x5933,0x4(%esp)
    344a:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    345f:	05 20 64 00 00       	add    $0x6420,%eax
    3464:	0f b6 00             	movzbl (%eax),%eax
    3467:	84 c0                	test   %al,%al
    3469:	74 1a                	je     3485 <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    346b:	a1 5c 63 00 00       	mov    0x635c,%eax
    3470:	c7 44 24 04 3d 59 00 	movl   $0x593d,0x4(%esp)
    3477:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3493:	a1 5c 63 00 00       	mov    0x635c,%eax
    3498:	c7 44 24 04 4e 59 00 	movl   $0x594e,0x4(%esp)
    349f:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34b0:	c7 04 24 5b 59 00 00 	movl   $0x595b,(%esp)
  ...
  if(pid == 0){
    ...
    34da:	c7 04 85 80 63 00 00 	movl   $0x5968,0x6380(,%eax,4)
    34e1:	68 59 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34ed:	7e e8                	jle    34d7 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34ef:	c7 05 fc 63 00 00 00 	movl   $0x0,0x63fc
    34f6:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f9:	a1 5c 63 00 00       	mov    0x635c,%eax
    34fe:	c7 44 24 04 45 5a 00 	movl   $0x5a45,0x4(%esp)
    3505:	00 
    3506:	89 04 24             	mov    %eax,(%esp)
    3509:	e8 ba 08 00 00       	call   3dc8 <printf>
    exec("echo", args);
    350e:	c7 44 24 04 80 63 00 	movl   $0x6380,0x4(%esp)
    3515:	00 
    3516:	c7 04 24 6c 44 00 00 	movl   $0x446c,(%esp)
    351d:	e8 2e 07 00 00       	call   3c50 <exec>
    printf(stdout, "bigarg test ok\n");
    3522:	a1 5c 63 00 00       	mov    0x635c,%eax
    3527:	c7 44 24 04 52 5a 00 	movl   $0x5a52,0x4(%esp)
    352e:	00 
    ...
    353e:	00 
    353f:	c7 04 24 5b 59 00 00 	movl   $0x595b,(%esp)
    ...
    3564:	a1 5c 63 00 00       	mov    0x635c,%eax
    3569:	c7 44 24 04 62 5a 00 	movl   $0x5a62,0x4(%esp)
    3570:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    358a:	00 
    358b:	c7 04 24 5b 59 00 00 	movl   $0x595b,(%esp)
  ...
  if(fd < 0){
    ...
    35a0:	a1 5c 63 00 00       	mov    0x635c,%eax
    35a5:	c7 44 24 04 7b 5a 00 	movl   $0x5a7b,0x4(%esp)
    35ac:	00 
  ...
  unlink("bigarg-ok");
    35c5:	c7 04 24 5b 59 00 00 	movl   $0x595b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35e1:	c7 44 24 04 90 5a 00 	movl   $0x5a90,0x4(%esp)
    35e8:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36cb:	c7 44 24 04 9d 5a 00 	movl   $0x5a9d,0x4(%esp)
    36d2:	00 
    ...
    3702:	c7 44 24 04 a9 5a 00 	movl   $0x5aa9,0x4(%esp)
    3709:	00 
    ...
    3726:	00 
    3727:	c7 44 24 04 40 8b 00 	movl   $0x8b40,0x4(%esp)
    372e:	00 
    ...
    374e:	c7 44 24 04 b9 5a 00 	movl   $0x5ab9,0x4(%esp)
    3755:	00 
  ...
  printf(1, "fsfull test finished\n");
    3872:	c7 44 24 04 c9 5a 00 	movl   $0x5ac9,0x4(%esp)
    3879:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    388f:	a1 60 63 00 00       	mov    0x6360,%eax
    3894:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    389a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    389f:	a3 60 63 00 00       	mov    %eax,0x6360
  return randstate;
    38a4:	a1 60 63 00 00       	mov    0x6360,%eax
}
    38a9:	5d                   	pop    %ebp
    38aa:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38b4:	c7 44 24 04 df 5a 00 	movl   $0x5adf,0x4(%esp)
    38bb:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3900:	00 
    3901:	c7 04 24 f3 5a 00 00 	movl   $0x5af3,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d61:	0f b6 80 64 63 00 00 	movzbl 0x6364(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3ebe:	75 09                	jne    3ec9 <printf+0x101>
          s = "(null)";
    3ec0:	c7 45 f4 2e 5b 00 00 	movl   $0x5b2e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f8a:	a1 08 64 00 00       	mov    0x6408,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    4055:	a3 08 64 00 00       	mov    %eax,0x6408
}
    405a:	c9                   	leave  
    405b:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    40ad:	a1 08 64 00 00       	mov    0x6408,%eax
}
    40b2:	c9                   	leave  
    40b3:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40c9:	a1 08 64 00 00       	mov    0x6408,%eax
    40ce:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40d1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40d5:	75 23                	jne    40fa <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40d7:	c7 45 f0 00 64 00 00 	movl   $0x6400,-0x10(%ebp)
    40de:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40e1:	a3 08 64 00 00       	mov    %eax,0x6408
    40e6:	a1 08 64 00 00       	mov    0x6408,%eax
    40eb:	a3 00 64 00 00       	mov    %eax,0x6400
    base.s.size = 0;
    40f0:	c7 05 04 64 00 00 00 	movl   $0x0,0x6404
    40f7:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    414d:	a3 08 64 00 00       	mov    %eax,0x6408
      return (void*)(p + 1);
    ...
    if(p == freep)
    415a:	a1 08 64 00 00       	mov    0x6408,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    if (inQ == 0) {
    4212:	0f b6 05 0c 64 00 00 	movzbl 0x640c,%eax
    4219:	84 c0                	test   %al,%al
    421b:	75 1c                	jne    4239 <thread_create+0x42>
        init_q(thQ2);
    421d:	a1 44 ab 00 00       	mov    0xab44,%eax
    4222:	89 04 24             	mov    %eax,(%esp)
    4225:	e8 2c 01 00 00       	call   4356 <init_q>
        inQ++;
    422a:	0f b6 05 0c 64 00 00 	movzbl 0x640c,%eax
    4231:	83 c0 01             	add    $0x1,%eax
    4234:	a2 0c 64 00 00       	mov    %al,0x640c
    }
    ...
    425f:	c7 44 24 04 35 5b 00 	movl   $0x5b35,0x4(%esp)
    4266:	00 
    ...
    42a7:	c7 44 24 04 43 5b 00 	movl   $0x5b43,0x4(%esp)
    42ae:	00 
    ...
    42e7:	c7 44 24 04 50 5b 00 	movl   $0x5b50,0x4(%esp)
    42ee:	00 
...
int random(int max){
    ...
    4305:	a1 78 63 00 00       	mov    0x6378,%eax
    430a:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    4310:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    4315:	a3 78 63 00 00       	mov    %eax,0x6378
    return (int)(rands % max);
    431a:	a1 78 63 00 00       	mov    0x6378,%eax
...
void thread_yield2(){
    ...
    4330:	83 ec 18             	sub    $0x18,%esp
    printf(1,"My PID: %d \n", proc->pid);
    4333:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    4339:	8b 40 10             	mov    0x10(%eax),%eax
    433c:	89 44 24 08          	mov    %eax,0x8(%esp)
    4340:	c7 44 24 04 61 5b 00 	movl   $0x5b61,0x4(%esp)
    4347:	00 
    4348:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    434f:	e8 74 fa ff ff       	call   3dc8 <printf>
    */
    //add_q(thQ2, tid2);
    //proc->state = RUNNABLE;
...
void init_q(struct queue *q){
    4356:	55                   	push   %ebp
    4357:	89 e5                	mov    %esp,%ebp
    q->size = 0;
    4359:	8b 45 08             	mov    0x8(%ebp),%eax
    435c:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    4362:	8b 45 08             	mov    0x8(%ebp),%eax
    4365:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    436c:	8b 45 08             	mov    0x8(%ebp),%eax
    436f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    4376:	5d                   	pop    %ebp
    4377:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    4378:	55                   	push   %ebp
    4379:	89 e5                	mov    %esp,%ebp
    437b:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    437e:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    4385:	e8 2a fd ff ff       	call   40b4 <malloc>
    438a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    438d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4390:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    4397:	8b 45 f4             	mov    -0xc(%ebp),%eax
    439a:	8b 55 0c             	mov    0xc(%ebp),%edx
    439d:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    439f:	8b 45 08             	mov    0x8(%ebp),%eax
    43a2:	8b 40 04             	mov    0x4(%eax),%eax
    43a5:	85 c0                	test   %eax,%eax
    43a7:	75 0b                	jne    43b4 <add_q+0x3c>
        q->head = n;
    43a9:	8b 45 08             	mov    0x8(%ebp),%eax
    43ac:	8b 55 f4             	mov    -0xc(%ebp),%edx
    43af:	89 50 04             	mov    %edx,0x4(%eax)
    43b2:	eb 0c                	jmp    43c0 <add_q+0x48>
    }else{
        q->tail->next = n;
    43b4:	8b 45 08             	mov    0x8(%ebp),%eax
    43b7:	8b 40 08             	mov    0x8(%eax),%eax
    43ba:	8b 55 f4             	mov    -0xc(%ebp),%edx
    43bd:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    43c0:	8b 45 08             	mov    0x8(%ebp),%eax
    43c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
    43c6:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    43c9:	8b 45 08             	mov    0x8(%ebp),%eax
    43cc:	8b 00                	mov    (%eax),%eax
    43ce:	8d 50 01             	lea    0x1(%eax),%edx
    43d1:	8b 45 08             	mov    0x8(%ebp),%eax
    43d4:	89 10                	mov    %edx,(%eax)
}
    43d6:	c9                   	leave  
    43d7:	c3                   	ret    
...
int empty_q(struct queue *q){
    43d8:	55                   	push   %ebp
    43d9:	89 e5                	mov    %esp,%ebp
    if(q->size == 0)
    43db:	8b 45 08             	mov    0x8(%ebp),%eax
    43de:	8b 00                	mov    (%eax),%eax
    43e0:	85 c0                	test   %eax,%eax
    43e2:	75 07                	jne    43eb <empty_q+0x13>
        return 1;
    43e4:	b8 01 00 00 00       	mov    $0x1,%eax
    43e9:	eb 05                	jmp    43f0 <empty_q+0x18>
    else
        return 0;
    43eb:	b8 00 00 00 00       	mov    $0x0,%eax
} 
    43f0:	5d                   	pop    %ebp
    43f1:	c3                   	ret    
...
int pop_q(struct queue *q){
    ...
    43f5:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    43f8:	8b 45 08             	mov    0x8(%ebp),%eax
    43fb:	89 04 24             	mov    %eax,(%esp)
    43fe:	e8 d5 ff ff ff       	call   43d8 <empty_q>
    4403:	85 c0                	test   %eax,%eax
    4405:	75 5d                	jne    4464 <pop_q+0x72>
       val = q->head->value; 
    4407:	8b 45 08             	mov    0x8(%ebp),%eax
    440a:	8b 40 04             	mov    0x4(%eax),%eax
    440d:	8b 00                	mov    (%eax),%eax
    440f:	89 45 f4             	mov    %eax,-0xc(%ebp)
       destroy = q->head;
    4412:	8b 45 08             	mov    0x8(%ebp),%eax
    4415:	8b 40 04             	mov    0x4(%eax),%eax
    4418:	89 45 f0             	mov    %eax,-0x10(%ebp)
       q->head = q->head->next;
    441b:	8b 45 08             	mov    0x8(%ebp),%eax
    441e:	8b 40 04             	mov    0x4(%eax),%eax
    4421:	8b 50 04             	mov    0x4(%eax),%edx
    4424:	8b 45 08             	mov    0x8(%ebp),%eax
    4427:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    442a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    442d:	89 04 24             	mov    %eax,(%esp)
    4430:	e8 46 fb ff ff       	call   3f7b <free>
       q->size--;
    4435:	8b 45 08             	mov    0x8(%ebp),%eax
    4438:	8b 00                	mov    (%eax),%eax
    443a:	8d 50 ff             	lea    -0x1(%eax),%edx
    443d:	8b 45 08             	mov    0x8(%ebp),%eax
    4440:	89 10                	mov    %edx,(%eax)
       if(q->size == 0){
    4442:	8b 45 08             	mov    0x8(%ebp),%eax
    4445:	8b 00                	mov    (%eax),%eax
    4447:	85 c0                	test   %eax,%eax
    4449:	75 14                	jne    445f <pop_q+0x6d>
            q->head = 0;
    444b:	8b 45 08             	mov    0x8(%ebp),%eax
    444e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    4455:	8b 45 08             	mov    0x8(%ebp),%eax
    4458:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    445f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4462:	eb 05                	jmp    4469 <pop_q+0x77>
    }
    return -1;
    4464:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    4469:	c9                   	leave  
    446a:	c3                   	ret    
