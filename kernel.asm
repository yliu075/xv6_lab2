...
80100049:	e8 6f 4e 00 00       	call   80104ebd <initlock>
...
801000bd:	e8 1c 4e 00 00       	call   80104ede <acquire>
...
80100104:	e8 37 4e 00 00       	call   80104f40 <release>
        return b;
...
8010017c:	e8 bf 4d 00 00       	call   80104f40 <release>
      return b;
...
8010023c:	e8 9d 4c 00 00       	call   80104ede <acquire>
...
801002a9:	e8 92 4c 00 00       	call   80104f40 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 1e 4b 00 00       	call   80104ede <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 aa 85 10 80 	movl   $0x801085aa,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec b3 85 10 80 	movl   $0x801085b3,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 08 4a 00 00       	call   80104f40 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 ba 85 10 80 	movl   $0x801085ba,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 c9 85 10 80 	movl   $0x801085c9,(%esp)
...
8010058f:	e8 fb 49 00 00       	call   80104f8f <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 cb 85 10 80 	movl   $0x801085cb,(%esp)
...
801006b2:	e8 4a 4b 00 00       	call   80105201 <memmove>
    pos -= 80;
...
801006e1:	e8 4c 4a 00 00       	call   80105132 <memset>
  }
...
80100776:	e8 4b 64 00 00       	call   80106bc6 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 3f 64 00 00       	call   80106bc6 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 33 64 00 00       	call   80106bc6 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 26 64 00 00       	call   80106bc6 <uartputc>
  cgaputc(c);
...
801007ba:	e8 1f 47 00 00       	call   80104ede <acquire>
  while((c = getc()) >= 0){
...
80100914:	e8 27 46 00 00       	call   80104f40 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 a0 45 00 00       	call   80104ede <acquire>
  while(n > 0){
...
80100959:	e8 e2 45 00 00       	call   80104f40 <release>
        ilock(ip);
...
801009fe:	e8 3d 45 00 00       	call   80104f40 <release>
  ilock(ip);
...
80100a32:	e8 a7 44 00 00       	call   80104ede <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 cf 44 00 00       	call   80104f40 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 cf 85 10 	movl   $0x801085cf,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
80100a96:	e8 22 44 00 00       	call   80104ebd <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 d7 85 10 	movl   $0x801085d7,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 c0 dd 10 80 	movl   $0x8010ddc0,(%esp)
80100aaa:	e8 0e 44 00 00       	call   80104ebd <initlock>
...
80100b64:	e9 70 03 00 00       	jmp    80100ed9 <exec+0x3ea>
  ...
  if((pgdir = setupkvm()) == 0)
80100b69:	e8 a9 71 00 00       	call   80107d17 <setupkvm>
...
80100c0a:	e8 d6 74 00 00       	call   801080e5 <allocuvm>
...
80100c48:	e8 ad 73 00 00       	call   80107ffa <loaduvm>
...
80100cb1:	e8 2f 74 00 00       	call   801080e5 <allocuvm>
...
80100ce2:	e8 2e 76 00 00       	call   80108315 <clearpteu>
...
80100d18:	e8 7f 46 00 00       	call   8010539c <strlen>
...
80100d41:	e8 56 46 00 00       	call   8010539c <strlen>
...
80100d71:	e8 64 77 00 00       	call   801084da <copyout>
...
80100e18:	e8 bd 76 00 00       	call   801084da <copyout>
...
80100e70:	e8 dd 44 00 00       	call   80105352 <safestrcpy>
...
80100ec2:	e8 41 6f 00 00       	call   80107e08 <switchuvm>
  freevm(oldpgdir);
80100ec7:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eca:	89 04 24             	mov    %eax,(%esp)
80100ecd:	e8 a9 73 00 00       	call   8010827b <freevm>
  return 0;
...
80100ee5:	e8 91 73 00 00       	call   8010827b <freevm>
  if(ip)
...
80100f08:	c7 44 24 04 dd 85 10 	movl   $0x801085dd,0x4(%esp)
80100f0f:	80 
80100f10:	c7 04 24 80 de 10 80 	movl   $0x8010de80,(%esp)
80100f17:	e8 a1 3f 00 00       	call   80104ebd <initlock>
}
80100f1c:	c9                   	leave  
80100f1d:	c3                   	ret    
...
80100f2b:	e8 ae 3f 00 00       	call   80104ede <acquire>
...
80100f54:	e8 e7 3f 00 00       	call   80104f40 <release>
      return f;
...
80100f72:	e8 c9 3f 00 00       	call   80104f40 <release>
  return 0;
...
80100f8b:	e8 4e 3f 00 00       	call   80104ede <acquire>
  if(f->ref < 1)
...
80100f98:	7f 0c                	jg     80100fa6 <filedup+0x28>
    panic("filedup");
80100f9a:	c7 04 24 e4 85 10 80 	movl   $0x801085e4,(%esp)
...
80100fbc:	e8 7f 3f 00 00       	call   80104f40 <release>
  return f;
...
80100fd3:	e8 06 3f 00 00       	call   80104ede <acquire>
  if(f->ref < 1)
...
80100fe0:	7f 0c                	jg     80100fee <fileclose+0x28>
    panic("fileclose");
80100fe2:	c7 04 24 ec 85 10 80 	movl   $0x801085ec,(%esp)
...
8010100e:	e8 2d 3f 00 00       	call   80104f40 <release>
...
80101058:	e8 e3 3e 00 00       	call   80104f40 <release>
...
80101197:	eb 0c                	jmp    801011a5 <fileread+0xba>
  ...
  panic("fileread");
80101199:	c7 04 24 f6 85 10 80 	movl   $0x801085f6,(%esp)
...
801012a5:	c7 04 24 ff 85 10 80 	movl   $0x801085ff,(%esp)
...
801012d5:	eb 0c                	jmp    801012e3 <filewrite+0x13c>
  ...
  panic("filewrite");
801012d7:	c7 04 24 0f 86 10 80 	movl   $0x8010860f,(%esp)
...
8010131d:	e8 df 3e 00 00       	call   80105201 <memmove>
  brelse(bp);
...
80101363:	e8 ca 3d 00 00       	call   80105132 <memset>
  log_write(bp);
...
801014c0:	c7 04 24 19 86 10 80 	movl   $0x80108619,(%esp)
...
80101552:	c7 04 24 2f 86 10 80 	movl   $0x8010862f,(%esp)
...
801015a2:	c7 44 24 04 42 86 10 	movl   $0x80108642,0x4(%esp)
801015a9:	80 
801015aa:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
801015b1:	e8 07 39 00 00       	call   80104ebd <initlock>
}
801015b6:	c9                   	leave  
801015b7:	c3                   	ret    
...
80101633:	e8 fa 3a 00 00       	call   80105132 <memset>
      dip->type = type;
...
80101689:	c7 04 24 49 86 10 80 	movl   $0x80108649,(%esp)
...
80101732:	e8 ca 3a 00 00       	call   80105201 <memmove>
  log_write(bp);
...
8010175c:	e8 7d 37 00 00       	call   80104ede <acquire>
...
801017a6:	e8 95 37 00 00       	call   80104f40 <release>
      return ip;
...
801017d9:	c7 04 24 5b 86 10 80 	movl   $0x8010865b,(%esp)
...
80101817:	e8 24 37 00 00       	call   80104f40 <release>
...
8010182e:	e8 ab 36 00 00       	call   80104ede <acquire>
  ip->ref++;
...
80101849:	e8 f2 36 00 00       	call   80104f40 <release>
  return ip;
...
80101867:	7f 0c                	jg     80101875 <ilock+0x22>
    panic("ilock");
80101869:	c7 04 24 6b 86 10 80 	movl   $0x8010866b,(%esp)
80101870:	e8 c5 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101875:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
8010187c:	e8 5d 36 00 00       	call   80104ede <acquire>
...
801018bb:	e8 80 36 00 00       	call   80104f40 <release>
...
80101966:	e8 96 38 00 00       	call   80105201 <memmove>
    brelse(bp);
...
80101991:	75 0c                	jne    8010199f <ilock+0x14c>
      panic("ilock: no type");
80101993:	c7 04 24 71 86 10 80 	movl   $0x80108671,(%esp)
...
801019c2:	7f 0c                	jg     801019d0 <iunlock+0x2f>
    panic("iunlock");
801019c4:	c7 04 24 80 86 10 80 	movl   $0x80108680,(%esp)
801019cb:	e8 6a eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019d0:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
801019d7:	e8 02 35 00 00       	call   80104ede <acquire>
  ip->flags &= ~I_BUSY;
...
801019ff:	e8 3c 35 00 00       	call   80104f40 <release>
}
80101a04:	c9                   	leave  
80101a05:	c3                   	ret    
...
80101a13:	e8 c6 34 00 00       	call   80104ede <acquire>
...
80101a4f:	74 0c                	je     80101a5d <iput+0x57>
      panic("iput busy");
80101a51:	c7 04 24 88 86 10 80 	movl   $0x80108688,(%esp)
...
80101a75:	e8 c6 34 00 00       	call   80104f40 <release>
    itrunc(ip);
...
80101aa0:	e8 39 34 00 00       	call   80104ede <acquire>
    ip->flags = 0;
...
80101ad0:	e8 6b 34 00 00       	call   80104f40 <release>
}
80101ad5:	c9                   	leave  
80101ad6:	c3                   	ret    
...
80101bf0:	c7 04 24 92 86 10 80 	movl   $0x80108692,(%esp)
...
80101e91:	e8 6b 33 00 00       	call   80105201 <memmove>
    brelse(bp);
...
80101ff0:	e8 0c 32 00 00       	call   80105201 <memmove>
    log_write(bp);
...
8010206e:	e8 31 32 00 00       	call   801052a4 <strncmp>
}
80102073:	c9                   	leave  
80102074:	c3                   	ret    
...
80102088:	c7 04 24 a5 86 10 80 	movl   $0x801086a5,(%esp)
...
801020c4:	74 0c                	je     801020d2 <dirlookup+0x5d>
      panic("dirlink read");
801020c6:	c7 04 24 b7 86 10 80 	movl   $0x801086b7,(%esp)
...
801021a9:	74 0c                	je     801021b7 <dirlink+0x79>
      panic("dirlink read");
801021ab:	c7 04 24 b7 86 10 80 	movl   $0x801086b7,(%esp)
...
801021f0:	e8 05 31 00 00       	call   801052fa <strncpy>
  de.inum = inum;
...
80102220:	74 0c                	je     8010222e <dirlink+0xf0>
    panic("dirlink");
80102222:	c7 04 24 c4 86 10 80 	movl   $0x801086c4,(%esp)
...
801022a7:	e8 55 2f 00 00       	call   80105201 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022c2:	e8 3a 2f 00 00       	call   80105201 <memmove>
    name[len] = 0;
...
80102511:	c7 44 24 04 cc 86 10 	movl   $0x801086cc,0x4(%esp)
80102518:	80 
80102519:	c7 04 24 20 b6 10 80 	movl   $0x8010b620,(%esp)
80102520:	e8 98 29 00 00       	call   80104ebd <initlock>
  picenable(IRQ_IDE);
...
801025bb:	75 0c                	jne    801025c9 <idestart+0x18>
    panic("idestart");
801025bd:	c7 04 24 d0 86 10 80 	movl   $0x801086d0,(%esp)
...
801026e3:	e8 f6 27 00 00       	call   80104ede <acquire>
  if((b = idequeue) == 0){
...
801026fd:	e8 3e 28 00 00       	call   80104f40 <release>
...
80102792:	e8 a9 27 00 00       	call   80104f40 <release>
}
80102797:	c9                   	leave  
80102798:	c3                   	ret    
...
801027ab:	c7 04 24 d9 86 10 80 	movl   $0x801086d9,(%esp)
...
801027c4:	c7 04 24 ed 86 10 80 	movl   $0x801086ed,(%esp)
...
8010286a:	e8 d1 26 00 00       	call   80104f40 <release>
}
8010286f:	c9                   	leave  
80102870:	c3                   	ret    
...
801028f8:	c7 04 24 20 87 10 80 	movl   $0x80108720,(%esp)
...
801029b2:	c7 44 24 04 52 87 10 	movl   $0x80108752,0x4(%esp)
801029b9:	80 
801029ba:	c7 04 24 60 f8 10 80 	movl   $0x8010f860,(%esp)
801029c1:	e8 f7 24 00 00       	call   80104ebd <initlock>
  kmem.use_lock = 0;
...
80102a6c:	76 0c                	jbe    80102a7a <kfree+0x39>
    panic("kfree");
80102a6e:	c7 04 24 57 87 10 80 	movl   $0x80108757,(%esp)
...
80102a90:	e8 9d 26 00 00       	call   80105132 <memset>
...
80102aa5:	e8 34 24 00 00       	call   80104ede <acquire>
  r = (struct run*)v;
...
80102ad3:	e8 68 24 00 00       	call   80104f40 <release>
}
80102ad8:	c9                   	leave  
80102ad9:	c3                   	ret    
...
80102af0:	e8 e9 23 00 00       	call   80104ede <acquire>
  r = kmem.freelist;
...
80102b1d:	e8 1e 24 00 00       	call   80104f40 <release>
  return (char*)r;
...
80102e80:	c7 04 24 60 87 10 80 	movl   $0x80108760,(%esp)
...
80102fd5:	c7 44 24 04 8c 87 10 	movl   $0x8010878c,0x4(%esp)
80102fdc:	80 
80102fdd:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
80102fe4:	e8 d4 1e 00 00       	call   80104ebd <initlock>
  readsb(ROOTDEV, &sb);
...
80103098:	e8 64 21 00 00       	call   80105201 <memmove>
...
801031ea:	e8 ef 1c 00 00       	call   80104ede <acquire>
  while (log.busy) {
...
8010321f:	e8 1c 1d 00 00       	call   80104f40 <release>
}
80103224:	c9                   	leave  
80103225:	c3                   	ret    
...
80103255:	e8 84 1c 00 00       	call   80104ede <acquire>
  log.busy = 0;
...
80103277:	e8 c4 1c 00 00       	call   80104f40 <release>
}
8010327c:	c9                   	leave  
8010327d:	c3                   	ret    
...
801032a0:	c7 04 24 90 87 10 80 	movl   $0x80108790,(%esp)
...
801032b5:	c7 04 24 a6 87 10 80 	movl   $0x801087a6,(%esp)
...
80103346:	e8 b6 1e 00 00       	call   80105201 <memmove>
  bwrite(lbuf);
...
801033fe:	c7 04 24 bd 87 10 80 	movl   $0x801087bd,(%esp)
...
80103419:	e8 98 36 00 00       	call   80106ab6 <uartinit>
  pinit();         // process table
8010341e:	e8 f1 0b 00 00       	call   80104014 <pinit>
  tvinit();        // trap vectors
80103423:	e8 40 32 00 00       	call   80106668 <tvinit>
  binit();         // buffer cache
...
80103445:	e8 69 31 00 00       	call   801065b3 <timerinit>
...
80103470:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
80103473:	e8 73 49 00 00       	call   80107deb <switchkvm>
  seginit();
80103478:	e8 ea 42 00 00       	call   80107767 <seginit>
  lapicinit();
...
8010349d:	c7 04 24 d4 87 10 80 	movl   $0x801087d4,(%esp)
801034a4:	e8 f7 ce ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
801034a9:	e8 2e 33 00 00       	call   801067dc <idtinit>
...
801034fb:	e8 01 1d 00 00       	call   80105201 <memmove>
...
8010367c:	00 
8010367d:	c7 44 24 04 e8 87 10 	movl   $0x801087e8,0x4(%esp)
80103684:	80 
80103685:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103688:	89 04 24             	mov    %eax,(%esp)
8010368b:	e8 19 1b 00 00       	call   801051a9 <memcmp>
...
801037bd:	00 
801037be:	c7 44 24 04 ed 87 10 	movl   $0x801087ed,0x4(%esp)
801037c5:	80 
801037c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037c9:	89 04 24             	mov    %eax,(%esp)
801037cc:	e8 d8 19 00 00       	call   801051a9 <memcmp>
...
8010389a:	8b 04 85 30 88 10 80 	mov    -0x7fef77d0(,%eax,4),%eax
...
801038d3:	c7 04 24 f2 87 10 80 	movl   $0x801087f2,(%esp)
...
80103966:	c7 04 24 10 88 10 80 	movl   $0x80108810,(%esp)
...
80103c5f:	c7 44 24 04 44 88 10 	movl   $0x80108844,0x4(%esp)
80103c66:	80 
80103c67:	89 04 24             	mov    %eax,(%esp)
80103c6a:	e8 4e 12 00 00       	call   80104ebd <initlock>
  (*f0)->type = FD_PIPE;
...
80103d16:	e8 c3 11 00 00       	call   80104ede <acquire>
  if(writable){
...
80103d7d:	e8 be 11 00 00       	call   80104f40 <release>
    kfree((char*)p);
...
80103d95:	e8 a6 11 00 00       	call   80104f40 <release>
}
80103d9a:	c9                   	leave  
80103d9b:	c3                   	ret    
...
80103da8:	e8 31 11 00 00       	call   80104ede <acquire>
  for(i = 0; i < n; i++){
...
80103ddb:	e8 60 11 00 00       	call   80104f40 <release>
        return -1;
...
80103e81:	e8 ba 10 00 00       	call   80104f40 <release>
  return n;
...
80103e98:	e8 41 10 00 00       	call   80104ede <acquire>
...
80103eb2:	e8 89 10 00 00       	call   80104f40 <release>
      return -1;
...
80103f6e:	e8 cd 0f 00 00       	call   80104f40 <release>
  return i;
...
8010401a:	c7 44 24 04 4c 88 10 	movl   $0x8010884c,0x4(%esp)
80104021:	80 
80104022:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104029:	e8 8f 0e 00 00       	call   80104ebd <initlock>
}
8010402e:	c9                   	leave  
8010402f:	c3                   	ret    
...
8010403d:	e8 9c 0e 00 00       	call   80104ede <acquire>
...
8010407b:	e8 c0 0e 00 00       	call   80104f40 <release>
...
801040ae:	e8 8d 0e 00 00       	call   80104f40 <release>
    return 0;
...
801040ea:	ba 23 66 10 80       	mov    $0x80106623,%edx
...
8010411a:	e8 13 10 00 00       	call   80105132 <memset>
...
80104148:	e8 ca 3b 00 00       	call   80107d17 <setupkvm>
...
8010415d:	c7 04 24 53 88 10 80 	movl   $0x80108853,(%esp)
...
80104183:	e8 e7 3d 00 00       	call   80107f6f <inituvm>
    p->sz = PGSIZE;
...
801041aa:	e8 83 0f 00 00       	call   80105132 <memset>
...
80104223:	00 
80104224:	c7 44 24 04 6c 88 10 	movl   $0x8010886c,0x4(%esp)
8010422b:	80 
8010422c:	89 04 24             	mov    %eax,(%esp)
8010422f:	e8 1e 11 00 00       	call   80105352 <safestrcpy>
    p->cwd = namei("/");
80104234:	c7 04 24 75 88 10 80 	movl   $0x80108875,(%esp)
...
80104288:	e8 58 3e 00 00       	call   801080e5 <allocuvm>
...
801042c2:	e8 f8 3e 00 00       	call   801081bf <deallocuvm>
...
801042eb:	e8 18 3b 00 00       	call   80107e08 <switchuvm>
    return 0;
...
80104330:	e8 26 40 00 00       	call   8010835b <copyuvm>
...
80104457:	e8 f6 0e 00 00       	call   80105352 <safestrcpy>
    return pid;
...
801045de:	e8 f7 3e 00 00       	call   801084da <copyout>
801045e3:	85 c0                	test   %eax,%eax
801045e5:	79 16                	jns    801045fd <clone+0x196>
        cprintf("push arg fails\n");
801045e7:	c7 04 24 77 88 10 80 	movl   $0x80108877,(%esp)
...
80104632:	e8 d1 37 00 00       	call   80107e08 <switchuvm>

     acquire(&ptable.lock);
80104637:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010463e:	e8 9b 08 00 00       	call   80104ede <acquire>
    np->state = RUNNABLE;
...
80104654:	e8 e7 08 00 00       	call   80104f40 <release>
    safestrcpy(np->name, proc->name, sizeof(proc->name));
...
80104677:	e8 d6 0c 00 00       	call   80105352 <safestrcpy>
...
8010469e:	75 0c                	jne    801046ac <exit+0x22>
        panic("init exiting");
801046a0:	c7 04 24 87 88 10 80 	movl   $0x80108887,(%esp)
...
80104724:	e8 b5 07 00 00       	call   80104ede <acquire>
...
80104794:	e8 95 02 00 00       	call   80104a2e <sched>
    panic("zombie exit");
80104799:	c7 04 24 94 88 10 80 	movl   $0x80108894,(%esp)
...
801047b9:	75 0c                	jne    801047c7 <texit+0x22>
        panic("init exiting");
801047bb:	c7 04 24 87 88 10 80 	movl   $0x80108887,(%esp)
...
8010483f:	e8 9a 06 00 00       	call   80104ede <acquire>
    // Parent might be sleeping in wait().
    wakeup1(proc->parent);
...
80104862:	e8 c7 01 00 00       	call   80104a2e <sched>
    panic("zombie exit");
80104867:	c7 04 24 94 88 10 80 	movl   $0x80108894,(%esp)
...
80104880:	e8 59 06 00 00       	call   80104ede <acquire>
    for(;;){
...
801048f7:	e8 7f 39 00 00       	call   8010827b <freevm>
                }
                p->state = UNUSED;
...
80104932:	e8 09 06 00 00       	call   80104f40 <release>
                return pid;
...
8010496a:	e8 d1 05 00 00       	call   80104f40 <release>
            return -1;
...
801049a5:	e8 34 05 00 00       	call   80104ede <acquire>
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801049cf:	e8 34 34 00 00       	call   80107e08 <switchuvm>
            p->state = RUNNING;
...
801049f8:	e8 c6 09 00 00       	call   801053c3 <swtch>
            switchkvm();
801049fd:	e8 e9 33 00 00       	call   80107deb <switchkvm>
...
80104a24:	e8 17 05 00 00       	call   80104f40 <release>
...
80104a3b:	e8 c8 05 00 00       	call   80105008 <holding>
80104a40:	85 c0                	test   %eax,%eax
80104a42:	75 0c                	jne    80104a50 <sched+0x22>
        panic("sched ptable.lock");
80104a44:	c7 04 24 a0 88 10 80 	movl   $0x801088a0,(%esp)
...
80104a7e:	c7 04 24 b4 88 10 80 	movl   $0x801088b4,(%esp)
80104a85:	e8 16 b9 ff ff       	call   801003a0 <cprintf>
        panic("sched locks");
80104a8a:	c7 04 24 d3 88 10 80 	movl   $0x801088d3,(%esp)
...
80104aa2:	75 0c                	jne    80104ab0 <sched+0x82>
        panic("sched running");
80104aa4:	c7 04 24 df 88 10 80 	movl   $0x801088df,(%esp)
...
80104abe:	c7 04 24 ed 88 10 80 	movl   $0x801088ed,(%esp)
...
80104af3:	e8 cb 08 00 00       	call   801053c3 <swtch>
    cpu->intena = intena;
...
80104b16:	e8 c3 03 00 00       	call   80104ede <acquire>
    proc->state = RUNNABLE;
...
80104b34:	e8 07 04 00 00       	call   80104f40 <release>
}
80104b39:	c9                   	leave  
80104b3a:	c3                   	ret    
...
80104b48:	e8 f3 03 00 00       	call   80104f40 <release>
...
80104b75:	75 0c                	jne    80104b83 <sleep+0x1c>
        panic("sleep");
80104b77:	c7 04 24 01 89 10 80 	movl   $0x80108901,(%esp)
...
80104b89:	c7 04 24 07 89 10 80 	movl   $0x80108907,(%esp)
...
80104ba5:	e8 34 03 00 00       	call   80104ede <acquire>
        release(lk);
80104baa:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bad:	89 04 24             	mov    %eax,(%esp)
80104bb0:	e8 8b 03 00 00       	call   80104f40 <release>
    }
...
80104bf0:	e8 4b 03 00 00       	call   80104f40 <release>
        acquire(lk);
80104bf5:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bf8:	89 04 24             	mov    %eax,(%esp)
80104bfb:	e8 de 02 00 00       	call   80104ede <acquire>
    }
}
80104c00:	c9                   	leave  
80104c01:	c3                   	ret    
...
80104c50:	e8 89 02 00 00       	call   80104ede <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104ca4:	e8 97 02 00 00       	call   80104f40 <release>
}
80104ca9:	c9                   	leave  
80104caa:	c3                   	ret    
...
80104cb8:	e8 21 02 00 00       	call   80104ede <acquire>
    wakeup1(chan);
...
80104ccf:	e8 6c 02 00 00       	call   80104f40 <release>
}
80104cd4:	c9                   	leave  
80104cd5:	c3                   	ret    
...
80104ce3:	e8 f6 01 00 00       	call   80104ede <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104d22:	e8 19 02 00 00       	call   80104f40 <release>
            return 0;
...
80104d45:	e8 f6 01 00 00       	call   80104f40 <release>
    return -1;
...
80104d9e:	eb 07                	jmp    80104da7 <procdump+0x56>
            ...
            state = "???";
80104da0:	c7 45 ec 18 89 10 80 	movl   $0x80108918,-0x14(%ebp)
...
80104dc2:	c7 04 24 1c 89 10 80 	movl   $0x8010891c,(%esp)
...
80104def:	e8 9b 01 00 00       	call   80104f8f <getcallerpcs>
...
80104e08:	c7 04 24 25 89 10 80 	movl   $0x80108925,(%esp)
...
80104e27:	75 d4                	jne    80104dfd <procdump+0xac>
        ...
        cprintf("\n");
80104e29:	c7 04 24 29 89 10 80 	movl   $0x80108929,(%esp)
...
80104e58:	e8 81 00 00 00       	call   80104ede <acquire>
...
80104e7a:	e8 c1 00 00 00       	call   80104f40 <release>

}
80104e7f:	c9                   	leave  
80104e80:	c3                   	ret    

80104e81 <thread_yield>:
...
80104e8d:	9c                   	pushf  
80104e8e:	58                   	pop    %eax
80104e8f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
...
80104eb2:	f0 87 02             	lock xchg %eax,(%edx)
80104eb5:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104eb8:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80104ebb:	c9                   	leave  
80104ebc:	c3                   	ret    
...
80104ec6:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104ec9:	8b 45 08             	mov    0x8(%ebp),%eax
80104ecc:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104ed2:	8b 45 08             	mov    0x8(%ebp),%eax
80104ed5:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104edc:	5d                   	pop    %ebp
80104edd:	c3                   	ret    
...
80104ee1:	83 ec 18             	sub    $0x18,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80104ee4:	e8 49 01 00 00       	call   80105032 <pushcli>
  if(holding(lk))
80104ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80104eec:	89 04 24             	mov    %eax,(%esp)
80104eef:	e8 14 01 00 00       	call   80105008 <holding>
80104ef4:	85 c0                	test   %eax,%eax
80104ef6:	74 0c                	je     80104f04 <acquire+0x26>
    panic("acquire");
80104ef8:	c7 04 24 55 89 10 80 	movl   $0x80108955,(%esp)
...
80104f08:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104f0f:	00 
80104f10:	89 04 24             	mov    %eax,(%esp)
80104f13:	e8 8b ff ff ff       	call   80104ea3 <xchg>
80104f18:	85 c0                	test   %eax,%eax
80104f1a:	75 e9                	jne    80104f05 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104f1c:	8b 45 08             	mov    0x8(%ebp),%eax
80104f1f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104f26:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104f29:	8b 45 08             	mov    0x8(%ebp),%eax
80104f2c:	83 c0 0c             	add    $0xc,%eax
80104f2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f33:	8d 45 08             	lea    0x8(%ebp),%eax
80104f36:	89 04 24             	mov    %eax,(%esp)
80104f39:	e8 51 00 00 00       	call   80104f8f <getcallerpcs>
}
80104f3e:	c9                   	leave  
80104f3f:	c3                   	ret    
...
80104f4c:	e8 b7 00 00 00       	call   80105008 <holding>
80104f51:	85 c0                	test   %eax,%eax
80104f53:	75 0c                	jne    80104f61 <release+0x21>
    panic("release");
80104f55:	c7 04 24 5d 89 10 80 	movl   $0x8010895d,(%esp)
80104f5c:	e8 d9 b5 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104f61:	8b 45 08             	mov    0x8(%ebp),%eax
80104f64:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
...
80104f78:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104f7f:	00 
80104f80:	89 04 24             	mov    %eax,(%esp)
80104f83:	e8 1b ff ff ff       	call   80104ea3 <xchg>

  popcli();
80104f88:	e8 e9 00 00 00       	call   80105076 <popcli>
}
80104f8d:	c9                   	leave  
80104f8e:	c3                   	ret    

80104f8f <getcallerpcs>:
...
80104f98:	83 e8 08             	sub    $0x8,%eax
80104f9b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104f9e:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104fa5:	eb 38                	jmp    80104fdf <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104fa7:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104fab:	74 38                	je     80104fe5 <getcallerpcs+0x56>
80104fad:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104fb4:	76 2f                	jbe    80104fe5 <getcallerpcs+0x56>
80104fb6:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104fba:	74 29                	je     80104fe5 <getcallerpcs+0x56>
      break;
...
80104fce:	8b 40 04             	mov    0x4(%eax),%eax
80104fd1:	89 02                	mov    %eax,(%edx)
...
80104fe3:	7e c2                	jle    80104fa7 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104fe5:	eb 19                	jmp    80105000 <getcallerpcs+0x71>
    pcs[i] = 0;
80104fe7:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104fea:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104ff1:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ff4:	01 d0                	add    %edx,%eax
80104ff6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104ffc:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105000:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105004:	7e e1                	jle    80104fe7 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105006:	c9                   	leave  
80105007:	c3                   	ret    
...
80105012:	74 17                	je     8010502b <holding+0x23>
80105014:	8b 45 08             	mov    0x8(%ebp),%eax
80105017:	8b 50 08             	mov    0x8(%eax),%edx
8010501a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105020:	39 c2                	cmp    %eax,%edx
80105022:	75 07                	jne    8010502b <holding+0x23>
80105024:	b8 01 00 00 00       	mov    $0x1,%eax
80105029:	eb 05                	jmp    80105030 <holding+0x28>
...
80105035:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105038:	e8 4a fe ff ff       	call   80104e87 <readeflags>
8010503d:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105040:	e8 52 fe ff ff       	call   80104e97 <cli>
  if(cpu->ncli++ == 0)
80105045:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010504c:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80105052:	8d 48 01             	lea    0x1(%eax),%ecx
80105055:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
8010505b:	85 c0                	test   %eax,%eax
8010505d:	75 15                	jne    80105074 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
8010505f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105065:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105068:	81 e2 00 02 00 00    	and    $0x200,%edx
8010506e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105074:	c9                   	leave  
80105075:	c3                   	ret    
...
80105079:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010507c:	e8 06 fe ff ff       	call   80104e87 <readeflags>
80105081:	25 00 02 00 00       	and    $0x200,%eax
80105086:	85 c0                	test   %eax,%eax
80105088:	74 0c                	je     80105096 <popcli+0x20>
    panic("popcli - interruptible");
8010508a:	c7 04 24 65 89 10 80 	movl   $0x80108965,(%esp)
80105091:	e8 a4 b4 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80105096:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010509c:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801050a2:	83 ea 01             	sub    $0x1,%edx
801050a5:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801050ab:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050b1:	85 c0                	test   %eax,%eax
801050b3:	79 0c                	jns    801050c1 <popcli+0x4b>
    panic("popcli");
801050b5:	c7 04 24 7c 89 10 80 	movl   $0x8010897c,(%esp)
801050bc:	e8 79 b4 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
801050c1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050c7:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050cd:	85 c0                	test   %eax,%eax
801050cf:	75 15                	jne    801050e6 <popcli+0x70>
801050d1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050d7:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801050dd:	85 c0                	test   %eax,%eax
801050df:	74 05                	je     801050e6 <popcli+0x70>
    sti();
801050e1:	e8 b7 fd ff ff       	call   80104e9d <sti>
}
801050e6:	c9                   	leave  
801050e7:	c3                   	ret    
...
8010515e:	c1 e0 18             	shl    $0x18,%eax
80105161:	89 c1                	mov    %eax,%ecx
...
801051b8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801051bb:	eb 30                	jmp    801051ed <memcmp+0x44>
    if(*s1 != *s2)
...
801051cb:	74 18                	je     801051e5 <memcmp+0x3c>
      return *s1 - *s2;
...
801051e3:	eb 1a                	jmp    801051ff <memcmp+0x56>
    s1++, s2++;
801051e5:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801051f8:	75 c3                	jne    801051bd <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105216:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105219:	73 3d                	jae    80105258 <memmove+0x57>
8010521b:	8b 45 10             	mov    0x10(%ebp),%eax
8010521e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105221:	01 d0                	add    %edx,%eax
80105223:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105226:	76 30                	jbe    80105258 <memmove+0x57>
    s += n;
80105228:	8b 45 10             	mov    0x10(%ebp),%eax
8010522b:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010522e:	8b 45 10             	mov    0x10(%ebp),%eax
80105231:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105234:	eb 13                	jmp    80105249 <memmove+0x48>
      *--d = *--s;
80105236:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010523a:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010523e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105241:	0f b6 10             	movzbl (%eax),%edx
80105244:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105247:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
80105254:	75 e0                	jne    80105236 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105256:	eb 26                	jmp    8010527e <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105258:	eb 17                	jmp    80105271 <memmove+0x70>
      *d++ = *s++;
8010525a:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010525d:	8d 50 01             	lea    0x1(%eax),%edx
80105260:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105263:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105266:	8d 4a 01             	lea    0x1(%edx),%ecx
80105269:	89 4d fc             	mov    %ecx,-0x4(%ebp)
8010526c:	0f b6 12             	movzbl (%edx),%edx
8010526f:	88 10                	mov    %dl,(%eax)
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105271:	8b 45 10             	mov    0x10(%ebp),%eax
80105274:	8d 50 ff             	lea    -0x1(%eax),%edx
80105277:	89 55 10             	mov    %edx,0x10(%ebp)
8010527a:	85 c0                	test   %eax,%eax
8010527c:	75 dc                	jne    8010525a <memmove+0x59>
      *d++ = *s++;
...
8010528c:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010529d:	e8 5f ff ff ff       	call   80105201 <memmove>
}
801052a2:	c9                   	leave  
801052a3:	c3                   	ret    
...
801052a5:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801052a7:	eb 0c                	jmp    801052b5 <strncmp+0x11>
    n--, p++, q++;
801052a9:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801052ad:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801052b1:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801052b9:	74 1a                	je     801052d5 <strncmp+0x31>
801052bb:	8b 45 08             	mov    0x8(%ebp),%eax
801052be:	0f b6 00             	movzbl (%eax),%eax
801052c1:	84 c0                	test   %al,%al
801052c3:	74 10                	je     801052d5 <strncmp+0x31>
801052c5:	8b 45 08             	mov    0x8(%ebp),%eax
801052c8:	0f b6 10             	movzbl (%eax),%edx
801052cb:	8b 45 0c             	mov    0xc(%ebp),%eax
801052ce:	0f b6 00             	movzbl (%eax),%eax
801052d1:	38 c2                	cmp    %al,%dl
801052d3:	74 d4                	je     801052a9 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801052d5:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052d9:	75 07                	jne    801052e2 <strncmp+0x3e>
    return 0;
801052db:	b8 00 00 00 00       	mov    $0x0,%eax
801052e0:	eb 16                	jmp    801052f8 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
801052e2:	8b 45 08             	mov    0x8(%ebp),%eax
801052e5:	0f b6 00             	movzbl (%eax),%eax
801052e8:	0f b6 d0             	movzbl %al,%edx
801052eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801052ee:	0f b6 00             	movzbl (%eax),%eax
801052f1:	0f b6 c0             	movzbl %al,%eax
801052f4:	29 c2                	sub    %eax,%edx
...
80105312:	7e 1e                	jle    80105332 <strncpy+0x38>
...
80105330:	75 d5                	jne    80105307 <strncpy+0xd>
    ;
  while(n-- > 0)
80105332:	eb 0c                	jmp    80105340 <strncpy+0x46>
    *s++ = 0;
...
8010534b:	7f e7                	jg     80105334 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
80105367:	eb 31                	jmp    8010539a <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105369:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010536d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105371:	7e 1e                	jle    80105391 <safestrcpy+0x3f>
...
8010537f:	8d 4a 01             	lea    0x1(%edx),%ecx
80105382:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105385:	0f b6 12             	movzbl (%edx),%edx
80105388:	88 10                	mov    %dl,(%eax)
8010538a:	0f b6 00             	movzbl (%eax),%eax
8010538d:	84 c0                	test   %al,%al
8010538f:	75 d8                	jne    80105369 <safestrcpy+0x17>
    ;
  *s = 0;
80105391:	8b 45 08             	mov    0x8(%ebp),%eax
80105394:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
8010539f:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
801053a2:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801053a9:	eb 04                	jmp    801053af <strlen+0x13>
801053ab:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801053af:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053b2:	8b 45 08             	mov    0x8(%ebp),%eax
801053b5:	01 d0                	add    %edx,%eax
801053b7:	0f b6 00             	movzbl (%eax),%eax
801053ba:	84 c0                	test   %al,%al
801053bc:	75 ed                	jne    801053ab <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801053c3:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801053c7:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801053cc:	53                   	push   %ebx
  pushl %esi
801053cd:	56                   	push   %esi
  pushl %edi
801053ce:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
801053cf:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801053d1:	89 d4                	mov    %edx,%esp
...
8010542a:	eb 46                	jmp    80105472 <fetchstr+0x60>
  *pp = (char*)addr;
...
8010545f:	eb 11                	jmp    80105472 <fetchstr+0x60>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
80105461:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105465:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105468:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010546b:	72 dc                	jb     80105449 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105483:	8b 50 44             	mov    0x44(%eax),%edx
80105486:	8b 45 08             	mov    0x8(%ebp),%eax
80105489:	c1 e0 02             	shl    $0x2,%eax
8010548c:	01 d0                	add    %edx,%eax
8010548e:	8d 50 04             	lea    0x4(%eax),%edx
80105491:	8b 45 0c             	mov    0xc(%ebp),%eax
80105494:	89 44 24 04          	mov    %eax,0x4(%esp)
80105498:	89 14 24             	mov    %edx,(%esp)
8010549b:	e8 38 ff ff ff       	call   801053d8 <fetchint>
}
801054a0:	c9                   	leave  
801054a1:	c3                   	ret    
...
80105534:	e8 d9 fe ff ff       	call   80105412 <fetchstr>
}
80105539:	c9                   	leave  
8010553a:	c3                   	ret    
...
8010553f:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105542:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105548:	8b 40 18             	mov    0x18(%eax),%eax
8010554b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010554e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105551:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105555:	7e 30                	jle    80105587 <syscall+0x4c>
80105557:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010555a:	83 f8 1a             	cmp    $0x1a,%eax
8010555d:	77 28                	ja     80105587 <syscall+0x4c>
8010555f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105562:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105569:	85 c0                	test   %eax,%eax
8010556b:	74 1a                	je     80105587 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
8010556d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105573:	8b 58 18             	mov    0x18(%eax),%ebx
80105576:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105579:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105580:	ff d0                	call   *%eax
80105582:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105585:	eb 3d                	jmp    801055c4 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105587:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010558d:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
8010559c:	89 54 24 0c          	mov    %edx,0xc(%esp)
801055a0:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801055a4:	89 44 24 04          	mov    %eax,0x4(%esp)
801055a8:	c7 04 24 83 89 10 80 	movl   $0x80108983,(%esp)
801055af:	e8 ec ad ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801055b4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055ba:	8b 40 18             	mov    0x18(%eax),%eax
801055bd:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
801055dd:	e8 92 fe ff ff       	call   80105474 <argint>
801055e2:	85 c0                	test   %eax,%eax
801055e4:	79 07                	jns    801055ed <argfd+0x23>
    return -1;
801055e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055eb:	eb 50                	jmp    8010563d <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801055ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055f0:	85 c0                	test   %eax,%eax
801055f2:	78 21                	js     80105615 <argfd+0x4b>
801055f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055f7:	83 f8 0f             	cmp    $0xf,%eax
801055fa:	7f 19                	jg     80105615 <argfd+0x4b>
801055fc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105602:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80105613:	75 07                	jne    8010561c <argfd+0x52>
    return -1;
80105615:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010561a:	eb 21                	jmp    8010563d <argfd+0x73>
  if(pfd)
8010561c:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105620:	74 08                	je     8010562a <argfd+0x60>
    *pfd = fd;
80105622:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105625:	8b 45 0c             	mov    0xc(%ebp),%eax
80105628:	89 10                	mov    %edx,(%eax)
  if(pf)
8010562a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010562e:	74 08                	je     80105638 <argfd+0x6e>
    *pf = f;
...
80105642:	83 ec 10             	sub    $0x10,%esp
  int fd;

  for(fd = 0; fd < NOFILE; fd++){
80105645:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010564c:	eb 30                	jmp    8010567e <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
8010564e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105654:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105657:	83 c2 08             	add    $0x8,%edx
8010565a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010565e:	85 c0                	test   %eax,%eax
80105660:	75 18                	jne    8010567a <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105662:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105668:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010566b:	8d 4a 08             	lea    0x8(%edx),%ecx
8010566e:	8b 55 08             	mov    0x8(%ebp),%edx
80105671:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105675:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105678:	eb 0f                	jmp    80105689 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
8010567e:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105682:	7e ca                	jle    8010564e <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
8010568e:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
80105691:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105694:	89 44 24 08          	mov    %eax,0x8(%esp)
80105698:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010569f:	00 
801056a0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056a7:	e8 1e ff ff ff       	call   801055ca <argfd>
801056ac:	85 c0                	test   %eax,%eax
801056ae:	79 07                	jns    801056b7 <sys_dup+0x2c>
    return -1;
801056b0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056b5:	eb 29                	jmp    801056e0 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801056b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056ba:	89 04 24             	mov    %eax,(%esp)
801056bd:	e8 7d ff ff ff       	call   8010563f <fdalloc>
801056c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056c5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801056c9:	79 07                	jns    801056d2 <sys_dup+0x47>
    return -1;
801056cb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056d0:	eb 0e                	jmp    801056e0 <sys_dup+0x55>
  filedup(f);
801056d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056d5:	89 04 24             	mov    %eax,(%esp)
801056d8:	e8 a1 b8 ff ff       	call   80100f7e <filedup>
  return fd;
...
801056ef:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801056f6:	00 
801056f7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056fe:	e8 c7 fe ff ff       	call   801055ca <argfd>
80105703:	85 c0                	test   %eax,%eax
80105705:	78 35                	js     8010573c <sys_read+0x5a>
80105707:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010570a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010570e:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105715:	e8 5a fd ff ff       	call   80105474 <argint>
8010571a:	85 c0                	test   %eax,%eax
8010571c:	78 1e                	js     8010573c <sys_read+0x5a>
8010571e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105721:	89 44 24 08          	mov    %eax,0x8(%esp)
80105725:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105728:	89 44 24 04          	mov    %eax,0x4(%esp)
8010572c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105733:	e8 6a fd ff ff       	call   801054a2 <argptr>
80105738:	85 c0                	test   %eax,%eax
8010573a:	79 07                	jns    80105743 <sys_read+0x61>
    return -1;
8010573c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105741:	eb 19                	jmp    8010575c <sys_read+0x7a>
  return fileread(f, p, n);
80105743:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105746:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105749:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010574c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105750:	89 54 24 04          	mov    %edx,0x4(%esp)
80105754:	89 04 24             	mov    %eax,(%esp)
80105757:	e8 8f b9 ff ff       	call   801010eb <fileread>
}
8010575c:	c9                   	leave  
8010575d:	c3                   	ret    
...
8010577a:	e8 4b fe ff ff       	call   801055ca <argfd>
8010577f:	85 c0                	test   %eax,%eax
80105781:	78 35                	js     801057b8 <sys_write+0x5a>
80105783:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105786:	89 44 24 04          	mov    %eax,0x4(%esp)
8010578a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105791:	e8 de fc ff ff       	call   80105474 <argint>
80105796:	85 c0                	test   %eax,%eax
80105798:	78 1e                	js     801057b8 <sys_write+0x5a>
8010579a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010579d:	89 44 24 08          	mov    %eax,0x8(%esp)
801057a1:	8d 45 ec             	lea    -0x14(%ebp),%eax
801057a4:	89 44 24 04          	mov    %eax,0x4(%esp)
801057a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057af:	e8 ee fc ff ff       	call   801054a2 <argptr>
801057b4:	85 c0                	test   %eax,%eax
801057b6:	79 07                	jns    801057bf <sys_write+0x61>
    return -1;
801057b8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057bd:	eb 19                	jmp    801057d8 <sys_write+0x7a>
  return filewrite(f, p, n);
801057bf:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801057c2:	8b 55 ec             	mov    -0x14(%ebp),%edx
801057c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057c8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801057cc:	89 54 24 04          	mov    %edx,0x4(%esp)
801057d0:	89 04 24             	mov    %eax,(%esp)
801057d3:	e8 cf b9 ff ff       	call   801011a7 <filewrite>
}
801057d8:	c9                   	leave  
801057d9:	c3                   	ret    
...
801057dd:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
801057f5:	e8 d0 fd ff ff       	call   801055ca <argfd>
801057fa:	85 c0                	test   %eax,%eax
801057fc:	79 07                	jns    80105805 <sys_close+0x2b>
    return -1;
801057fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105803:	eb 24                	jmp    80105829 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105805:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010580b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010580e:	83 c2 08             	add    $0x8,%edx
80105811:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105818:	00 
  fileclose(f);
80105819:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010581c:	89 04 24             	mov    %eax,(%esp)
8010581f:	e8 a2 b7 ff ff       	call   80100fc6 <fileclose>
  return 0;
...
80105847:	e8 7e fd ff ff       	call   801055ca <argfd>
8010584c:	85 c0                	test   %eax,%eax
8010584e:	78 1f                	js     8010586f <sys_fstat+0x44>
80105850:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105857:	00 
80105858:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010585b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010585f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105866:	e8 37 fc ff ff       	call   801054a2 <argptr>
8010586b:	85 c0                	test   %eax,%eax
8010586d:	79 07                	jns    80105876 <sys_fstat+0x4b>
    return -1;
8010586f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105874:	eb 12                	jmp    80105888 <sys_fstat+0x5d>
  return filestat(f, st);
80105876:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105879:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587c:	89 54 24 04          	mov    %edx,0x4(%esp)
80105880:	89 04 24             	mov    %eax,(%esp)
80105883:	e8 14 b8 ff ff       	call   8010109c <filestat>
}
80105888:	c9                   	leave  
80105889:	c3                   	ret    
...
8010588d:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105890:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105893:	89 44 24 04          	mov    %eax,0x4(%esp)
80105897:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010589e:	e8 61 fc ff ff       	call   80105504 <argstr>
801058a3:	85 c0                	test   %eax,%eax
801058a5:	78 17                	js     801058be <sys_link+0x34>
801058a7:	8d 45 dc             	lea    -0x24(%ebp),%eax
801058aa:	89 44 24 04          	mov    %eax,0x4(%esp)
801058ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801058b5:	e8 4a fc ff ff       	call   80105504 <argstr>
801058ba:	85 c0                	test   %eax,%eax
801058bc:	79 0a                	jns    801058c8 <sys_link+0x3e>
    return -1;
801058be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058c3:	e9 3d 01 00 00       	jmp    80105a05 <sys_link+0x17b>
  if((ip = namei(old)) == 0)
801058c8:	8b 45 d8             	mov    -0x28(%ebp),%eax
801058cb:	89 04 24             	mov    %eax,(%esp)
801058ce:	e8 2b cb ff ff       	call   801023fe <namei>
801058d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058d6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058da:	75 0a                	jne    801058e6 <sys_link+0x5c>
    return -1;
801058dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058e1:	e9 1f 01 00 00       	jmp    80105a05 <sys_link+0x17b>

  begin_trans();
801058e6:	e8 f2 d8 ff ff       	call   801031dd <begin_trans>

  ilock(ip);
801058eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058ee:	89 04 24             	mov    %eax,(%esp)
801058f1:	e8 5d bf ff ff       	call   80101853 <ilock>
  if(ip->type == T_DIR){
801058f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058f9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801058fd:	66 83 f8 01          	cmp    $0x1,%ax
80105901:	75 1a                	jne    8010591d <sys_link+0x93>
    iunlockput(ip);
80105903:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105906:	89 04 24             	mov    %eax,(%esp)
80105909:	e8 c9 c1 ff ff       	call   80101ad7 <iunlockput>
    commit_trans();
8010590e:	e8 13 d9 ff ff       	call   80103226 <commit_trans>
    return -1;
80105913:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105918:	e9 e8 00 00 00       	jmp    80105a05 <sys_link+0x17b>
  }

  ip->nlink++;
8010591d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105920:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105924:	8d 50 01             	lea    0x1(%eax),%edx
80105927:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010592a:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010592e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105931:	89 04 24             	mov    %eax,(%esp)
80105934:	e8 5e bd ff ff       	call   80101697 <iupdate>
  iunlock(ip);
80105939:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010593c:	89 04 24             	mov    %eax,(%esp)
8010593f:	e8 5d c0 ff ff       	call   801019a1 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105944:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105947:	8d 55 e2             	lea    -0x1e(%ebp),%edx
8010594a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010594e:	89 04 24             	mov    %eax,(%esp)
80105951:	e8 ca ca ff ff       	call   80102420 <nameiparent>
80105956:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105959:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010595d:	75 02                	jne    80105961 <sys_link+0xd7>
    goto bad;
8010595f:	eb 68                	jmp    801059c9 <sys_link+0x13f>
  ilock(dp);
80105961:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105964:	89 04 24             	mov    %eax,(%esp)
80105967:	e8 e7 be ff ff       	call   80101853 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010596c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596f:	8b 10                	mov    (%eax),%edx
80105971:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105974:	8b 00                	mov    (%eax),%eax
80105976:	39 c2                	cmp    %eax,%edx
80105978:	75 20                	jne    8010599a <sys_link+0x110>
8010597a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010597d:	8b 40 04             	mov    0x4(%eax),%eax
80105980:	89 44 24 08          	mov    %eax,0x8(%esp)
80105984:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105987:	89 44 24 04          	mov    %eax,0x4(%esp)
8010598b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010598e:	89 04 24             	mov    %eax,(%esp)
80105991:	e8 a8 c7 ff ff       	call   8010213e <dirlink>
80105996:	85 c0                	test   %eax,%eax
80105998:	79 0d                	jns    801059a7 <sys_link+0x11d>
    iunlockput(dp);
8010599a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010599d:	89 04 24             	mov    %eax,(%esp)
801059a0:	e8 32 c1 ff ff       	call   80101ad7 <iunlockput>
    goto bad;
801059a5:	eb 22                	jmp    801059c9 <sys_link+0x13f>
  }
  iunlockput(dp);
801059a7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059aa:	89 04 24             	mov    %eax,(%esp)
801059ad:	e8 25 c1 ff ff       	call   80101ad7 <iunlockput>
  iput(ip);
801059b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059b5:	89 04 24             	mov    %eax,(%esp)
801059b8:	e8 49 c0 ff ff       	call   80101a06 <iput>

  commit_trans();
801059bd:	e8 64 d8 ff ff       	call   80103226 <commit_trans>

  return 0;
801059c2:	b8 00 00 00 00       	mov    $0x0,%eax
801059c7:	eb 3c                	jmp    80105a05 <sys_link+0x17b>

bad:
  ilock(ip);
801059c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059cc:	89 04 24             	mov    %eax,(%esp)
801059cf:	e8 7f be ff ff       	call   80101853 <ilock>
  ip->nlink--;
...
801059e1:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801059e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e8:	89 04 24             	mov    %eax,(%esp)
801059eb:	e8 a7 bc ff ff       	call   80101697 <iupdate>
  iunlockput(ip);
801059f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059f3:	89 04 24             	mov    %eax,(%esp)
801059f6:	e8 dc c0 ff ff       	call   80101ad7 <iunlockput>
  commit_trans();
801059fb:	e8 26 d8 ff ff       	call   80103226 <commit_trans>
  return -1;
...
80105a0a:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105a0d:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105a14:	eb 4b                	jmp    80105a61 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105a16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a19:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105a20:	00 
...
80105a32:	e8 29 c3 ff ff       	call   80101d60 <readi>
80105a37:	83 f8 10             	cmp    $0x10,%eax
80105a3a:	74 0c                	je     80105a48 <isdirempty+0x41>
      panic("isdirempty: readi");
80105a3c:	c7 04 24 9f 89 10 80 	movl   $0x8010899f,(%esp)
80105a43:	e8 f2 aa ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105a48:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105a4c:	66 85 c0             	test   %ax,%ax
80105a4f:	74 07                	je     80105a58 <isdirempty+0x51>
      return 0;
80105a51:	b8 00 00 00 00       	mov    $0x0,%eax
80105a56:	eb 1b                	jmp    80105a73 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105a5b:	83 c0 10             	add    $0x10,%eax
...
80105a6c:	72 a8                	jb     80105a16 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105a78:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105a7b:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105a7e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a82:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a89:	e8 76 fa ff ff       	call   80105504 <argstr>
80105a8e:	85 c0                	test   %eax,%eax
80105a90:	79 0a                	jns    80105a9c <sys_unlink+0x27>
    return -1;
80105a92:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a97:	e9 aa 01 00 00       	jmp    80105c46 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105a9c:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105a9f:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105aa2:	89 54 24 04          	mov    %edx,0x4(%esp)
80105aa6:	89 04 24             	mov    %eax,(%esp)
80105aa9:	e8 72 c9 ff ff       	call   80102420 <nameiparent>
80105aae:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ab1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ab5:	75 0a                	jne    80105ac1 <sys_unlink+0x4c>
    return -1;
80105ab7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105abc:	e9 85 01 00 00       	jmp    80105c46 <sys_unlink+0x1d1>

  begin_trans();
80105ac1:	e8 17 d7 ff ff       	call   801031dd <begin_trans>

  ilock(dp);
80105ac6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ac9:	89 04 24             	mov    %eax,(%esp)
80105acc:	e8 82 bd ff ff       	call   80101853 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105ad1:	c7 44 24 04 b1 89 10 	movl   $0x801089b1,0x4(%esp)
80105ad8:	80 
80105ad9:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105adc:	89 04 24             	mov    %eax,(%esp)
80105adf:	e8 6f c5 ff ff       	call   80102053 <namecmp>
80105ae4:	85 c0                	test   %eax,%eax
80105ae6:	0f 84 45 01 00 00    	je     80105c31 <sys_unlink+0x1bc>
80105aec:	c7 44 24 04 b3 89 10 	movl   $0x801089b3,0x4(%esp)
80105af3:	80 
80105af4:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105af7:	89 04 24             	mov    %eax,(%esp)
80105afa:	e8 54 c5 ff ff       	call   80102053 <namecmp>
80105aff:	85 c0                	test   %eax,%eax
80105b01:	0f 84 2a 01 00 00    	je     80105c31 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105b07:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105b0a:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b0e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105b11:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b15:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b18:	89 04 24             	mov    %eax,(%esp)
80105b1b:	e8 55 c5 ff ff       	call   80102075 <dirlookup>
80105b20:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b23:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b27:	75 05                	jne    80105b2e <sys_unlink+0xb9>
    goto bad;
80105b29:	e9 03 01 00 00       	jmp    80105c31 <sys_unlink+0x1bc>
  ilock(ip);
80105b2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b31:	89 04 24             	mov    %eax,(%esp)
80105b34:	e8 1a bd ff ff       	call   80101853 <ilock>

  if(ip->nlink < 1)
80105b39:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b40:	66 85 c0             	test   %ax,%ax
80105b43:	7f 0c                	jg     80105b51 <sys_unlink+0xdc>
    panic("unlink: nlink < 1");
80105b45:	c7 04 24 b6 89 10 80 	movl   $0x801089b6,(%esp)
80105b4c:	e8 e9 a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105b51:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b54:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b58:	66 83 f8 01          	cmp    $0x1,%ax
80105b5c:	75 1f                	jne    80105b7d <sys_unlink+0x108>
80105b5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b61:	89 04 24             	mov    %eax,(%esp)
80105b64:	e8 9e fe ff ff       	call   80105a07 <isdirempty>
80105b69:	85 c0                	test   %eax,%eax
80105b6b:	75 10                	jne    80105b7d <sys_unlink+0x108>
    iunlockput(ip);
80105b6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b70:	89 04 24             	mov    %eax,(%esp)
80105b73:	e8 5f bf ff ff       	call   80101ad7 <iunlockput>
    goto bad;
80105b78:	e9 b4 00 00 00       	jmp    80105c31 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105b7d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105b84:	00 
80105b85:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b8c:	00 
80105b8d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b90:	89 04 24             	mov    %eax,(%esp)
80105b93:	e8 9a f5 ff ff       	call   80105132 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105b98:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105b9b:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105ba2:	00 
80105ba3:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ba7:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105baa:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bb1:	89 04 24             	mov    %eax,(%esp)
80105bb4:	e8 0b c3 ff ff       	call   80101ec4 <writei>
80105bb9:	83 f8 10             	cmp    $0x10,%eax
80105bbc:	74 0c                	je     80105bca <sys_unlink+0x155>
    panic("unlink: writei");
80105bbe:	c7 04 24 c8 89 10 80 	movl   $0x801089c8,(%esp)
80105bc5:	e8 70 a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105bca:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bcd:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105bd1:	66 83 f8 01          	cmp    $0x1,%ax
80105bd5:	75 1c                	jne    80105bf3 <sys_unlink+0x17e>
    dp->nlink--;
80105bd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bda:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105bde:	8d 50 ff             	lea    -0x1(%eax),%edx
80105be1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105be4:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105be8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105beb:	89 04 24             	mov    %eax,(%esp)
80105bee:	e8 a4 ba ff ff       	call   80101697 <iupdate>
  }
  iunlockput(dp);
80105bf3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bf6:	89 04 24             	mov    %eax,(%esp)
80105bf9:	e8 d9 be ff ff       	call   80101ad7 <iunlockput>
...
80105c15:	e8 7d ba ff ff       	call   80101697 <iupdate>
  iunlockput(ip);
80105c1a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c1d:	89 04 24             	mov    %eax,(%esp)
80105c20:	e8 b2 be ff ff       	call   80101ad7 <iunlockput>

  commit_trans();
80105c25:	e8 fc d5 ff ff       	call   80103226 <commit_trans>

  return 0;
80105c2a:	b8 00 00 00 00       	mov    $0x0,%eax
80105c2f:	eb 15                	jmp    80105c46 <sys_unlink+0x1d1>

bad:
  iunlockput(dp);
80105c31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c34:	89 04 24             	mov    %eax,(%esp)
80105c37:	e8 9b be ff ff       	call   80101ad7 <iunlockput>
  commit_trans();
80105c3c:	e8 e5 d5 ff ff       	call   80103226 <commit_trans>
  return -1;
...
80105c4b:	83 ec 48             	sub    $0x48,%esp
80105c4e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105c51:	8b 55 10             	mov    0x10(%ebp),%edx
80105c54:	8b 45 14             	mov    0x14(%ebp),%eax
80105c57:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105c5b:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105c5f:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105c6a:	8b 45 08             	mov    0x8(%ebp),%eax
80105c6d:	89 04 24             	mov    %eax,(%esp)
80105c70:	e8 ab c7 ff ff       	call   80102420 <nameiparent>
80105c75:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c78:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c7c:	75 0a                	jne    80105c88 <create+0x40>
    return 0;
80105c7e:	b8 00 00 00 00       	mov    $0x0,%eax
80105c83:	e9 7e 01 00 00       	jmp    80105e06 <create+0x1be>
  ilock(dp);
80105c88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c8b:	89 04 24             	mov    %eax,(%esp)
80105c8e:	e8 c0 bb ff ff       	call   80101853 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105c93:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105c96:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c9a:	8d 45 de             	lea    -0x22(%ebp),%eax
80105c9d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ca1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ca4:	89 04 24             	mov    %eax,(%esp)
80105ca7:	e8 c9 c3 ff ff       	call   80102075 <dirlookup>
80105cac:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105caf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105cb3:	74 47                	je     80105cfc <create+0xb4>
    iunlockput(dp);
80105cb5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cb8:	89 04 24             	mov    %eax,(%esp)
80105cbb:	e8 17 be ff ff       	call   80101ad7 <iunlockput>
    ilock(ip);
80105cc0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cc3:	89 04 24             	mov    %eax,(%esp)
80105cc6:	e8 88 bb ff ff       	call   80101853 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105ccb:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105cd0:	75 15                	jne    80105ce7 <create+0x9f>
80105cd2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cd5:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105cd9:	66 83 f8 02          	cmp    $0x2,%ax
80105cdd:	75 08                	jne    80105ce7 <create+0x9f>
      return ip;
80105cdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ce2:	e9 1f 01 00 00       	jmp    80105e06 <create+0x1be>
    iunlockput(ip);
80105ce7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cea:	89 04 24             	mov    %eax,(%esp)
80105ced:	e8 e5 bd ff ff       	call   80101ad7 <iunlockput>
    return 0;
80105cf2:	b8 00 00 00 00       	mov    $0x0,%eax
80105cf7:	e9 0a 01 00 00       	jmp    80105e06 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105cfc:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105d00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d03:	8b 00                	mov    (%eax),%eax
80105d05:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d09:	89 04 24             	mov    %eax,(%esp)
80105d0c:	e8 a7 b8 ff ff       	call   801015b8 <ialloc>
80105d11:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d14:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d18:	75 0c                	jne    80105d26 <create+0xde>
    panic("create: ialloc");
80105d1a:	c7 04 24 d7 89 10 80 	movl   $0x801089d7,(%esp)
80105d21:	e8 14 a8 ff ff       	call   8010053a <panic>

  ilock(ip);
80105d26:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d29:	89 04 24             	mov    %eax,(%esp)
80105d2c:	e8 22 bb ff ff       	call   80101853 <ilock>
  ip->major = major;
80105d31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d34:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105d38:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105d3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d3f:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105d43:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105d47:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4a:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105d50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d53:	89 04 24             	mov    %eax,(%esp)
80105d56:	e8 3c b9 ff ff       	call   80101697 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105d5b:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105d60:	75 6a                	jne    80105dcc <create+0x184>
    dp->nlink++;  // for ".."
80105d62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d65:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d69:	8d 50 01             	lea    0x1(%eax),%edx
80105d6c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d6f:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105d73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d76:	89 04 24             	mov    %eax,(%esp)
80105d79:	e8 19 b9 ff ff       	call   80101697 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105d7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d81:	8b 40 04             	mov    0x4(%eax),%eax
80105d84:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d88:	c7 44 24 04 b1 89 10 	movl   $0x801089b1,0x4(%esp)
80105d8f:	80 
80105d90:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d93:	89 04 24             	mov    %eax,(%esp)
80105d96:	e8 a3 c3 ff ff       	call   8010213e <dirlink>
80105d9b:	85 c0                	test   %eax,%eax
80105d9d:	78 21                	js     80105dc0 <create+0x178>
80105d9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105da2:	8b 40 04             	mov    0x4(%eax),%eax
80105da5:	89 44 24 08          	mov    %eax,0x8(%esp)
80105da9:	c7 44 24 04 b3 89 10 	movl   $0x801089b3,0x4(%esp)
80105db0:	80 
80105db1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105db4:	89 04 24             	mov    %eax,(%esp)
80105db7:	e8 82 c3 ff ff       	call   8010213e <dirlink>
80105dbc:	85 c0                	test   %eax,%eax
80105dbe:	79 0c                	jns    80105dcc <create+0x184>
      panic("create dots");
80105dc0:	c7 04 24 e6 89 10 80 	movl   $0x801089e6,(%esp)
80105dc7:	e8 6e a7 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105dcc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dcf:	8b 40 04             	mov    0x4(%eax),%eax
...
80105de3:	e8 56 c3 ff ff       	call   8010213e <dirlink>
80105de8:	85 c0                	test   %eax,%eax
80105dea:	79 0c                	jns    80105df8 <create+0x1b0>
    panic("create: dirlink");
80105dec:	c7 04 24 f2 89 10 80 	movl   $0x801089f2,(%esp)
80105df3:	e8 42 a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105df8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dfb:	89 04 24             	mov    %eax,(%esp)
80105dfe:	e8 d4 bc ff ff       	call   80101ad7 <iunlockput>
...
80105e0e:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105e11:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e15:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e1c:	e8 e3 f6 ff ff       	call   80105504 <argstr>
80105e21:	85 c0                	test   %eax,%eax
80105e23:	78 17                	js     80105e3c <sys_open+0x34>
80105e25:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e28:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e2c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e33:	e8 3c f6 ff ff       	call   80105474 <argint>
80105e38:	85 c0                	test   %eax,%eax
80105e3a:	79 0a                	jns    80105e46 <sys_open+0x3e>
    return -1;
80105e3c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e41:	e9 48 01 00 00       	jmp    80105f8e <sys_open+0x186>
  if(omode & O_CREATE){
80105e46:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e49:	25 00 02 00 00       	and    $0x200,%eax
80105e4e:	85 c0                	test   %eax,%eax
80105e50:	74 40                	je     80105e92 <sys_open+0x8a>
    begin_trans();
80105e52:	e8 86 d3 ff ff       	call   801031dd <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105e57:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e5a:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e61:	00 
80105e62:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e69:	00 
80105e6a:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105e71:	00 
80105e72:	89 04 24             	mov    %eax,(%esp)
80105e75:	e8 ce fd ff ff       	call   80105c48 <create>
80105e7a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105e7d:	e8 a4 d3 ff ff       	call   80103226 <commit_trans>
    if(ip == 0)
80105e82:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e86:	75 5c                	jne    80105ee4 <sys_open+0xdc>
      return -1;
80105e88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e8d:	e9 fc 00 00 00       	jmp    80105f8e <sys_open+0x186>
  } else {
    if((ip = namei(path)) == 0)
80105e92:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e95:	89 04 24             	mov    %eax,(%esp)
80105e98:	e8 61 c5 ff ff       	call   801023fe <namei>
80105e9d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ea0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ea4:	75 0a                	jne    80105eb0 <sys_open+0xa8>
      return -1;
80105ea6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eab:	e9 de 00 00 00       	jmp    80105f8e <sys_open+0x186>
    ilock(ip);
80105eb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eb3:	89 04 24             	mov    %eax,(%esp)
80105eb6:	e8 98 b9 ff ff       	call   80101853 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105ebb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ebe:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ec2:	66 83 f8 01          	cmp    $0x1,%ax
80105ec6:	75 1c                	jne    80105ee4 <sys_open+0xdc>
80105ec8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ecb:	85 c0                	test   %eax,%eax
80105ecd:	74 15                	je     80105ee4 <sys_open+0xdc>
      iunlockput(ip);
80105ecf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ed2:	89 04 24             	mov    %eax,(%esp)
80105ed5:	e8 fd bb ff ff       	call   80101ad7 <iunlockput>
      return -1;
80105eda:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105edf:	e9 aa 00 00 00       	jmp    80105f8e <sys_open+0x186>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105ee4:	e8 35 b0 ff ff       	call   80100f1e <filealloc>
80105ee9:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105eec:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ef0:	74 14                	je     80105f06 <sys_open+0xfe>
80105ef2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ef5:	89 04 24             	mov    %eax,(%esp)
80105ef8:	e8 42 f7 ff ff       	call   8010563f <fdalloc>
80105efd:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105f00:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105f04:	79 23                	jns    80105f29 <sys_open+0x121>
    if(f)
80105f06:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f0a:	74 0b                	je     80105f17 <sys_open+0x10f>
      fileclose(f);
80105f0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f0f:	89 04 24             	mov    %eax,(%esp)
80105f12:	e8 af b0 ff ff       	call   80100fc6 <fileclose>
    iunlockput(ip);
80105f17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f1a:	89 04 24             	mov    %eax,(%esp)
80105f1d:	e8 b5 bb ff ff       	call   80101ad7 <iunlockput>
    return -1;
80105f22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f27:	eb 65                	jmp    80105f8e <sys_open+0x186>
  }
  iunlock(ip);
80105f29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f2c:	89 04 24             	mov    %eax,(%esp)
80105f2f:	e8 6d ba ff ff       	call   801019a1 <iunlock>

  f->type = FD_INODE;
80105f34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f37:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105f3d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f40:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f43:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105f46:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f49:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105f50:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f53:	83 e0 01             	and    $0x1,%eax
80105f56:	85 c0                	test   %eax,%eax
80105f58:	0f 94 c0             	sete   %al
80105f5b:	89 c2                	mov    %eax,%edx
80105f5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f60:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105f63:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f66:	83 e0 01             	and    $0x1,%eax
80105f69:	85 c0                	test   %eax,%eax
80105f6b:	75 0a                	jne    80105f77 <sys_open+0x16f>
80105f6d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f70:	83 e0 02             	and    $0x2,%eax
80105f73:	85 c0                	test   %eax,%eax
80105f75:	74 07                	je     80105f7e <sys_open+0x176>
80105f77:	b8 01 00 00 00       	mov    $0x1,%eax
80105f7c:	eb 05                	jmp    80105f83 <sys_open+0x17b>
80105f7e:	b8 00 00 00 00       	mov    $0x0,%eax
80105f83:	89 c2                	mov    %eax,%edx
80105f85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f88:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80105f93:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105f96:	e8 42 d2 ff ff       	call   801031dd <begin_trans>
...
80105fa9:	e8 56 f5 ff ff       	call   80105504 <argstr>
80105fae:	85 c0                	test   %eax,%eax
80105fb0:	78 2c                	js     80105fde <sys_mkdir+0x4e>
80105fb2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fb5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105fbc:	00 
80105fbd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105fc4:	00 
80105fc5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105fcc:	00 
80105fcd:	89 04 24             	mov    %eax,(%esp)
80105fd0:	e8 73 fc ff ff       	call   80105c48 <create>
80105fd5:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fd8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105fdc:	75 0c                	jne    80105fea <sys_mkdir+0x5a>
    commit_trans();
80105fde:	e8 43 d2 ff ff       	call   80103226 <commit_trans>
    return -1;
80105fe3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fe8:	eb 15                	jmp    80105fff <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105fea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fed:	89 04 24             	mov    %eax,(%esp)
80105ff0:	e8 e2 ba ff ff       	call   80101ad7 <iunlockput>
  commit_trans();
80105ff5:	e8 2c d2 ff ff       	call   80103226 <commit_trans>
  return 0;
80105ffa:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105fff:	c9                   	leave  
80106000:	c3                   	ret    
...
80106004:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
80106007:	e8 d1 d1 ff ff       	call   801031dd <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
8010600c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010600f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106013:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010601a:	e8 e5 f4 ff ff       	call   80105504 <argstr>
8010601f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106022:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106026:	78 5e                	js     80106086 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106028:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010602b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010602f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106036:	e8 39 f4 ff ff       	call   80105474 <argint>
  char *path;
  int len;
  int major, minor;
...
8010603d:	78 47                	js     80106086 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010603f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106042:	89 44 24 04          	mov    %eax,0x4(%esp)
80106046:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010604d:	e8 22 f4 ff ff       	call   80105474 <argint>
  int len;
  int major, minor;
...
80106054:	78 30                	js     80106086 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106056:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106059:	0f bf c8             	movswl %ax,%ecx
8010605c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010605f:	0f bf d0             	movswl %ax,%edx
80106062:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106065:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106069:	89 54 24 08          	mov    %edx,0x8(%esp)
8010606d:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106074:	00 
80106075:	89 04 24             	mov    %eax,(%esp)
80106078:	e8 cb fb ff ff       	call   80105c48 <create>
8010607d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106080:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106084:	75 0c                	jne    80106092 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80106086:	e8 9b d1 ff ff       	call   80103226 <commit_trans>
    return -1;
8010608b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106090:	eb 15                	jmp    801060a7 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80106092:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106095:	89 04 24             	mov    %eax,(%esp)
80106098:	e8 3a ba ff ff       	call   80101ad7 <iunlockput>
  commit_trans();
8010609d:	e8 84 d1 ff ff       	call   80103226 <commit_trans>
  return 0;
...
8010613d:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106151:	e8 ae f3 ff ff       	call   80105504 <argstr>
80106156:	85 c0                	test   %eax,%eax
80106158:	78 1a                	js     80106174 <sys_exec+0x3a>
8010615a:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106160:	89 44 24 04          	mov    %eax,0x4(%esp)
80106164:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010616b:	e8 04 f3 ff ff       	call   80105474 <argint>
80106170:	85 c0                	test   %eax,%eax
80106172:	79 0a                	jns    8010617e <sys_exec+0x44>
    return -1;
80106174:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106179:	e9 c8 00 00 00       	jmp    80106246 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
8010617e:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106185:	00 
80106186:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010618d:	00 
8010618e:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106194:	89 04 24             	mov    %eax,(%esp)
80106197:	e8 96 ef ff ff       	call   80105132 <memset>
  for(i=0;; i++){
8010619c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801061a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061a6:	83 f8 1f             	cmp    $0x1f,%eax
801061a9:	76 0a                	jbe    801061b5 <sys_exec+0x7b>
      return -1;
801061ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061b0:	e9 91 00 00 00       	jmp    80106246 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801061b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061b8:	c1 e0 02             	shl    $0x2,%eax
801061bb:	89 c2                	mov    %eax,%edx
801061bd:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801061c3:	01 c2                	add    %eax,%edx
801061c5:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801061cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801061cf:	89 14 24             	mov    %edx,(%esp)
801061d2:	e8 01 f2 ff ff       	call   801053d8 <fetchint>
801061d7:	85 c0                	test   %eax,%eax
801061d9:	79 07                	jns    801061e2 <sys_exec+0xa8>
      return -1;
801061db:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061e0:	eb 64                	jmp    80106246 <sys_exec+0x10c>
    if(uarg == 0){
801061e2:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801061e8:	85 c0                	test   %eax,%eax
801061ea:	75 26                	jne    80106212 <sys_exec+0xd8>
      argv[i] = 0;
801061ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ef:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801061f6:	00 00 00 00 
      break;
801061fa:	90                   	nop
    }
...
801061fe:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106204:	89 54 24 04          	mov    %edx,0x4(%esp)
80106208:	89 04 24             	mov    %eax,(%esp)
8010620b:	e8 df a8 ff ff       	call   80100aef <exec>
80106210:	eb 34                	jmp    80106246 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
80106212:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106218:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010621b:	c1 e2 02             	shl    $0x2,%edx
8010621e:	01 c2                	add    %eax,%edx
80106220:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106226:	89 54 24 04          	mov    %edx,0x4(%esp)
8010622a:	89 04 24             	mov    %eax,(%esp)
8010622d:	e8 e0 f1 ff ff       	call   80105412 <fetchstr>
80106232:	85 c0                	test   %eax,%eax
80106234:	79 07                	jns    8010623d <sys_exec+0x103>
      return -1;
80106236:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010623b:	eb 09                	jmp    80106246 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
8010623d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80106241:	e9 5d ff ff ff       	jmp    801061a3 <sys_exec+0x69>
  return exec(path, argv);
}
80106246:	c9                   	leave  
80106247:	c3                   	ret    
...
8010624b:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010624e:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106255:	00 
80106256:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106259:	89 44 24 04          	mov    %eax,0x4(%esp)
8010625d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106264:	e8 39 f2 ff ff       	call   801054a2 <argptr>
80106269:	85 c0                	test   %eax,%eax
8010626b:	79 0a                	jns    80106277 <sys_pipe+0x2f>
    return -1;
8010626d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106272:	e9 9b 00 00 00       	jmp    80106312 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106277:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010627a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010627e:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106281:	89 04 24             	mov    %eax,(%esp)
80106284:	e8 3e d9 ff ff       	call   80103bc7 <pipealloc>
80106289:	85 c0                	test   %eax,%eax
8010628b:	79 07                	jns    80106294 <sys_pipe+0x4c>
    return -1;
8010628d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106292:	eb 7e                	jmp    80106312 <sys_pipe+0xca>
  fd0 = -1;
80106294:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010629b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010629e:	89 04 24             	mov    %eax,(%esp)
801062a1:	e8 99 f3 ff ff       	call   8010563f <fdalloc>
801062a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062ad:	78 14                	js     801062c3 <sys_pipe+0x7b>
801062af:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062b2:	89 04 24             	mov    %eax,(%esp)
801062b5:	e8 85 f3 ff ff       	call   8010563f <fdalloc>
801062ba:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062bd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062c1:	79 37                	jns    801062fa <sys_pipe+0xb2>
    if(fd0 >= 0)
801062c3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062c7:	78 14                	js     801062dd <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
801062c9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801062cf:	8b 55 f4             	mov    -0xc(%ebp),%edx
801062d2:	83 c2 08             	add    $0x8,%edx
801062d5:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801062dc:	00 
    fileclose(rf);
801062dd:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062e0:	89 04 24             	mov    %eax,(%esp)
801062e3:	e8 de ac ff ff       	call   80100fc6 <fileclose>
    fileclose(wf);
801062e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062eb:	89 04 24             	mov    %eax,(%esp)
801062ee:	e8 d3 ac ff ff       	call   80100fc6 <fileclose>
    return -1;
801062f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062f8:	eb 18                	jmp    80106312 <sys_pipe+0xca>
  }
  fd[0] = fd0;
801062fa:	8b 45 ec             	mov    -0x14(%ebp),%eax
801062fd:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106300:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106302:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106305:	8d 50 04             	lea    0x4(%eax),%edx
80106308:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010630b:	89 02                	mov    %eax,(%edx)
  return 0;
...
80106317:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010631a:	e8 d8 df ff ff       	call   801042f7 <fork>
}
8010631f:	c9                   	leave  
80106320:	c3                   	ret    
...
80106325:	83 ec 24             	sub    $0x24,%esp
    int stack;
    int size;
    int routine;
    int arg;
...
8010632f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106336:	e8 39 f1 ff ff       	call   80105474 <argint>
8010633b:	85 c0                	test   %eax,%eax
8010633d:	78 4c                	js     8010638b <sys_clone+0x6a>
8010633f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106342:	85 c0                	test   %eax,%eax
80106344:	7e 45                	jle    8010638b <sys_clone+0x6a>
80106346:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106349:	89 44 24 04          	mov    %eax,0x4(%esp)
8010634d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106354:	e8 1b f1 ff ff       	call   80105474 <argint>
80106359:	85 c0                	test   %eax,%eax
8010635b:	78 2e                	js     8010638b <sys_clone+0x6a>
            argint(2,&routine) < 0 || argint(3,&arg)<0){
8010635d:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106360:	89 44 24 04          	mov    %eax,0x4(%esp)
80106364:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010636b:	e8 04 f1 ff ff       	call   80105474 <argint>
    int stack;
    int size;
    int routine;
    int arg;
...
80106372:	78 17                	js     8010638b <sys_clone+0x6a>
            argint(2,&routine) < 0 || argint(3,&arg)<0){
80106374:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106377:	89 44 24 04          	mov    %eax,0x4(%esp)
8010637b:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
80106382:	e8 ed f0 ff ff       	call   80105474 <argint>
80106387:	85 c0                	test   %eax,%eax
80106389:	79 07                	jns    80106392 <sys_clone+0x71>
        return -1;
8010638b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106390:	eb 20                	jmp    801063b2 <sys_clone+0x91>
    }
    return clone(stack,size,routine,arg);
80106392:	8b 5d e8             	mov    -0x18(%ebp),%ebx
80106395:	8b 4d ec             	mov    -0x14(%ebp),%ecx
80106398:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010639b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010639e:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801063a2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801063a6:	89 54 24 04          	mov    %edx,0x4(%esp)
801063aa:	89 04 24             	mov    %eax,(%esp)
801063ad:	e8 b5 e0 ff ff       	call   80104467 <clone>
}
801063b2:	83 c4 24             	add    $0x24,%esp
801063b5:	5b                   	pop    %ebx
801063b6:	5d                   	pop    %ebp
801063b7:	c3                   	ret    
...
801063bb:	83 ec 08             	sub    $0x8,%esp
  exit();
801063be:	e8 c7 e2 ff ff       	call   8010468a <exit>
  return 0;  // not reached
801063c3:	b8 00 00 00 00       	mov    $0x0,%eax
}
801063c8:	c9                   	leave  
801063c9:	c3                   	ret    
...
801063cd:	83 ec 08             	sub    $0x8,%esp
    texit();
801063d0:	e8 d0 e3 ff ff       	call   801047a5 <texit>
    return 0;
...
801063df:	83 ec 08             	sub    $0x8,%esp
  return wait();
801063e2:	e8 8c e4 ff ff       	call   80104873 <wait>
}
801063e7:	c9                   	leave  
801063e8:	c3                   	ret    
...
80106423:	8b 40 10             	mov    0x10(%eax),%eax
}
80106426:	5d                   	pop    %ebp
80106427:	c3                   	ret    
...
8010642b:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
8010643c:	e8 33 f0 ff ff       	call   80105474 <argint>
80106441:	85 c0                	test   %eax,%eax
80106443:	79 07                	jns    8010644c <sys_sbrk+0x24>
    return -1;
80106445:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010644a:	eb 24                	jmp    80106470 <sys_sbrk+0x48>
  addr = proc->sz;
...
8010645d:	e8 f0 dd ff ff       	call   80104252 <growproc>
80106462:	85 c0                	test   %eax,%eax
80106464:	79 07                	jns    8010646d <sys_sbrk+0x45>
    return -1;
80106466:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010646b:	eb 03                	jmp    80106470 <sys_sbrk+0x48>
  return addr;
...
8010647f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106486:	e8 e9 ef ff ff       	call   80105474 <argint>
8010648b:	85 c0                	test   %eax,%eax
8010648d:	79 07                	jns    80106496 <sys_sleep+0x24>
    return -1;
8010648f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106494:	eb 6c                	jmp    80106502 <sys_sleep+0x90>
  acquire(&tickslock);
80106496:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
8010649d:	e8 3c ea ff ff       	call   80104ede <acquire>
  ticks0 = ticks;
801064a2:	a1 c0 28 11 80       	mov    0x801128c0,%eax
801064a7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801064aa:	eb 34                	jmp    801064e0 <sys_sleep+0x6e>
    if(proc->killed){
801064ac:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064b2:	8b 40 24             	mov    0x24(%eax),%eax
801064b5:	85 c0                	test   %eax,%eax
801064b7:	74 13                	je     801064cc <sys_sleep+0x5a>
      release(&tickslock);
801064b9:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801064c0:	e8 7b ea ff ff       	call   80104f40 <release>
      return -1;
801064c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064ca:	eb 36                	jmp    80106502 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801064cc:	c7 44 24 04 80 20 11 	movl   $0x80112080,0x4(%esp)
801064d3:	80 
801064d4:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
801064db:	e8 87 e6 ff ff       	call   80104b67 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801064e0:	a1 c0 28 11 80       	mov    0x801128c0,%eax
801064e5:	2b 45 f4             	sub    -0xc(%ebp),%eax
801064e8:	89 c2                	mov    %eax,%edx
801064ea:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ed:	39 c2                	cmp    %eax,%edx
801064ef:	72 bb                	jb     801064ac <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
801064f1:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801064f8:	e8 43 ea ff ff       	call   80104f40 <release>
  return 0;
...
80106507:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
8010650a:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
80106511:	e8 c8 e9 ff ff       	call   80104ede <acquire>
  xticks = ticks;
80106516:	a1 c0 28 11 80       	mov    0x801128c0,%eax
8010651b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
8010651e:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
80106525:	e8 16 ea ff ff       	call   80104f40 <release>
  return xticks;
...
80106532:	83 ec 08             	sub    $0x8,%esp
    tsleep();
80106535:	e8 11 e9 ff ff       	call   80104e4b <tsleep>
    return 0;
...
80106555:	e8 1a ef ff ff       	call   80105474 <argint>
8010655a:	85 c0                	test   %eax,%eax
8010655c:	79 07                	jns    80106565 <sys_twakeup+0x24>
        return -1;
8010655e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106563:	eb 10                	jmp    80106575 <sys_twakeup+0x34>
    }
        twakeup(tid);
80106565:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106568:	89 04 24             	mov    %eax,(%esp)
8010656b:	e8 d3 e6 ff ff       	call   80104c43 <twakeup>
        return 0;
...
8010657a:	83 ec 18             	sub    $0x18,%esp
  cprintf("Yielded\n");
8010657d:	c7 04 24 02 8a 10 80 	movl   $0x80108a02,(%esp)
80106584:	e8 17 9e ff ff       	call   801003a0 <cprintf>
  //yield();
  thread_yield();
80106589:	e8 f3 e8 ff ff       	call   80104e81 <thread_yield>
  
  return 0;
8010658e:	b8 00 00 00 00       	mov    $0x0,%eax
80106593:	c9                   	leave  
80106594:	c3                   	ret    
...
801065a1:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801065a5:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801065a8:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801065ac:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
801065b9:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801065c0:	00 
801065c1:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801065c8:	e8 c8 ff ff ff       	call   80106595 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801065cd:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801065d4:	00 
801065d5:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801065dc:	e8 b4 ff ff ff       	call   80106595 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801065e1:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801065e8:	00 
801065e9:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801065f0:	e8 a0 ff ff ff       	call   80106595 <outb>
  picenable(IRQ_TIMER);
801065f5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065fc:	e8 59 d4 ff ff       	call   80103a5a <picenable>
}
80106601:	c9                   	leave  
80106602:	c3                   	ret    
...
80106604:	06                   	push   %es
  pushl %fs
80106605:	0f a0                	push   %fs
  pushl %gs
80106607:	0f a8                	push   %gs
  pushal
80106609:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
8010660a:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010660e:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106610:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106612:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106616:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106618:	8e e8                	mov    %eax,%gs
...
8010667d:	8b 04 85 ac b0 10 80 	mov    -0x7fef4f54(,%eax,4),%eax
80106684:	89 c2                	mov    %eax,%edx
80106686:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106689:	66 89 14 c5 c0 20 11 	mov    %dx,-0x7feedf40(,%eax,8)
80106690:	80 
80106691:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106694:	66 c7 04 c5 c2 20 11 	movw   $0x8,-0x7feedf3e(,%eax,8)
8010669b:	80 08 00 
8010669e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a1:	0f b6 14 c5 c4 20 11 	movzbl -0x7feedf3c(,%eax,8),%edx
801066a8:	80 
801066a9:	83 e2 e0             	and    $0xffffffe0,%edx
801066ac:	88 14 c5 c4 20 11 80 	mov    %dl,-0x7feedf3c(,%eax,8)
801066b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b6:	0f b6 14 c5 c4 20 11 	movzbl -0x7feedf3c(,%eax,8),%edx
801066bd:	80 
801066be:	83 e2 1f             	and    $0x1f,%edx
801066c1:	88 14 c5 c4 20 11 80 	mov    %dl,-0x7feedf3c(,%eax,8)
801066c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066cb:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
801066d2:	80 
801066d3:	83 e2 f0             	and    $0xfffffff0,%edx
801066d6:	83 ca 0e             	or     $0xe,%edx
801066d9:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
801066e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e3:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
801066ea:	80 
801066eb:	83 e2 ef             	and    $0xffffffef,%edx
801066ee:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
801066f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f8:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
801066ff:	80 
80106700:	83 e2 9f             	and    $0xffffff9f,%edx
80106703:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
8010670a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010670d:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
80106714:	80 
80106715:	83 ca 80             	or     $0xffffff80,%edx
80106718:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
8010671f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106722:	8b 04 85 ac b0 10 80 	mov    -0x7fef4f54(,%eax,4),%eax
80106729:	c1 e8 10             	shr    $0x10,%eax
8010672c:	89 c2                	mov    %eax,%edx
8010672e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106731:	66 89 14 c5 c6 20 11 	mov    %dx,-0x7feedf3a(,%eax,8)
80106738:	80 
void
tvinit(void)
{
...
8010674a:	a1 ac b1 10 80       	mov    0x8010b1ac,%eax
8010674f:	66 a3 c0 22 11 80    	mov    %ax,0x801122c0
80106755:	66 c7 05 c2 22 11 80 	movw   $0x8,0x801122c2
8010675c:	08 00 
8010675e:	0f b6 05 c4 22 11 80 	movzbl 0x801122c4,%eax
80106765:	83 e0 e0             	and    $0xffffffe0,%eax
80106768:	a2 c4 22 11 80       	mov    %al,0x801122c4
8010676d:	0f b6 05 c4 22 11 80 	movzbl 0x801122c4,%eax
80106774:	83 e0 1f             	and    $0x1f,%eax
80106777:	a2 c4 22 11 80       	mov    %al,0x801122c4
8010677c:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
80106783:	83 c8 0f             	or     $0xf,%eax
80106786:	a2 c5 22 11 80       	mov    %al,0x801122c5
8010678b:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
80106792:	83 e0 ef             	and    $0xffffffef,%eax
80106795:	a2 c5 22 11 80       	mov    %al,0x801122c5
8010679a:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
801067a1:	83 c8 60             	or     $0x60,%eax
801067a4:	a2 c5 22 11 80       	mov    %al,0x801122c5
801067a9:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
801067b0:	83 c8 80             	or     $0xffffff80,%eax
801067b3:	a2 c5 22 11 80       	mov    %al,0x801122c5
801067b8:	a1 ac b1 10 80       	mov    0x8010b1ac,%eax
801067bd:	c1 e8 10             	shr    $0x10,%eax
801067c0:	66 a3 c6 22 11 80    	mov    %ax,0x801122c6
  
  initlock(&tickslock, "time");
801067c6:	c7 44 24 04 0c 8a 10 	movl   $0x80108a0c,0x4(%esp)
801067cd:	80 
801067ce:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801067d5:	e8 e3 e6 ff ff       	call   80104ebd <initlock>
}
801067da:	c9                   	leave  
801067db:	c3                   	ret    
...
801067e9:	00 
801067ea:	c7 04 24 c0 20 11 80 	movl   $0x801120c0,(%esp)
...
8010680a:	75 3f                	jne    8010684b <trap+0x53>
    if(proc->killed)
8010680c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106812:	8b 40 24             	mov    0x24(%eax),%eax
80106815:	85 c0                	test   %eax,%eax
80106817:	74 05                	je     8010681e <trap+0x26>
      exit();
80106819:	e8 6c de ff ff       	call   8010468a <exit>
    proc->tf = tf;
8010681e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106824:	8b 55 08             	mov    0x8(%ebp),%edx
80106827:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010682a:	e8 0c ed ff ff       	call   8010553b <syscall>
    if(proc->killed)
8010682f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106835:	8b 40 24             	mov    0x24(%eax),%eax
80106838:	85 c0                	test   %eax,%eax
8010683a:	74 0a                	je     80106846 <trap+0x4e>
      exit();
8010683c:	e8 49 de ff ff       	call   8010468a <exit>
    return;
80106841:	e9 2d 02 00 00       	jmp    80106a73 <trap+0x27b>
80106846:	e9 28 02 00 00       	jmp    80106a73 <trap+0x27b>
  }
...
80106857:	0f 87 bc 00 00 00    	ja     80106919 <trap+0x121>
8010685d:	8b 04 85 b4 8a 10 80 	mov    -0x7fef754c(,%eax,4),%eax
80106864:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106866:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010686c:	0f b6 00             	movzbl (%eax),%eax
8010686f:	84 c0                	test   %al,%al
80106871:	75 31                	jne    801068a4 <trap+0xac>
      acquire(&tickslock);
80106873:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
8010687a:	e8 5f e6 ff ff       	call   80104ede <acquire>
      ticks++;
8010687f:	a1 c0 28 11 80       	mov    0x801128c0,%eax
80106884:	83 c0 01             	add    $0x1,%eax
80106887:	a3 c0 28 11 80       	mov    %eax,0x801128c0
      wakeup(&ticks);
8010688c:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80106893:	e8 13 e4 ff ff       	call   80104cab <wakeup>
      release(&tickslock);
80106898:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
8010689f:	e8 9c e6 ff ff       	call   80104f40 <release>
    }
    lapiceoi();
801068a4:	e8 02 c6 ff ff       	call   80102eab <lapiceoi>
    break;
801068a9:	e9 41 01 00 00       	jmp    801069ef <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801068ae:	e8 23 be ff ff       	call   801026d6 <ideintr>
    lapiceoi();
801068b3:	e8 f3 c5 ff ff       	call   80102eab <lapiceoi>
    break;
801068b8:	e9 32 01 00 00       	jmp    801069ef <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801068bd:	e8 d5 c3 ff ff       	call   80102c97 <kbdintr>
    lapiceoi();
801068c2:	e8 e4 c5 ff ff       	call   80102eab <lapiceoi>
    break;
801068c7:	e9 23 01 00 00       	jmp    801069ef <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801068cc:	e8 97 03 00 00       	call   80106c68 <uartintr>
    lapiceoi();
801068d1:	e8 d5 c5 ff ff       	call   80102eab <lapiceoi>
    break;
801068d6:	e9 14 01 00 00       	jmp    801069ef <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068db:	8b 45 08             	mov    0x8(%ebp),%eax
801068de:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
801068e4:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068e8:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801068eb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801068f1:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068f4:	0f b6 c0             	movzbl %al,%eax
801068f7:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801068fb:	89 54 24 08          	mov    %edx,0x8(%esp)
801068ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106903:	c7 04 24 14 8a 10 80 	movl   $0x80108a14,(%esp)
8010690a:	e8 91 9a ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
8010690f:	e8 97 c5 ff ff       	call   80102eab <lapiceoi>
    break;
80106914:	e9 d6 00 00 00       	jmp    801069ef <trap+0x1f7>
...
80106921:	74 11                	je     80106934 <trap+0x13c>
...
80106932:	75 46                	jne    8010697a <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106934:	e8 1e fd ff ff       	call   80106657 <rcr2>
80106939:	8b 55 08             	mov    0x8(%ebp),%edx
8010693c:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010693f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106946:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106949:	0f b6 ca             	movzbl %dl,%ecx
8010694c:	8b 55 08             	mov    0x8(%ebp),%edx
8010694f:	8b 52 30             	mov    0x30(%edx),%edx
80106952:	89 44 24 10          	mov    %eax,0x10(%esp)
80106956:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010695a:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010695e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106962:	c7 04 24 38 8a 10 80 	movl   $0x80108a38,(%esp)
80106969:	e8 32 9a ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
8010696e:	c7 04 24 6a 8a 10 80 	movl   $0x80108a6a,(%esp)
80106975:	e8 c0 9b ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010697a:	e8 d8 fc ff ff       	call   80106657 <rcr2>
8010697f:	89 c2                	mov    %eax,%edx
80106981:	8b 45 08             	mov    0x8(%ebp),%eax
80106984:	8b 78 38             	mov    0x38(%eax),%edi
...
8010698d:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106990:	0f b6 f0             	movzbl %al,%esi
80106993:	8b 45 08             	mov    0x8(%ebp),%eax
80106996:	8b 58 34             	mov    0x34(%eax),%ebx
80106999:	8b 45 08             	mov    0x8(%ebp),%eax
8010699c:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010699f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069a5:	83 c0 6c             	add    $0x6c,%eax
...
801069b4:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801069b8:	89 7c 24 18          	mov    %edi,0x18(%esp)
801069bc:	89 74 24 14          	mov    %esi,0x14(%esp)
801069c0:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801069c4:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801069c8:	8b 75 e4             	mov    -0x1c(%ebp),%esi
801069cb:	89 74 24 08          	mov    %esi,0x8(%esp)
801069cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801069d3:	c7 04 24 70 8a 10 80 	movl   $0x80108a70,(%esp)
801069da:	e8 c1 99 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801069df:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069e5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801069ec:	eb 01                	jmp    801069ef <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106a16:	75 05                	jne    80106a1d <trap+0x225>
    exit();
80106a18:	e8 6d dc ff ff       	call   8010468a <exit>
...
80106a25:	74 1e                	je     80106a45 <trap+0x24d>
80106a27:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a2d:	8b 40 0c             	mov    0xc(%eax),%eax
80106a30:	83 f8 04             	cmp    $0x4,%eax
80106a33:	75 10                	jne    80106a45 <trap+0x24d>
80106a35:	8b 45 08             	mov    0x8(%ebp),%eax
80106a38:	8b 40 30             	mov    0x30(%eax),%eax
80106a3b:	83 f8 20             	cmp    $0x20,%eax
80106a3e:	75 05                	jne    80106a45 <trap+0x24d>
    yield();
80106a40:	e8 c4 e0 ff ff       	call   80104b09 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106a45:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a4b:	85 c0                	test   %eax,%eax
80106a4d:	74 24                	je     80106a73 <trap+0x27b>
80106a4f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a55:	8b 40 24             	mov    0x24(%eax),%eax
80106a58:	85 c0                	test   %eax,%eax
80106a5a:	74 17                	je     80106a73 <trap+0x27b>
...
80106a69:	83 f8 03             	cmp    $0x3,%eax
80106a6c:	75 05                	jne    80106a73 <trap+0x27b>
    exit();
80106a6e:	e8 17 dc ff ff       	call   8010468a <exit>
}
...
80106a7e:	83 ec 14             	sub    $0x14,%esp
80106a81:	8b 45 08             	mov    0x8(%ebp),%eax
80106a84:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106a88:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106a8c:	89 c2                	mov    %eax,%edx
80106a8e:	ec                   	in     (%dx),%al
80106a8f:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106a92:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106a96:	c9                   	leave  
80106a97:	c3                   	ret    
...
80106a9e:	8b 55 08             	mov    0x8(%ebp),%edx
80106aa1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106aa4:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106aa8:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106aab:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106aaf:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106ab3:	ee                   	out    %al,(%dx)
}
80106ab4:	c9                   	leave  
80106ab5:	c3                   	ret    
...
80106ab9:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106abc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ac3:	00 
80106ac4:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106acb:	e8 c8 ff ff ff       	call   80106a98 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106ad0:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106ad7:	00 
80106ad8:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106adf:	e8 b4 ff ff ff       	call   80106a98 <outb>
  outb(COM1+0, 115200/9600);
80106ae4:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106aeb:	00 
80106aec:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106af3:	e8 a0 ff ff ff       	call   80106a98 <outb>
  outb(COM1+1, 0);
80106af8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106aff:	00 
80106b00:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b07:	e8 8c ff ff ff       	call   80106a98 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106b0c:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106b13:	00 
80106b14:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b1b:	e8 78 ff ff ff       	call   80106a98 <outb>
  outb(COM1+4, 0);
80106b20:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b27:	00 
80106b28:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106b2f:	e8 64 ff ff ff       	call   80106a98 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b34:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106b3b:	00 
80106b3c:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b43:	e8 50 ff ff ff       	call   80106a98 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b48:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b4f:	e8 27 ff ff ff       	call   80106a7b <inb>
80106b54:	3c ff                	cmp    $0xff,%al
80106b56:	75 02                	jne    80106b5a <uartinit+0xa4>
    return;
80106b58:	eb 6a                	jmp    80106bc4 <uartinit+0x10e>
  uart = 1;
80106b5a:	c7 05 6c b6 10 80 01 	movl   $0x1,0x8010b66c
80106b61:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106b64:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b6b:	e8 0b ff ff ff       	call   80106a7b <inb>
  inb(COM1+0);
80106b70:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b77:	e8 ff fe ff ff       	call   80106a7b <inb>
  picenable(IRQ_COM1);
80106b7c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b83:	e8 d2 ce ff ff       	call   80103a5a <picenable>
  ioapicenable(IRQ_COM1, 0);
80106b88:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b8f:	00 
80106b90:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b97:	e8 b9 bd ff ff       	call   80102955 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106b9c:	c7 45 f4 34 8b 10 80 	movl   $0x80108b34,-0xc(%ebp)
80106ba3:	eb 15                	jmp    80106bba <uartinit+0x104>
    uartputc(*p);
80106ba5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ba8:	0f b6 00             	movzbl (%eax),%eax
80106bab:	0f be c0             	movsbl %al,%eax
80106bae:	89 04 24             	mov    %eax,(%esp)
80106bb1:	e8 10 00 00 00       	call   80106bc6 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106bbd:	0f b6 00             	movzbl (%eax),%eax
80106bc0:	84 c0                	test   %al,%al
80106bc2:	75 e1                	jne    80106ba5 <uartinit+0xef>
    uartputc(*p);
}
80106bc4:	c9                   	leave  
80106bc5:	c3                   	ret    
...
80106bc9:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106bcc:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80106bd1:	85 c0                	test   %eax,%eax
80106bd3:	75 02                	jne    80106bd7 <uartputc+0x11>
    return;
80106bd5:	eb 4b                	jmp    80106c22 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106bd7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106bde:	eb 10                	jmp    80106bf0 <uartputc+0x2a>
    microdelay(10);
80106be0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106be7:	e8 e4 c2 ff ff       	call   80102ed0 <microdelay>
{
  int i;
...
80106c1d:	e8 76 fe ff ff       	call   80106a98 <outb>
}
80106c22:	c9                   	leave  
80106c23:	c3                   	ret    
...
80106c27:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106c2a:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80106c2f:	85 c0                	test   %eax,%eax
80106c31:	75 07                	jne    80106c3a <uartgetc+0x16>
    return -1;
80106c33:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c38:	eb 2c                	jmp    80106c66 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106c3a:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c41:	e8 35 fe ff ff       	call   80106a7b <inb>
80106c46:	0f b6 c0             	movzbl %al,%eax
80106c49:	83 e0 01             	and    $0x1,%eax
80106c4c:	85 c0                	test   %eax,%eax
80106c4e:	75 07                	jne    80106c57 <uartgetc+0x33>
    return -1;
80106c50:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c55:	eb 0f                	jmp    80106c66 <uartgetc+0x42>
  return inb(COM1+0);
80106c57:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c5e:	e8 18 fe ff ff       	call   80106a7b <inb>
80106c63:	0f b6 c0             	movzbl %al,%eax
}
80106c66:	c9                   	leave  
80106c67:	c3                   	ret    
...
80106c6b:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106c6e:	c7 04 24 24 6c 10 80 	movl   $0x80106c24,(%esp)
80106c75:	e8 33 9b ff ff       	call   801007ad <consoleintr>
}
80106c7a:	c9                   	leave  
80106c7b:	c3                   	ret    
...
80106c7e:	6a 00                	push   $0x0
  jmp alltraps
80106c80:	e9 7e f9 ff ff       	jmp    80106603 <alltraps>
...
80106c87:	6a 01                	push   $0x1
  jmp alltraps
80106c89:	e9 75 f9 ff ff       	jmp    80106603 <alltraps>
...
80106c8e:	6a 00                	push   $0x0
  pushl $2
80106c90:	6a 02                	push   $0x2
  jmp alltraps
80106c92:	e9 6c f9 ff ff       	jmp    80106603 <alltraps>
...
80106c97:	6a 00                	push   $0x0
  pushl $3
80106c99:	6a 03                	push   $0x3
  jmp alltraps
80106c9b:	e9 63 f9 ff ff       	jmp    80106603 <alltraps>
...
80106ca0:	6a 00                	push   $0x0
  pushl $4
80106ca2:	6a 04                	push   $0x4
  jmp alltraps
80106ca4:	e9 5a f9 ff ff       	jmp    80106603 <alltraps>
...
80106ca9:	6a 00                	push   $0x0
  pushl $5
80106cab:	6a 05                	push   $0x5
  jmp alltraps
80106cad:	e9 51 f9 ff ff       	jmp    80106603 <alltraps>
...
80106cb2:	6a 00                	push   $0x0
  pushl $6
80106cb4:	6a 06                	push   $0x6
  jmp alltraps
80106cb6:	e9 48 f9 ff ff       	jmp    80106603 <alltraps>
...
80106cbb:	6a 00                	push   $0x0
  pushl $7
80106cbd:	6a 07                	push   $0x7
  jmp alltraps
80106cbf:	e9 3f f9 ff ff       	jmp    80106603 <alltraps>

80106cc4 <vector8>:
.globl vector8
vector8:
  pushl $8
80106cc4:	6a 08                	push   $0x8
  jmp alltraps
80106cc6:	e9 38 f9 ff ff       	jmp    80106603 <alltraps>
...
80106ccb:	6a 00                	push   $0x0
  pushl $9
80106ccd:	6a 09                	push   $0x9
  jmp alltraps
80106ccf:	e9 2f f9 ff ff       	jmp    80106603 <alltraps>

80106cd4 <vector10>:
.globl vector10
vector10:
  pushl $10
80106cd4:	6a 0a                	push   $0xa
  jmp alltraps
80106cd6:	e9 28 f9 ff ff       	jmp    80106603 <alltraps>

80106cdb <vector11>:
.globl vector11
vector11:
  pushl $11
80106cdb:	6a 0b                	push   $0xb
  jmp alltraps
80106cdd:	e9 21 f9 ff ff       	jmp    80106603 <alltraps>

80106ce2 <vector12>:
.globl vector12
vector12:
  pushl $12
80106ce2:	6a 0c                	push   $0xc
  jmp alltraps
80106ce4:	e9 1a f9 ff ff       	jmp    80106603 <alltraps>

80106ce9 <vector13>:
.globl vector13
vector13:
  pushl $13
80106ce9:	6a 0d                	push   $0xd
  jmp alltraps
80106ceb:	e9 13 f9 ff ff       	jmp    80106603 <alltraps>

80106cf0 <vector14>:
.globl vector14
vector14:
  pushl $14
80106cf0:	6a 0e                	push   $0xe
  jmp alltraps
80106cf2:	e9 0c f9 ff ff       	jmp    80106603 <alltraps>
...
80106cf7:	6a 00                	push   $0x0
  pushl $15
80106cf9:	6a 0f                	push   $0xf
  jmp alltraps
80106cfb:	e9 03 f9 ff ff       	jmp    80106603 <alltraps>
...
80106d00:	6a 00                	push   $0x0
  pushl $16
80106d02:	6a 10                	push   $0x10
  jmp alltraps
80106d04:	e9 fa f8 ff ff       	jmp    80106603 <alltraps>

80106d09 <vector17>:
.globl vector17
vector17:
  pushl $17
80106d09:	6a 11                	push   $0x11
  jmp alltraps
80106d0b:	e9 f3 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $18
80106d12:	6a 12                	push   $0x12
  jmp alltraps
80106d14:	e9 ea f8 ff ff       	jmp    80106603 <alltraps>
...
80106d19:	6a 00                	push   $0x0
  pushl $19
80106d1b:	6a 13                	push   $0x13
  jmp alltraps
80106d1d:	e9 e1 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $20
80106d24:	6a 14                	push   $0x14
  jmp alltraps
80106d26:	e9 d8 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d2b:	6a 00                	push   $0x0
  pushl $21
80106d2d:	6a 15                	push   $0x15
  jmp alltraps
80106d2f:	e9 cf f8 ff ff       	jmp    80106603 <alltraps>
...
80106d34:	6a 00                	push   $0x0
  pushl $22
80106d36:	6a 16                	push   $0x16
  jmp alltraps
80106d38:	e9 c6 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d3d:	6a 00                	push   $0x0
  pushl $23
80106d3f:	6a 17                	push   $0x17
  jmp alltraps
80106d41:	e9 bd f8 ff ff       	jmp    80106603 <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $24
80106d48:	6a 18                	push   $0x18
  jmp alltraps
80106d4a:	e9 b4 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d4f:	6a 00                	push   $0x0
  pushl $25
80106d51:	6a 19                	push   $0x19
  jmp alltraps
80106d53:	e9 ab f8 ff ff       	jmp    80106603 <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $26
80106d5a:	6a 1a                	push   $0x1a
  jmp alltraps
80106d5c:	e9 a2 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d61:	6a 00                	push   $0x0
  pushl $27
80106d63:	6a 1b                	push   $0x1b
  jmp alltraps
80106d65:	e9 99 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $28
80106d6c:	6a 1c                	push   $0x1c
  jmp alltraps
80106d6e:	e9 90 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d73:	6a 00                	push   $0x0
  pushl $29
80106d75:	6a 1d                	push   $0x1d
  jmp alltraps
80106d77:	e9 87 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d7c:	6a 00                	push   $0x0
  pushl $30
80106d7e:	6a 1e                	push   $0x1e
  jmp alltraps
80106d80:	e9 7e f8 ff ff       	jmp    80106603 <alltraps>
...
80106d85:	6a 00                	push   $0x0
  pushl $31
80106d87:	6a 1f                	push   $0x1f
  jmp alltraps
80106d89:	e9 75 f8 ff ff       	jmp    80106603 <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $32
80106d90:	6a 20                	push   $0x20
  jmp alltraps
80106d92:	e9 6c f8 ff ff       	jmp    80106603 <alltraps>
...
80106d97:	6a 00                	push   $0x0
  pushl $33
80106d99:	6a 21                	push   $0x21
  jmp alltraps
80106d9b:	e9 63 f8 ff ff       	jmp    80106603 <alltraps>
...
80106da0:	6a 00                	push   $0x0
  pushl $34
80106da2:	6a 22                	push   $0x22
  jmp alltraps
80106da4:	e9 5a f8 ff ff       	jmp    80106603 <alltraps>
...
80106da9:	6a 00                	push   $0x0
  pushl $35
80106dab:	6a 23                	push   $0x23
  jmp alltraps
80106dad:	e9 51 f8 ff ff       	jmp    80106603 <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $36
80106db4:	6a 24                	push   $0x24
  jmp alltraps
80106db6:	e9 48 f8 ff ff       	jmp    80106603 <alltraps>
...
80106dbb:	6a 00                	push   $0x0
  pushl $37
80106dbd:	6a 25                	push   $0x25
  jmp alltraps
80106dbf:	e9 3f f8 ff ff       	jmp    80106603 <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $38
80106dc6:	6a 26                	push   $0x26
  jmp alltraps
80106dc8:	e9 36 f8 ff ff       	jmp    80106603 <alltraps>
...
80106dcd:	6a 00                	push   $0x0
  pushl $39
80106dcf:	6a 27                	push   $0x27
  jmp alltraps
80106dd1:	e9 2d f8 ff ff       	jmp    80106603 <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $40
80106dd8:	6a 28                	push   $0x28
  jmp alltraps
80106dda:	e9 24 f8 ff ff       	jmp    80106603 <alltraps>
...
80106ddf:	6a 00                	push   $0x0
  pushl $41
80106de1:	6a 29                	push   $0x29
  jmp alltraps
80106de3:	e9 1b f8 ff ff       	jmp    80106603 <alltraps>
...
80106de8:	6a 00                	push   $0x0
  pushl $42
80106dea:	6a 2a                	push   $0x2a
  jmp alltraps
80106dec:	e9 12 f8 ff ff       	jmp    80106603 <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $43
80106df3:	6a 2b                	push   $0x2b
  jmp alltraps
80106df5:	e9 09 f8 ff ff       	jmp    80106603 <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $44
80106dfc:	6a 2c                	push   $0x2c
  jmp alltraps
80106dfe:	e9 00 f8 ff ff       	jmp    80106603 <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $45
80106e05:	6a 2d                	push   $0x2d
  jmp alltraps
80106e07:	e9 f7 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $46
80106e0e:	6a 2e                	push   $0x2e
  jmp alltraps
80106e10:	e9 ee f7 ff ff       	jmp    80106603 <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $47
80106e17:	6a 2f                	push   $0x2f
  jmp alltraps
80106e19:	e9 e5 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $48
80106e20:	6a 30                	push   $0x30
  jmp alltraps
80106e22:	e9 dc f7 ff ff       	jmp    80106603 <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $49
80106e29:	6a 31                	push   $0x31
  jmp alltraps
80106e2b:	e9 d3 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $50
80106e32:	6a 32                	push   $0x32
  jmp alltraps
80106e34:	e9 ca f7 ff ff       	jmp    80106603 <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $51
80106e3b:	6a 33                	push   $0x33
  jmp alltraps
80106e3d:	e9 c1 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $52
80106e44:	6a 34                	push   $0x34
  jmp alltraps
80106e46:	e9 b8 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $53
80106e4d:	6a 35                	push   $0x35
  jmp alltraps
80106e4f:	e9 af f7 ff ff       	jmp    80106603 <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $54
80106e56:	6a 36                	push   $0x36
  jmp alltraps
80106e58:	e9 a6 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $55
80106e5f:	6a 37                	push   $0x37
  jmp alltraps
80106e61:	e9 9d f7 ff ff       	jmp    80106603 <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $56
80106e68:	6a 38                	push   $0x38
  jmp alltraps
80106e6a:	e9 94 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $57
80106e71:	6a 39                	push   $0x39
  jmp alltraps
80106e73:	e9 8b f7 ff ff       	jmp    80106603 <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $58
80106e7a:	6a 3a                	push   $0x3a
  jmp alltraps
80106e7c:	e9 82 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $59
80106e83:	6a 3b                	push   $0x3b
  jmp alltraps
80106e85:	e9 79 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $60
80106e8c:	6a 3c                	push   $0x3c
  jmp alltraps
80106e8e:	e9 70 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e93:	6a 00                	push   $0x0
  pushl $61
80106e95:	6a 3d                	push   $0x3d
  jmp alltraps
80106e97:	e9 67 f7 ff ff       	jmp    80106603 <alltraps>
...
80106e9c:	6a 00                	push   $0x0
  pushl $62
80106e9e:	6a 3e                	push   $0x3e
  jmp alltraps
80106ea0:	e9 5e f7 ff ff       	jmp    80106603 <alltraps>
...
80106ea5:	6a 00                	push   $0x0
  pushl $63
80106ea7:	6a 3f                	push   $0x3f
  jmp alltraps
80106ea9:	e9 55 f7 ff ff       	jmp    80106603 <alltraps>
...
80106eb0:	6a 40                	push   $0x40
  jmp alltraps
80106eb2:	e9 4c f7 ff ff       	jmp    80106603 <alltraps>
...
80106eb7:	6a 00                	push   $0x0
  pushl $65
80106eb9:	6a 41                	push   $0x41
  jmp alltraps
80106ebb:	e9 43 f7 ff ff       	jmp    80106603 <alltraps>
...
80106ec0:	6a 00                	push   $0x0
  pushl $66
80106ec2:	6a 42                	push   $0x42
  jmp alltraps
80106ec4:	e9 3a f7 ff ff       	jmp    80106603 <alltraps>
...
80106ec9:	6a 00                	push   $0x0
  pushl $67
80106ecb:	6a 43                	push   $0x43
  jmp alltraps
80106ecd:	e9 31 f7 ff ff       	jmp    80106603 <alltraps>
...
80106ed2:	6a 00                	push   $0x0
  pushl $68
80106ed4:	6a 44                	push   $0x44
  jmp alltraps
80106ed6:	e9 28 f7 ff ff       	jmp    80106603 <alltraps>
...
80106edb:	6a 00                	push   $0x0
  pushl $69
80106edd:	6a 45                	push   $0x45
  jmp alltraps
80106edf:	e9 1f f7 ff ff       	jmp    80106603 <alltraps>
...
80106ee4:	6a 00                	push   $0x0
  pushl $70
80106ee6:	6a 46                	push   $0x46
  jmp alltraps
80106ee8:	e9 16 f7 ff ff       	jmp    80106603 <alltraps>
...
80106eed:	6a 00                	push   $0x0
  pushl $71
80106eef:	6a 47                	push   $0x47
  jmp alltraps
80106ef1:	e9 0d f7 ff ff       	jmp    80106603 <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $72
80106ef8:	6a 48                	push   $0x48
  jmp alltraps
80106efa:	e9 04 f7 ff ff       	jmp    80106603 <alltraps>
...
80106eff:	6a 00                	push   $0x0
  pushl $73
80106f01:	6a 49                	push   $0x49
  jmp alltraps
80106f03:	e9 fb f6 ff ff       	jmp    80106603 <alltraps>
...
80106f08:	6a 00                	push   $0x0
  pushl $74
80106f0a:	6a 4a                	push   $0x4a
  jmp alltraps
80106f0c:	e9 f2 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f11:	6a 00                	push   $0x0
  pushl $75
80106f13:	6a 4b                	push   $0x4b
  jmp alltraps
80106f15:	e9 e9 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $76
80106f1c:	6a 4c                	push   $0x4c
  jmp alltraps
80106f1e:	e9 e0 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f23:	6a 00                	push   $0x0
  pushl $77
80106f25:	6a 4d                	push   $0x4d
  jmp alltraps
80106f27:	e9 d7 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f2c:	6a 00                	push   $0x0
  pushl $78
80106f2e:	6a 4e                	push   $0x4e
  jmp alltraps
80106f30:	e9 ce f6 ff ff       	jmp    80106603 <alltraps>
...
80106f35:	6a 00                	push   $0x0
  pushl $79
80106f37:	6a 4f                	push   $0x4f
  jmp alltraps
80106f39:	e9 c5 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $80
80106f40:	6a 50                	push   $0x50
  jmp alltraps
80106f42:	e9 bc f6 ff ff       	jmp    80106603 <alltraps>
...
80106f47:	6a 00                	push   $0x0
  pushl $81
80106f49:	6a 51                	push   $0x51
  jmp alltraps
80106f4b:	e9 b3 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f50:	6a 00                	push   $0x0
  pushl $82
80106f52:	6a 52                	push   $0x52
  jmp alltraps
80106f54:	e9 aa f6 ff ff       	jmp    80106603 <alltraps>
...
80106f59:	6a 00                	push   $0x0
  pushl $83
80106f5b:	6a 53                	push   $0x53
  jmp alltraps
80106f5d:	e9 a1 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $84
80106f64:	6a 54                	push   $0x54
  jmp alltraps
80106f66:	e9 98 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f6b:	6a 00                	push   $0x0
  pushl $85
80106f6d:	6a 55                	push   $0x55
  jmp alltraps
80106f6f:	e9 8f f6 ff ff       	jmp    80106603 <alltraps>
...
80106f74:	6a 00                	push   $0x0
  pushl $86
80106f76:	6a 56                	push   $0x56
  jmp alltraps
80106f78:	e9 86 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f7d:	6a 00                	push   $0x0
  pushl $87
80106f7f:	6a 57                	push   $0x57
  jmp alltraps
80106f81:	e9 7d f6 ff ff       	jmp    80106603 <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $88
80106f88:	6a 58                	push   $0x58
  jmp alltraps
80106f8a:	e9 74 f6 ff ff       	jmp    80106603 <alltraps>
...
80106f8f:	6a 00                	push   $0x0
  pushl $89
80106f91:	6a 59                	push   $0x59
  jmp alltraps
80106f93:	e9 6b f6 ff ff       	jmp    80106603 <alltraps>
...
80106f98:	6a 00                	push   $0x0
  pushl $90
80106f9a:	6a 5a                	push   $0x5a
  jmp alltraps
80106f9c:	e9 62 f6 ff ff       	jmp    80106603 <alltraps>
...
80106fa1:	6a 00                	push   $0x0
  pushl $91
80106fa3:	6a 5b                	push   $0x5b
  jmp alltraps
80106fa5:	e9 59 f6 ff ff       	jmp    80106603 <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $92
80106fac:	6a 5c                	push   $0x5c
  jmp alltraps
80106fae:	e9 50 f6 ff ff       	jmp    80106603 <alltraps>
...
80106fb3:	6a 00                	push   $0x0
  pushl $93
80106fb5:	6a 5d                	push   $0x5d
  jmp alltraps
80106fb7:	e9 47 f6 ff ff       	jmp    80106603 <alltraps>
...
80106fbc:	6a 00                	push   $0x0
  pushl $94
80106fbe:	6a 5e                	push   $0x5e
  jmp alltraps
80106fc0:	e9 3e f6 ff ff       	jmp    80106603 <alltraps>
...
80106fc5:	6a 00                	push   $0x0
  pushl $95
80106fc7:	6a 5f                	push   $0x5f
  jmp alltraps
80106fc9:	e9 35 f6 ff ff       	jmp    80106603 <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $96
80106fd0:	6a 60                	push   $0x60
  jmp alltraps
80106fd2:	e9 2c f6 ff ff       	jmp    80106603 <alltraps>
...
80106fd7:	6a 00                	push   $0x0
  pushl $97
80106fd9:	6a 61                	push   $0x61
  jmp alltraps
80106fdb:	e9 23 f6 ff ff       	jmp    80106603 <alltraps>
...
80106fe0:	6a 00                	push   $0x0
  pushl $98
80106fe2:	6a 62                	push   $0x62
  jmp alltraps
80106fe4:	e9 1a f6 ff ff       	jmp    80106603 <alltraps>
...
80106fe9:	6a 00                	push   $0x0
  pushl $99
80106feb:	6a 63                	push   $0x63
  jmp alltraps
80106fed:	e9 11 f6 ff ff       	jmp    80106603 <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $100
80106ff4:	6a 64                	push   $0x64
  jmp alltraps
80106ff6:	e9 08 f6 ff ff       	jmp    80106603 <alltraps>
...
80106ffb:	6a 00                	push   $0x0
  pushl $101
80106ffd:	6a 65                	push   $0x65
  jmp alltraps
80106fff:	e9 ff f5 ff ff       	jmp    80106603 <alltraps>
...
80107004:	6a 00                	push   $0x0
  pushl $102
80107006:	6a 66                	push   $0x66
  jmp alltraps
80107008:	e9 f6 f5 ff ff       	jmp    80106603 <alltraps>
...
8010700d:	6a 00                	push   $0x0
  pushl $103
8010700f:	6a 67                	push   $0x67
  jmp alltraps
80107011:	e9 ed f5 ff ff       	jmp    80106603 <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $104
80107018:	6a 68                	push   $0x68
  jmp alltraps
8010701a:	e9 e4 f5 ff ff       	jmp    80106603 <alltraps>
...
8010701f:	6a 00                	push   $0x0
  pushl $105
80107021:	6a 69                	push   $0x69
  jmp alltraps
80107023:	e9 db f5 ff ff       	jmp    80106603 <alltraps>
...
80107028:	6a 00                	push   $0x0
  pushl $106
8010702a:	6a 6a                	push   $0x6a
  jmp alltraps
8010702c:	e9 d2 f5 ff ff       	jmp    80106603 <alltraps>
...
80107031:	6a 00                	push   $0x0
  pushl $107
80107033:	6a 6b                	push   $0x6b
  jmp alltraps
80107035:	e9 c9 f5 ff ff       	jmp    80106603 <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $108
8010703c:	6a 6c                	push   $0x6c
  jmp alltraps
8010703e:	e9 c0 f5 ff ff       	jmp    80106603 <alltraps>
...
80107043:	6a 00                	push   $0x0
  pushl $109
80107045:	6a 6d                	push   $0x6d
  jmp alltraps
80107047:	e9 b7 f5 ff ff       	jmp    80106603 <alltraps>
...
8010704c:	6a 00                	push   $0x0
  pushl $110
8010704e:	6a 6e                	push   $0x6e
  jmp alltraps
80107050:	e9 ae f5 ff ff       	jmp    80106603 <alltraps>
...
80107055:	6a 00                	push   $0x0
  pushl $111
80107057:	6a 6f                	push   $0x6f
  jmp alltraps
80107059:	e9 a5 f5 ff ff       	jmp    80106603 <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $112
80107060:	6a 70                	push   $0x70
  jmp alltraps
80107062:	e9 9c f5 ff ff       	jmp    80106603 <alltraps>
...
80107067:	6a 00                	push   $0x0
  pushl $113
80107069:	6a 71                	push   $0x71
  jmp alltraps
8010706b:	e9 93 f5 ff ff       	jmp    80106603 <alltraps>
...
80107070:	6a 00                	push   $0x0
  pushl $114
80107072:	6a 72                	push   $0x72
  jmp alltraps
80107074:	e9 8a f5 ff ff       	jmp    80106603 <alltraps>
...
80107079:	6a 00                	push   $0x0
  pushl $115
8010707b:	6a 73                	push   $0x73
  jmp alltraps
8010707d:	e9 81 f5 ff ff       	jmp    80106603 <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $116
80107084:	6a 74                	push   $0x74
  jmp alltraps
80107086:	e9 78 f5 ff ff       	jmp    80106603 <alltraps>
...
8010708b:	6a 00                	push   $0x0
  pushl $117
8010708d:	6a 75                	push   $0x75
  jmp alltraps
8010708f:	e9 6f f5 ff ff       	jmp    80106603 <alltraps>
...
80107094:	6a 00                	push   $0x0
  pushl $118
80107096:	6a 76                	push   $0x76
  jmp alltraps
80107098:	e9 66 f5 ff ff       	jmp    80106603 <alltraps>
...
8010709d:	6a 00                	push   $0x0
  pushl $119
8010709f:	6a 77                	push   $0x77
  jmp alltraps
801070a1:	e9 5d f5 ff ff       	jmp    80106603 <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $120
801070a8:	6a 78                	push   $0x78
  jmp alltraps
801070aa:	e9 54 f5 ff ff       	jmp    80106603 <alltraps>
...
801070af:	6a 00                	push   $0x0
  pushl $121
801070b1:	6a 79                	push   $0x79
  jmp alltraps
801070b3:	e9 4b f5 ff ff       	jmp    80106603 <alltraps>
...
801070b8:	6a 00                	push   $0x0
  pushl $122
801070ba:	6a 7a                	push   $0x7a
  jmp alltraps
801070bc:	e9 42 f5 ff ff       	jmp    80106603 <alltraps>
...
801070c1:	6a 00                	push   $0x0
  pushl $123
801070c3:	6a 7b                	push   $0x7b
  jmp alltraps
801070c5:	e9 39 f5 ff ff       	jmp    80106603 <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $124
801070cc:	6a 7c                	push   $0x7c
  jmp alltraps
801070ce:	e9 30 f5 ff ff       	jmp    80106603 <alltraps>
...
801070d3:	6a 00                	push   $0x0
  pushl $125
801070d5:	6a 7d                	push   $0x7d
  jmp alltraps
801070d7:	e9 27 f5 ff ff       	jmp    80106603 <alltraps>
...
801070dc:	6a 00                	push   $0x0
  pushl $126
801070de:	6a 7e                	push   $0x7e
  jmp alltraps
801070e0:	e9 1e f5 ff ff       	jmp    80106603 <alltraps>
...
801070e5:	6a 00                	push   $0x0
  pushl $127
801070e7:	6a 7f                	push   $0x7f
  jmp alltraps
801070e9:	e9 15 f5 ff ff       	jmp    80106603 <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $128
801070f0:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801070f5:	e9 09 f5 ff ff       	jmp    80106603 <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $129
801070fc:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107101:	e9 fd f4 ff ff       	jmp    80106603 <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $130
80107108:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010710d:	e9 f1 f4 ff ff       	jmp    80106603 <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $131
80107114:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107119:	e9 e5 f4 ff ff       	jmp    80106603 <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $132
80107120:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107125:	e9 d9 f4 ff ff       	jmp    80106603 <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $133
8010712c:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107131:	e9 cd f4 ff ff       	jmp    80106603 <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $134
80107138:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010713d:	e9 c1 f4 ff ff       	jmp    80106603 <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $135
80107144:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107149:	e9 b5 f4 ff ff       	jmp    80106603 <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $136
80107150:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107155:	e9 a9 f4 ff ff       	jmp    80106603 <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $137
8010715c:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107161:	e9 9d f4 ff ff       	jmp    80106603 <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $138
80107168:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010716d:	e9 91 f4 ff ff       	jmp    80106603 <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $139
80107174:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107179:	e9 85 f4 ff ff       	jmp    80106603 <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $140
80107180:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107185:	e9 79 f4 ff ff       	jmp    80106603 <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $141
8010718c:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107191:	e9 6d f4 ff ff       	jmp    80106603 <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $142
80107198:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010719d:	e9 61 f4 ff ff       	jmp    80106603 <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $143
801071a4:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801071a9:	e9 55 f4 ff ff       	jmp    80106603 <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $144
801071b0:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801071b5:	e9 49 f4 ff ff       	jmp    80106603 <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $145
801071bc:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801071c1:	e9 3d f4 ff ff       	jmp    80106603 <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $146
801071c8:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801071cd:	e9 31 f4 ff ff       	jmp    80106603 <alltraps>
...
801071d2:	6a 00                	push   $0x0
  pushl $147
801071d4:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801071d9:	e9 25 f4 ff ff       	jmp    80106603 <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $148
801071e0:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801071e5:	e9 19 f4 ff ff       	jmp    80106603 <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $149
801071ec:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801071f1:	e9 0d f4 ff ff       	jmp    80106603 <alltraps>
...
801071f6:	6a 00                	push   $0x0
  pushl $150
801071f8:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801071fd:	e9 01 f4 ff ff       	jmp    80106603 <alltraps>
...
80107202:	6a 00                	push   $0x0
  pushl $151
80107204:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107209:	e9 f5 f3 ff ff       	jmp    80106603 <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $152
80107210:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107215:	e9 e9 f3 ff ff       	jmp    80106603 <alltraps>
...
8010721a:	6a 00                	push   $0x0
  pushl $153
8010721c:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107221:	e9 dd f3 ff ff       	jmp    80106603 <alltraps>
...
80107226:	6a 00                	push   $0x0
  pushl $154
80107228:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010722d:	e9 d1 f3 ff ff       	jmp    80106603 <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $155
80107234:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107239:	e9 c5 f3 ff ff       	jmp    80106603 <alltraps>
...
8010723e:	6a 00                	push   $0x0
  pushl $156
80107240:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107245:	e9 b9 f3 ff ff       	jmp    80106603 <alltraps>
...
8010724a:	6a 00                	push   $0x0
  pushl $157
8010724c:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107251:	e9 ad f3 ff ff       	jmp    80106603 <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $158
80107258:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010725d:	e9 a1 f3 ff ff       	jmp    80106603 <alltraps>
...
80107262:	6a 00                	push   $0x0
  pushl $159
80107264:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107269:	e9 95 f3 ff ff       	jmp    80106603 <alltraps>
...
8010726e:	6a 00                	push   $0x0
  pushl $160
80107270:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107275:	e9 89 f3 ff ff       	jmp    80106603 <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $161
8010727c:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107281:	e9 7d f3 ff ff       	jmp    80106603 <alltraps>
...
80107286:	6a 00                	push   $0x0
  pushl $162
80107288:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010728d:	e9 71 f3 ff ff       	jmp    80106603 <alltraps>
...
80107292:	6a 00                	push   $0x0
  pushl $163
80107294:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107299:	e9 65 f3 ff ff       	jmp    80106603 <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $164
801072a0:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801072a5:	e9 59 f3 ff ff       	jmp    80106603 <alltraps>
...
801072aa:	6a 00                	push   $0x0
  pushl $165
801072ac:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801072b1:	e9 4d f3 ff ff       	jmp    80106603 <alltraps>
...
801072b6:	6a 00                	push   $0x0
  pushl $166
801072b8:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801072bd:	e9 41 f3 ff ff       	jmp    80106603 <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $167
801072c4:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801072c9:	e9 35 f3 ff ff       	jmp    80106603 <alltraps>
...
801072ce:	6a 00                	push   $0x0
  pushl $168
801072d0:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801072d5:	e9 29 f3 ff ff       	jmp    80106603 <alltraps>
...
801072da:	6a 00                	push   $0x0
  pushl $169
801072dc:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801072e1:	e9 1d f3 ff ff       	jmp    80106603 <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $170
801072e8:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801072ed:	e9 11 f3 ff ff       	jmp    80106603 <alltraps>
...
801072f2:	6a 00                	push   $0x0
  pushl $171
801072f4:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801072f9:	e9 05 f3 ff ff       	jmp    80106603 <alltraps>
...
801072fe:	6a 00                	push   $0x0
  pushl $172
80107300:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107305:	e9 f9 f2 ff ff       	jmp    80106603 <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $173
8010730c:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107311:	e9 ed f2 ff ff       	jmp    80106603 <alltraps>
...
80107316:	6a 00                	push   $0x0
  pushl $174
80107318:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010731d:	e9 e1 f2 ff ff       	jmp    80106603 <alltraps>
...
80107322:	6a 00                	push   $0x0
  pushl $175
80107324:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107329:	e9 d5 f2 ff ff       	jmp    80106603 <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $176
80107330:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107335:	e9 c9 f2 ff ff       	jmp    80106603 <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $177
8010733c:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107341:	e9 bd f2 ff ff       	jmp    80106603 <alltraps>
...
80107346:	6a 00                	push   $0x0
  pushl $178
80107348:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010734d:	e9 b1 f2 ff ff       	jmp    80106603 <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $179
80107354:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107359:	e9 a5 f2 ff ff       	jmp    80106603 <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $180
80107360:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107365:	e9 99 f2 ff ff       	jmp    80106603 <alltraps>
...
8010736a:	6a 00                	push   $0x0
  pushl $181
8010736c:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107371:	e9 8d f2 ff ff       	jmp    80106603 <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $182
80107378:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010737d:	e9 81 f2 ff ff       	jmp    80106603 <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $183
80107384:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107389:	e9 75 f2 ff ff       	jmp    80106603 <alltraps>
...
8010738e:	6a 00                	push   $0x0
  pushl $184
80107390:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107395:	e9 69 f2 ff ff       	jmp    80106603 <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $185
8010739c:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801073a1:	e9 5d f2 ff ff       	jmp    80106603 <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $186
801073a8:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801073ad:	e9 51 f2 ff ff       	jmp    80106603 <alltraps>
...
801073b2:	6a 00                	push   $0x0
  pushl $187
801073b4:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801073b9:	e9 45 f2 ff ff       	jmp    80106603 <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $188
801073c0:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801073c5:	e9 39 f2 ff ff       	jmp    80106603 <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $189
801073cc:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801073d1:	e9 2d f2 ff ff       	jmp    80106603 <alltraps>
...
801073d6:	6a 00                	push   $0x0
  pushl $190
801073d8:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801073dd:	e9 21 f2 ff ff       	jmp    80106603 <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $191
801073e4:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801073e9:	e9 15 f2 ff ff       	jmp    80106603 <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $192
801073f0:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801073f5:	e9 09 f2 ff ff       	jmp    80106603 <alltraps>
...
801073fa:	6a 00                	push   $0x0
  pushl $193
801073fc:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107401:	e9 fd f1 ff ff       	jmp    80106603 <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $194
80107408:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010740d:	e9 f1 f1 ff ff       	jmp    80106603 <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $195
80107414:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107419:	e9 e5 f1 ff ff       	jmp    80106603 <alltraps>
...
8010741e:	6a 00                	push   $0x0
  pushl $196
80107420:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107425:	e9 d9 f1 ff ff       	jmp    80106603 <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $197
8010742c:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107431:	e9 cd f1 ff ff       	jmp    80106603 <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $198
80107438:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010743d:	e9 c1 f1 ff ff       	jmp    80106603 <alltraps>
...
80107442:	6a 00                	push   $0x0
  pushl $199
80107444:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107449:	e9 b5 f1 ff ff       	jmp    80106603 <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $200
80107450:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107455:	e9 a9 f1 ff ff       	jmp    80106603 <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $201
8010745c:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107461:	e9 9d f1 ff ff       	jmp    80106603 <alltraps>
...
80107466:	6a 00                	push   $0x0
  pushl $202
80107468:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010746d:	e9 91 f1 ff ff       	jmp    80106603 <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $203
80107474:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107479:	e9 85 f1 ff ff       	jmp    80106603 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $204
80107480:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107485:	e9 79 f1 ff ff       	jmp    80106603 <alltraps>
...
8010748a:	6a 00                	push   $0x0
  pushl $205
8010748c:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107491:	e9 6d f1 ff ff       	jmp    80106603 <alltraps>
...
80107496:	6a 00                	push   $0x0
  pushl $206
80107498:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010749d:	e9 61 f1 ff ff       	jmp    80106603 <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $207
801074a4:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801074a9:	e9 55 f1 ff ff       	jmp    80106603 <alltraps>
...
801074ae:	6a 00                	push   $0x0
  pushl $208
801074b0:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801074b5:	e9 49 f1 ff ff       	jmp    80106603 <alltraps>
...
801074ba:	6a 00                	push   $0x0
  pushl $209
801074bc:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801074c1:	e9 3d f1 ff ff       	jmp    80106603 <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $210
801074c8:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801074cd:	e9 31 f1 ff ff       	jmp    80106603 <alltraps>
...
801074d2:	6a 00                	push   $0x0
  pushl $211
801074d4:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801074d9:	e9 25 f1 ff ff       	jmp    80106603 <alltraps>
...
801074de:	6a 00                	push   $0x0
  pushl $212
801074e0:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801074e5:	e9 19 f1 ff ff       	jmp    80106603 <alltraps>
...
801074ea:	6a 00                	push   $0x0
  pushl $213
801074ec:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801074f1:	e9 0d f1 ff ff       	jmp    80106603 <alltraps>
...
801074f6:	6a 00                	push   $0x0
  pushl $214
801074f8:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801074fd:	e9 01 f1 ff ff       	jmp    80106603 <alltraps>
...
80107502:	6a 00                	push   $0x0
  pushl $215
80107504:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107509:	e9 f5 f0 ff ff       	jmp    80106603 <alltraps>
...
8010750e:	6a 00                	push   $0x0
  pushl $216
80107510:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107515:	e9 e9 f0 ff ff       	jmp    80106603 <alltraps>
...
8010751a:	6a 00                	push   $0x0
  pushl $217
8010751c:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107521:	e9 dd f0 ff ff       	jmp    80106603 <alltraps>
...
80107526:	6a 00                	push   $0x0
  pushl $218
80107528:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010752d:	e9 d1 f0 ff ff       	jmp    80106603 <alltraps>
...
80107532:	6a 00                	push   $0x0
  pushl $219
80107534:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107539:	e9 c5 f0 ff ff       	jmp    80106603 <alltraps>
...
8010753e:	6a 00                	push   $0x0
  pushl $220
80107540:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107545:	e9 b9 f0 ff ff       	jmp    80106603 <alltraps>
...
8010754a:	6a 00                	push   $0x0
  pushl $221
8010754c:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107551:	e9 ad f0 ff ff       	jmp    80106603 <alltraps>
...
80107556:	6a 00                	push   $0x0
  pushl $222
80107558:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010755d:	e9 a1 f0 ff ff       	jmp    80106603 <alltraps>
...
80107562:	6a 00                	push   $0x0
  pushl $223
80107564:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107569:	e9 95 f0 ff ff       	jmp    80106603 <alltraps>
...
8010756e:	6a 00                	push   $0x0
  pushl $224
80107570:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107575:	e9 89 f0 ff ff       	jmp    80106603 <alltraps>
...
8010757a:	6a 00                	push   $0x0
  pushl $225
8010757c:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107581:	e9 7d f0 ff ff       	jmp    80106603 <alltraps>
...
80107586:	6a 00                	push   $0x0
  pushl $226
80107588:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010758d:	e9 71 f0 ff ff       	jmp    80106603 <alltraps>
...
80107592:	6a 00                	push   $0x0
  pushl $227
80107594:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107599:	e9 65 f0 ff ff       	jmp    80106603 <alltraps>
...
8010759e:	6a 00                	push   $0x0
  pushl $228
801075a0:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801075a5:	e9 59 f0 ff ff       	jmp    80106603 <alltraps>
...
801075aa:	6a 00                	push   $0x0
  pushl $229
801075ac:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801075b1:	e9 4d f0 ff ff       	jmp    80106603 <alltraps>
...
801075b6:	6a 00                	push   $0x0
  pushl $230
801075b8:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801075bd:	e9 41 f0 ff ff       	jmp    80106603 <alltraps>
...
801075c2:	6a 00                	push   $0x0
  pushl $231
801075c4:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801075c9:	e9 35 f0 ff ff       	jmp    80106603 <alltraps>
...
801075ce:	6a 00                	push   $0x0
  pushl $232
801075d0:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801075d5:	e9 29 f0 ff ff       	jmp    80106603 <alltraps>
...
801075da:	6a 00                	push   $0x0
  pushl $233
801075dc:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801075e1:	e9 1d f0 ff ff       	jmp    80106603 <alltraps>
...
801075e6:	6a 00                	push   $0x0
  pushl $234
801075e8:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801075ed:	e9 11 f0 ff ff       	jmp    80106603 <alltraps>
...
801075f2:	6a 00                	push   $0x0
  pushl $235
801075f4:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801075f9:	e9 05 f0 ff ff       	jmp    80106603 <alltraps>
...
801075fe:	6a 00                	push   $0x0
  pushl $236
80107600:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107605:	e9 f9 ef ff ff       	jmp    80106603 <alltraps>
...
8010760a:	6a 00                	push   $0x0
  pushl $237
8010760c:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107611:	e9 ed ef ff ff       	jmp    80106603 <alltraps>
...
80107616:	6a 00                	push   $0x0
  pushl $238
80107618:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010761d:	e9 e1 ef ff ff       	jmp    80106603 <alltraps>
...
80107622:	6a 00                	push   $0x0
  pushl $239
80107624:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107629:	e9 d5 ef ff ff       	jmp    80106603 <alltraps>
...
8010762e:	6a 00                	push   $0x0
  pushl $240
80107630:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107635:	e9 c9 ef ff ff       	jmp    80106603 <alltraps>
...
8010763a:	6a 00                	push   $0x0
  pushl $241
8010763c:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107641:	e9 bd ef ff ff       	jmp    80106603 <alltraps>
...
80107646:	6a 00                	push   $0x0
  pushl $242
80107648:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010764d:	e9 b1 ef ff ff       	jmp    80106603 <alltraps>
...
80107652:	6a 00                	push   $0x0
  pushl $243
80107654:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107659:	e9 a5 ef ff ff       	jmp    80106603 <alltraps>
...
8010765e:	6a 00                	push   $0x0
  pushl $244
80107660:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107665:	e9 99 ef ff ff       	jmp    80106603 <alltraps>
...
8010766a:	6a 00                	push   $0x0
  pushl $245
8010766c:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107671:	e9 8d ef ff ff       	jmp    80106603 <alltraps>
...
80107676:	6a 00                	push   $0x0
  pushl $246
80107678:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010767d:	e9 81 ef ff ff       	jmp    80106603 <alltraps>
...
80107682:	6a 00                	push   $0x0
  pushl $247
80107684:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107689:	e9 75 ef ff ff       	jmp    80106603 <alltraps>
...
8010768e:	6a 00                	push   $0x0
  pushl $248
80107690:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107695:	e9 69 ef ff ff       	jmp    80106603 <alltraps>
...
8010769a:	6a 00                	push   $0x0
  pushl $249
8010769c:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801076a1:	e9 5d ef ff ff       	jmp    80106603 <alltraps>
...
801076a6:	6a 00                	push   $0x0
  pushl $250
801076a8:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801076ad:	e9 51 ef ff ff       	jmp    80106603 <alltraps>
...
801076b2:	6a 00                	push   $0x0
  pushl $251
801076b4:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801076b9:	e9 45 ef ff ff       	jmp    80106603 <alltraps>
...
801076be:	6a 00                	push   $0x0
  pushl $252
801076c0:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801076c5:	e9 39 ef ff ff       	jmp    80106603 <alltraps>
...
801076ca:	6a 00                	push   $0x0
  pushl $253
801076cc:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801076d1:	e9 2d ef ff ff       	jmp    80106603 <alltraps>
...
801076d6:	6a 00                	push   $0x0
  pushl $254
801076d8:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801076dd:	e9 21 ef ff ff       	jmp    80106603 <alltraps>
...
801076e2:	6a 00                	push   $0x0
  pushl $255
801076e4:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801076e9:	e9 15 ef ff ff       	jmp    80106603 <alltraps>
...
801076f1:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801076f4:	8b 45 0c             	mov    0xc(%ebp),%eax
801076f7:	83 e8 01             	sub    $0x1,%eax
801076fa:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801076fe:	8b 45 08             	mov    0x8(%ebp),%eax
80107701:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107705:	8b 45 08             	mov    0x8(%ebp),%eax
80107708:	c1 e8 10             	shr    $0x10,%eax
8010770b:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
8010770f:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107712:	0f 01 10             	lgdtl  (%eax)
}
80107715:	c9                   	leave  
80107716:	c3                   	ret    
...
ltr(ushort sel)
{
80107717:	55                   	push   %ebp
80107718:	89 e5                	mov    %esp,%ebp
8010771a:	83 ec 04             	sub    $0x4,%esp
8010771d:	8b 45 08             	mov    0x8(%ebp),%eax
80107720:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107724:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107728:	0f 00 d8             	ltr    %ax
}
8010772b:	c9                   	leave  
8010772c:	c3                   	ret    
...
80107736:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
8010773a:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010773e:	8e e8                	mov    %eax,%gs
}
80107740:	c9                   	leave  
80107741:	c3                   	ret    
...
8010776a:	53                   	push   %ebx
8010776b:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
8010776e:	e8 e0 b6 ff ff       	call   80102e53 <cpunum>
80107773:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107779:	05 40 f9 10 80       	add    $0x8010f940,%eax
...
8010779d:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077a1:	83 e2 f0             	and    $0xfffffff0,%edx
801077a4:	83 ca 0a             	or     $0xa,%edx
801077a7:	88 50 7d             	mov    %dl,0x7d(%eax)
801077aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ad:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077b1:	83 ca 10             	or     $0x10,%edx
801077b4:	88 50 7d             	mov    %dl,0x7d(%eax)
801077b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ba:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077be:	83 e2 9f             	and    $0xffffff9f,%edx
801077c1:	88 50 7d             	mov    %dl,0x7d(%eax)
801077c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077cb:	83 ca 80             	or     $0xffffff80,%edx
801077ce:	88 50 7d             	mov    %dl,0x7d(%eax)
801077d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d4:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801077d8:	83 ca 0f             	or     $0xf,%edx
801077db:	88 50 7e             	mov    %dl,0x7e(%eax)
801077de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e1:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801077e5:	83 e2 ef             	and    $0xffffffef,%edx
801077e8:	88 50 7e             	mov    %dl,0x7e(%eax)
801077eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ee:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801077f2:	83 e2 df             	and    $0xffffffdf,%edx
801077f5:	88 50 7e             	mov    %dl,0x7e(%eax)
...
80107815:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107819:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010781c:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107823:	ff ff 
80107825:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107828:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
8010782f:	00 00 
80107831:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107834:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
8010783b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010783e:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
...
80107867:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010786e:	83 e2 9f             	and    $0xffffff9f,%edx
...
801078ec:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801078f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078f6:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801078fd:	ff ff 
801078ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107902:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107909:	00 00 
8010790b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790e:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107915:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107918:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010791f:	83 e2 f0             	and    $0xfffffff0,%edx
80107922:	83 ca 0a             	or     $0xa,%edx
...
80107935:	83 ca 10             	or     $0x10,%edx
80107938:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
8010793e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107941:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107948:	83 ca 60             	or     $0x60,%edx
...
80107981:	83 e2 ef             	and    $0xffffffef,%edx
...
80107994:	83 e2 df             	and    $0xffffffdf,%edx
...
801079ba:	83 ca 80             	or     $0xffffff80,%edx
801079bd:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801079c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c6:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801079cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d0:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801079d7:	ff ff 
801079d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079dc:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801079e3:	00 00 
801079e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e8:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801079ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f2:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801079f9:	83 e2 f0             	and    $0xfffffff0,%edx
801079fc:	83 ca 02             	or     $0x2,%edx
...
80107a0f:	83 ca 10             	or     $0x10,%edx
80107a12:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107a18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a1b:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
...
80107a6e:	83 e2 df             	and    $0xffffffdf,%edx
...
80107aa0:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107aa7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aaa:	05 b4 00 00 00       	add    $0xb4,%eax
80107aaf:	89 c3                	mov    %eax,%ebx
80107ab1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab4:	05 b4 00 00 00       	add    $0xb4,%eax
80107ab9:	c1 e8 10             	shr    $0x10,%eax
80107abc:	89 c1                	mov    %eax,%ecx
80107abe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ac1:	05 b4 00 00 00       	add    $0xb4,%eax
80107ac6:	c1 e8 18             	shr    $0x18,%eax
80107ac9:	89 c2                	mov    %eax,%edx
80107acb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ace:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107ad5:	00 00 
80107ad7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ada:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107ae1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ae4:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107aea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aed:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107af4:	83 e1 f0             	and    $0xfffffff0,%ecx
80107af7:	83 c9 02             	or     $0x2,%ecx
80107afa:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b03:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b0a:	83 c9 10             	or     $0x10,%ecx
80107b0d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b16:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b1d:	83 e1 9f             	and    $0xffffff9f,%ecx
...
80107b30:	83 c9 80             	or     $0xffffff80,%ecx
80107b33:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b43:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b46:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b4f:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b56:	83 e1 ef             	and    $0xffffffef,%ecx
80107b59:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b62:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b69:	83 e1 df             	and    $0xffffffdf,%ecx
...
80107b8f:	83 c9 80             	or     $0xffffff80,%ecx
80107b92:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b9b:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107ba1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ba4:	83 c0 70             	add    $0x70,%eax
80107ba7:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107bae:	00 
80107baf:	89 04 24             	mov    %eax,(%esp)
80107bb2:	e8 37 fb ff ff       	call   801076ee <lgdt>
  loadgs(SEG_KCPU << 3);
80107bb7:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107bbe:	e8 6a fb ff ff       	call   8010772d <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107bc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc6:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107bcc:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107bd3:	00 00 00 00 
}
80107bd7:	83 c4 24             	add    $0x24,%esp
80107bda:	5b                   	pop    %ebx
80107bdb:	5d                   	pop    %ebp
80107bdc:	c3                   	ret    
...
80107c02:	74 17                	je     80107c1b <walkpgdir+0x3e>
...
80107c11:	e8 44 fb ff ff       	call   8010775a <p2v>
80107c16:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c19:	eb 4b                	jmp    80107c66 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107c1b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107c1f:	74 0e                	je     80107c2f <walkpgdir+0x52>
80107c21:	e8 b4 ae ff ff       	call   80102ada <kalloc>
80107c26:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c29:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107c2d:	75 07                	jne    80107c36 <walkpgdir+0x59>
      return 0;
80107c2f:	b8 00 00 00 00       	mov    $0x0,%eax
80107c34:	eb 47                	jmp    80107c7d <walkpgdir+0xa0>
...
80107c57:	e8 f1 fa ff ff       	call   8010774d <v2p>
80107c5c:	83 c8 07             	or     $0x7,%eax
...
80107c71:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107cb8:	e8 20 ff ff ff       	call   80107bdd <walkpgdir>
80107cbd:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107cc0:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107cc4:	75 07                	jne    80107ccd <mappages+0x4e>
      return -1;
80107cc6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107ccb:	eb 48                	jmp    80107d15 <mappages+0x96>
    if(*pte & PTE_P)
80107ccd:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cd0:	8b 00                	mov    (%eax),%eax
80107cd2:	83 e0 01             	and    $0x1,%eax
80107cd5:	85 c0                	test   %eax,%eax
80107cd7:	74 0c                	je     80107ce5 <mappages+0x66>
      panic("remap");
80107cd9:	c7 04 24 3c 8b 10 80 	movl   $0x80108b3c,(%esp)
80107ce0:	e8 55 88 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107ce5:	8b 45 18             	mov    0x18(%ebp),%eax
80107ce8:	0b 45 14             	or     0x14(%ebp),%eax
80107ceb:	83 c8 01             	or     $0x1,%eax
80107cee:	89 c2                	mov    %eax,%edx
80107cf0:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cf3:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107cf5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf8:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107cfb:	75 08                	jne    80107d05 <mappages+0x86>
      break;
80107cfd:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107d03:	eb 10                	jmp    80107d15 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107d05:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107d0c:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107d13:	eb 8e                	jmp    80107ca3 <mappages+0x24>
  return 0;
}
80107d15:	c9                   	leave  
80107d16:	c3                   	ret    
...
80107d1b:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107d1e:	e8 b7 ad ff ff       	call   80102ada <kalloc>
80107d23:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d26:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107d2a:	75 0a                	jne    80107d36 <setupkvm+0x1f>
    return 0;
80107d2c:	b8 00 00 00 00       	mov    $0x0,%eax
80107d31:	e9 98 00 00 00       	jmp    80107dce <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107d36:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107d3d:	00 
80107d3e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d45:	00 
80107d46:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d49:	89 04 24             	mov    %eax,(%esp)
80107d4c:	e8 e1 d3 ff ff       	call   80105132 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107d51:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107d58:	e8 fd f9 ff ff       	call   8010775a <p2v>
80107d5d:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107d62:	76 0c                	jbe    80107d70 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107d64:	c7 04 24 42 8b 10 80 	movl   $0x80108b42,(%esp)
80107d6b:	e8 ca 87 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107d70:	c7 45 f4 c0 b4 10 80 	movl   $0x8010b4c0,-0xc(%ebp)
80107d77:	eb 49                	jmp    80107dc2 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107d79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d7c:	8b 48 0c             	mov    0xc(%eax),%ecx
80107d7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d82:	8b 50 04             	mov    0x4(%eax),%edx
80107d85:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d88:	8b 58 08             	mov    0x8(%eax),%ebx
80107d8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d8e:	8b 40 04             	mov    0x4(%eax),%eax
80107d91:	29 c3                	sub    %eax,%ebx
80107d93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d96:	8b 00                	mov    (%eax),%eax
80107d98:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107d9c:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107da0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107da4:	89 44 24 04          	mov    %eax,0x4(%esp)
80107da8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107dab:	89 04 24             	mov    %eax,(%esp)
80107dae:	e8 cc fe ff ff       	call   80107c7f <mappages>
80107db3:	85 c0                	test   %eax,%eax
80107db5:	79 07                	jns    80107dbe <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107db7:	b8 00 00 00 00       	mov    $0x0,%eax
80107dbc:	eb 10                	jmp    80107dce <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107dbe:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107dc2:	81 7d f4 00 b5 10 80 	cmpl   $0x8010b500,-0xc(%ebp)
80107dc9:	72 ae                	jb     80107d79 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107dce:	83 c4 34             	add    $0x34,%esp
80107dd1:	5b                   	pop    %ebx
80107dd2:	5d                   	pop    %ebp
80107dd3:	c3                   	ret    
...
80107dd7:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107dda:	e8 38 ff ff ff       	call   80107d17 <setupkvm>
80107ddf:	a3 18 29 11 80       	mov    %eax,0x80112918
  switchkvm();
80107de4:	e8 02 00 00 00       	call   80107deb <switchkvm>
}
80107de9:	c9                   	leave  
80107dea:	c3                   	ret    
...
80107df1:	a1 18 29 11 80       	mov    0x80112918,%eax
80107df6:	89 04 24             	mov    %eax,(%esp)
80107df9:	e8 4f f9 ff ff       	call   8010774d <v2p>
80107dfe:	89 04 24             	mov    %eax,(%esp)
80107e01:	e8 3c f9 ff ff       	call   80107742 <lcr3>
}
80107e06:	c9                   	leave  
80107e07:	c3                   	ret    
...
80107e0c:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107e0f:	e8 1e d2 ff ff       	call   80105032 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107e14:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e1a:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e21:	83 c2 08             	add    $0x8,%edx
80107e24:	89 d3                	mov    %edx,%ebx
80107e26:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e2d:	83 c2 08             	add    $0x8,%edx
80107e30:	c1 ea 10             	shr    $0x10,%edx
80107e33:	89 d1                	mov    %edx,%ecx
80107e35:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e3c:	83 c2 08             	add    $0x8,%edx
80107e3f:	c1 ea 18             	shr    $0x18,%edx
80107e42:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107e49:	67 00 
80107e4b:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107e52:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107e58:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e5f:	83 e1 f0             	and    $0xfffffff0,%ecx
80107e62:	83 c9 09             	or     $0x9,%ecx
80107e65:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e6b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e72:	83 c9 10             	or     $0x10,%ecx
80107e75:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e7b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e82:	83 e1 9f             	and    $0xffffff9f,%ecx
80107e85:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e8b:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e92:	83 c9 80             	or     $0xffffff80,%ecx
80107e95:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e9b:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ea2:	83 e1 f0             	and    $0xfffffff0,%ecx
80107ea5:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107eab:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107eb2:	83 e1 ef             	and    $0xffffffef,%ecx
80107eb5:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ebb:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ec2:	83 e1 df             	and    $0xffffffdf,%ecx
...
80107ee2:	83 e1 7f             	and    $0x7f,%ecx
80107ee5:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107eeb:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107ef1:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
...
80107f0d:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107f13:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f19:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107f20:	8b 52 08             	mov    0x8(%edx),%edx
80107f23:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107f29:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107f2c:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107f33:	e8 df f7 ff ff       	call   80107717 <ltr>
  if(p->pgdir == 0)
80107f38:	8b 45 08             	mov    0x8(%ebp),%eax
80107f3b:	8b 40 04             	mov    0x4(%eax),%eax
80107f3e:	85 c0                	test   %eax,%eax
80107f40:	75 0c                	jne    80107f4e <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107f42:	c7 04 24 53 8b 10 80 	movl   $0x80108b53,(%esp)
...
80107f57:	e8 f1 f7 ff ff       	call   8010774d <v2p>
80107f5c:	89 04 24             	mov    %eax,(%esp)
80107f5f:	e8 de f7 ff ff       	call   80107742 <lcr3>
  popcli();
80107f64:	e8 0d d1 ff ff       	call   80105076 <popcli>
}
80107f69:	83 c4 14             	add    $0x14,%esp
80107f6c:	5b                   	pop    %ebx
80107f6d:	5d                   	pop    %ebp
80107f6e:	c3                   	ret    
...
80107f72:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107f75:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107f7c:	76 0c                	jbe    80107f8a <inituvm+0x1b>
    panic("inituvm: more than a page");
80107f7e:	c7 04 24 67 8b 10 80 	movl   $0x80108b67,(%esp)
80107f85:	e8 b0 85 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107f8a:	e8 4b ab ff ff       	call   80102ada <kalloc>
...
80107fa8:	e8 85 d1 ff ff       	call   80105132 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107fad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb0:	89 04 24             	mov    %eax,(%esp)
80107fb3:	e8 95 f7 ff ff       	call   8010774d <v2p>
80107fb8:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107fbf:	00 
80107fc0:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80107fda:	e8 a0 fc ff ff       	call   80107c7f <mappages>
  memmove(mem, init, sz);
80107fdf:	8b 45 10             	mov    0x10(%ebp),%eax
80107fe2:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107ff3:	e8 09 d2 ff ff       	call   80105201 <memmove>
}
80107ff8:	c9                   	leave  
80107ff9:	c3                   	ret    
...
80107ffe:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80108001:	8b 45 0c             	mov    0xc(%ebp),%eax
80108004:	25 ff 0f 00 00       	and    $0xfff,%eax
80108009:	85 c0                	test   %eax,%eax
8010800b:	74 0c                	je     80108019 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
8010800d:	c7 04 24 84 8b 10 80 	movl   $0x80108b84,(%esp)
80108014:	e8 21 85 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108019:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108020:	e9 a9 00 00 00       	jmp    801080ce <loaduvm+0xd4>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108025:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108028:	8b 55 0c             	mov    0xc(%ebp),%edx
8010802b:	01 d0                	add    %edx,%eax
8010802d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108034:	00 
80108035:	89 44 24 04          	mov    %eax,0x4(%esp)
80108039:	8b 45 08             	mov    0x8(%ebp),%eax
8010803c:	89 04 24             	mov    %eax,(%esp)
8010803f:	e8 99 fb ff ff       	call   80107bdd <walkpgdir>
80108044:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108047:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010804b:	75 0c                	jne    80108059 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010804d:	c7 04 24 a7 8b 10 80 	movl   $0x80108ba7,(%esp)
80108054:	e8 e1 84 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
80108059:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010805c:	8b 00                	mov    (%eax),%eax
8010805e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108063:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108066:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108069:	8b 55 18             	mov    0x18(%ebp),%edx
8010806c:	29 c2                	sub    %eax,%edx
8010806e:	89 d0                	mov    %edx,%eax
80108070:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108075:	77 0f                	ja     80108086 <loaduvm+0x8c>
      n = sz - i;
80108077:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010807a:	8b 55 18             	mov    0x18(%ebp),%edx
8010807d:	29 c2                	sub    %eax,%edx
8010807f:	89 d0                	mov    %edx,%eax
80108081:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108084:	eb 07                	jmp    8010808d <loaduvm+0x93>
    else
      n = PGSIZE;
80108086:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
8010808d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108090:	8b 55 14             	mov    0x14(%ebp),%edx
80108093:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108096:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108099:	89 04 24             	mov    %eax,(%esp)
8010809c:	e8 b9 f6 ff ff       	call   8010775a <p2v>
801080a1:	8b 55 f0             	mov    -0x10(%ebp),%edx
801080a4:	89 54 24 0c          	mov    %edx,0xc(%esp)
801080a8:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801080ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801080b0:	8b 45 10             	mov    0x10(%ebp),%eax
801080b3:	89 04 24             	mov    %eax,(%esp)
801080b6:	e8 a5 9c ff ff       	call   80101d60 <readi>
801080bb:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801080be:	74 07                	je     801080c7 <loaduvm+0xcd>
      return -1;
801080c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801080c5:	eb 18                	jmp    801080df <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
801080d4:	0f 82 4b ff ff ff    	jb     80108025 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801080df:	83 c4 24             	add    $0x24,%esp
801080e2:	5b                   	pop    %ebx
801080e3:	5d                   	pop    %ebp
801080e4:	c3                   	ret    
...
801080f0:	79 0a                	jns    801080fc <allocuvm+0x17>
    return 0;
801080f2:	b8 00 00 00 00       	mov    $0x0,%eax
801080f7:	e9 c1 00 00 00       	jmp    801081bd <allocuvm+0xd8>
  if(newsz < oldsz)
801080fc:	8b 45 10             	mov    0x10(%ebp),%eax
801080ff:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108102:	73 08                	jae    8010810c <allocuvm+0x27>
    return oldsz;
80108104:	8b 45 0c             	mov    0xc(%ebp),%eax
80108107:	e9 b1 00 00 00       	jmp    801081bd <allocuvm+0xd8>
...
8010811c:	e9 8d 00 00 00       	jmp    801081ae <allocuvm+0xc9>
    mem = kalloc();
80108121:	e8 b4 a9 ff ff       	call   80102ada <kalloc>
80108126:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108129:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010812d:	75 2c                	jne    8010815b <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010812f:	c7 04 24 c5 8b 10 80 	movl   $0x80108bc5,(%esp)
80108136:	e8 65 82 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010813b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010813e:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010814f:	e8 6b 00 00 00       	call   801081bf <deallocuvm>
      return 0;
80108154:	b8 00 00 00 00       	mov    $0x0,%eax
80108159:	eb 62                	jmp    801081bd <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
8010815b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108162:	00 
80108163:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010816a:	00 
8010816b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010816e:	89 04 24             	mov    %eax,(%esp)
80108171:	e8 bc cf ff ff       	call   80105132 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108176:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108179:	89 04 24             	mov    %eax,(%esp)
8010817c:	e8 cc f5 ff ff       	call   8010774d <v2p>
80108181:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108184:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
8010818b:	00 
8010818c:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
801081a2:	e8 d8 fa ff ff       	call   80107c7f <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801081a7:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801081ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081b1:	3b 45 10             	cmp    0x10(%ebp),%eax
801081b4:	0f 82 67 ff ff ff    	jb     80108121 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801081c2:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801081c5:	8b 45 10             	mov    0x10(%ebp),%eax
801081c8:	3b 45 0c             	cmp    0xc(%ebp),%eax
801081cb:	72 08                	jb     801081d5 <deallocuvm+0x16>
    return oldsz;
801081cd:	8b 45 0c             	mov    0xc(%ebp),%eax
801081d0:	e9 a4 00 00 00       	jmp    80108279 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801081d5:	8b 45 10             	mov    0x10(%ebp),%eax
801081d8:	05 ff 0f 00 00       	add    $0xfff,%eax
801081dd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081e2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801081e5:	e9 80 00 00 00       	jmp    8010826a <deallocuvm+0xab>
...
801081ff:	e8 d9 f9 ff ff       	call   80107bdd <walkpgdir>
80108204:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108207:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010820b:	75 09                	jne    80108216 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010820d:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108214:	eb 4d                	jmp    80108263 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108216:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108219:	8b 00                	mov    (%eax),%eax
8010821b:	83 e0 01             	and    $0x1,%eax
8010821e:	85 c0                	test   %eax,%eax
80108220:	74 41                	je     80108263 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108222:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108225:	8b 00                	mov    (%eax),%eax
80108227:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010822c:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010822f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108233:	75 0c                	jne    80108241 <deallocuvm+0x82>
        panic("kfree");
80108235:	c7 04 24 dd 8b 10 80 	movl   $0x80108bdd,(%esp)
8010823c:	e8 f9 82 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
80108241:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108244:	89 04 24             	mov    %eax,(%esp)
80108247:	e8 0e f5 ff ff       	call   8010775a <p2v>
8010824c:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010824f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108252:	89 04 24             	mov    %eax,(%esp)
80108255:	e8 e7 a7 ff ff       	call   80102a41 <kfree>
      *pte = 0;
8010825a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010825d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80108263:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010826a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010826d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108270:	0f 82 74 ff ff ff    	jb     801081ea <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
8010827e:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108281:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80108285:	75 0c                	jne    80108293 <freevm+0x18>
    panic("freevm: no pgdir");
80108287:	c7 04 24 e3 8b 10 80 	movl   $0x80108be3,(%esp)
8010828e:	e8 a7 82 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108293:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010829a:	00 
8010829b:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801082a2:	80 
801082a3:	8b 45 08             	mov    0x8(%ebp),%eax
801082a6:	89 04 24             	mov    %eax,(%esp)
801082a9:	e8 11 ff ff ff       	call   801081bf <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801082ae:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801082b5:	eb 48                	jmp    801082ff <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
801082c8:	83 e0 01             	and    $0x1,%eax
801082cb:	85 c0                	test   %eax,%eax
801082cd:	74 2c                	je     801082fb <freevm+0x80>
...
80108306:	76 af                	jbe    801082b7 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
80108308:	8b 45 08             	mov    0x8(%ebp),%eax
8010830b:	89 04 24             	mov    %eax,(%esp)
8010830e:	e8 2e a7 ff ff       	call   80102a41 <kfree>
}
80108313:	c9                   	leave  
80108314:	c3                   	ret    
...
80108318:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80108330:	e8 a8 f8 ff ff       	call   80107bdd <walkpgdir>
80108335:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108338:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010833c:	75 0c                	jne    8010834a <clearpteu+0x35>
    panic("clearpteu");
8010833e:	c7 04 24 f4 8b 10 80 	movl   $0x80108bf4,(%esp)
80108345:	e8 f0 81 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
8010834a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010834d:	8b 00                	mov    (%eax),%eax
8010834f:	83 e0 fb             	and    $0xfffffffb,%eax
80108352:	89 c2                	mov    %eax,%edx
80108354:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108357:	89 10                	mov    %edx,(%eax)
}
80108359:	c9                   	leave  
8010835a:	c3                   	ret    
...
8010835f:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108362:	e8 b0 f9 ff ff       	call   80107d17 <setupkvm>
80108367:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010836a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010836e:	75 0a                	jne    8010837a <copyuvm+0x1f>
    return 0;
80108370:	b8 00 00 00 00       	mov    $0x0,%eax
80108375:	e9 fd 00 00 00       	jmp    80108477 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
8010837a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108381:	e9 d0 00 00 00       	jmp    80108456 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108386:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108389:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108390:	00 
80108391:	89 44 24 04          	mov    %eax,0x4(%esp)
80108395:	8b 45 08             	mov    0x8(%ebp),%eax
80108398:	89 04 24             	mov    %eax,(%esp)
8010839b:	e8 3d f8 ff ff       	call   80107bdd <walkpgdir>
801083a0:	89 45 ec             	mov    %eax,-0x14(%ebp)
801083a3:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801083a7:	75 0c                	jne    801083b5 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801083a9:	c7 04 24 fe 8b 10 80 	movl   $0x80108bfe,(%esp)
801083b0:	e8 85 81 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
801083b5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083b8:	8b 00                	mov    (%eax),%eax
801083ba:	83 e0 01             	and    $0x1,%eax
801083bd:	85 c0                	test   %eax,%eax
801083bf:	75 0c                	jne    801083cd <copyuvm+0x72>
      panic("copyuvm: page not present");
801083c1:	c7 04 24 18 8c 10 80 	movl   $0x80108c18,(%esp)
801083c8:	e8 6d 81 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
801083e4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801083e7:	e8 ee a6 ff ff       	call   80102ada <kalloc>
801083ec:	89 45 e0             	mov    %eax,-0x20(%ebp)
801083ef:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801083f3:	75 02                	jne    801083f7 <copyuvm+0x9c>
      goto bad;
801083f5:	eb 70                	jmp    80108467 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
801083f7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801083fa:	89 04 24             	mov    %eax,(%esp)
801083fd:	e8 58 f3 ff ff       	call   8010775a <p2v>
80108402:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108409:	00 
8010840a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010840e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108411:	89 04 24             	mov    %eax,(%esp)
80108414:	e8 e8 cd ff ff       	call   80105201 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108419:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
8010841c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010841f:	89 04 24             	mov    %eax,(%esp)
80108422:	e8 26 f3 ff ff       	call   8010774d <v2p>
80108427:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010842a:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010842e:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80108444:	e8 36 f8 ff ff       	call   80107c7f <mappages>
80108449:	85 c0                	test   %eax,%eax
8010844b:	79 02                	jns    8010844f <copyuvm+0xf4>
      goto bad;
8010844d:	eb 18                	jmp    80108467 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010844f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108456:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108459:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010845c:	0f 82 24 ff ff ff    	jb     80108386 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108465:	eb 10                	jmp    80108477 <copyuvm+0x11c>

bad:
  freevm(d);
80108467:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010846a:	89 04 24             	mov    %eax,(%esp)
8010846d:	e8 09 fe ff ff       	call   8010827b <freevm>
  return 0;
80108472:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108477:	83 c4 44             	add    $0x44,%esp
8010847a:	5b                   	pop    %ebx
8010847b:	5d                   	pop    %ebp
8010847c:	c3                   	ret    
...
80108480:	83 ec 28             	sub    $0x28,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80108483:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010848a:	00 
8010848b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010848e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108492:	8b 45 08             	mov    0x8(%ebp),%eax
80108495:	89 04 24             	mov    %eax,(%esp)
80108498:	e8 40 f7 ff ff       	call   80107bdd <walkpgdir>
...
801084d3:	e8 82 f2 ff ff       	call   8010775a <p2v>
}
801084d8:	c9                   	leave  
801084d9:	c3                   	ret    
...
80108503:	e8 75 ff ff ff       	call   8010847d <uva2ka>
...
80108556:	e8 a6 cc ff ff       	call   80105201 <memmove>
    len -= n;
