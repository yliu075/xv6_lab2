...
main(int argc, char *argv[])
{
  ...
  1f:	b8 b8 0a 00 00       	mov    $0xab8,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 ba 0a 00 00       	mov    $0xaba,%eax
  ...
  45:	c7 44 24 04 bc 0a 00 	movl   $0xabc,0x4(%esp)
  4c:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 415:	0f b6 80 78 0e 00 00 	movzbl 0xe78(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 572:	75 09                	jne    57d <printf+0x101>
          s = "(null)";
 574:	c7 45 f4 c1 0a 00 00 	movl   $0xac1,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63e:	a1 98 0e 00 00       	mov    0xe98,%eax
...
free(void *ap)
{
 ...
 709:	a3 98 0e 00 00       	mov    %eax,0xe98
}
 70e:	c9                   	leave  
 70f:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75c:	e8 ce fe ff ff       	call   62f <free>
  return freep;
 761:	a1 98 0e 00 00       	mov    0xe98,%eax
}
 766:	c9                   	leave  
 767:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 77d:	a1 98 0e 00 00       	mov    0xe98,%eax
 782:	89 45 f0             	mov    %eax,-0x10(%ebp)
 785:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 789:	75 23                	jne    7ae <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78b:	c7 45 f0 90 0e 00 00 	movl   $0xe90,-0x10(%ebp)
 792:	8b 45 f0             	mov    -0x10(%ebp),%eax
 795:	a3 98 0e 00 00       	mov    %eax,0xe98
 79a:	a1 98 0e 00 00       	mov    0xe98,%eax
 79f:	a3 90 0e 00 00       	mov    %eax,0xe90
    base.s.size = 0;
 7a4:	c7 05 94 0e 00 00 00 	movl   $0x0,0xe94
 7ab:	00 00 00 
  }
 ...
 801:	a3 98 0e 00 00       	mov    %eax,0xe98
      return (void*)(p + 1);
 ...
 80c:	eb 38                	jmp    846 <malloc+0xde>
    ...
    if(p == freep)
 80e:	a1 98 0e 00 00       	mov    0xe98,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8ec:	c7 44 24 04 c8 0a 00 	movl   $0xac8,0x4(%esp)
 8f3:	00 
 ...
 931:	c7 44 24 04 d6 0a 00 	movl   $0xad6,0x4(%esp)
 938:	00 
 ...
 95d:	c7 44 24 04 e3 0a 00 	movl   $0xae3,0x4(%esp)
 964:	00 
...
int random(int max){
 ...
 97b:	a1 8c 0e 00 00       	mov    0xe8c,%eax
 980:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 986:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 98b:	a3 8c 0e 00 00       	mov    %eax,0xe8c
    return (int)(rands % max);
 990:	a1 8c 0e 00 00       	mov    0xe8c,%eax
