...
int main()
{
    ...
    1023:	c7 44 24 04 7f 1b 00 	movl   $0x1b7f,0x4(%esp)
    102a:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13ef:	0f b6 80 90 1f 00 00 	movzbl 0x1f90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    154c:	75 09                	jne    1557 <printf+0x101>
          s = "(null)";
    154e:	c7 45 f4 93 1b 00 00 	movl   $0x1b93,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1618:	a1 b0 1f 00 00       	mov    0x1fb0,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16e3:	a3 b0 1f 00 00       	mov    %eax,0x1fb0
}
    16e8:	c9                   	leave  
    16e9:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    173b:	a1 b0 1f 00 00       	mov    0x1fb0,%eax
}
    1740:	c9                   	leave  
    1741:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1757:	a1 b0 1f 00 00       	mov    0x1fb0,%eax
    175c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    175f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1763:	75 23                	jne    1788 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1765:	c7 45 f0 a8 1f 00 00 	movl   $0x1fa8,-0x10(%ebp)
    176c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    176f:	a3 b0 1f 00 00       	mov    %eax,0x1fb0
    1774:	a1 b0 1f 00 00       	mov    0x1fb0,%eax
    1779:	a3 a8 1f 00 00       	mov    %eax,0x1fa8
    base.s.size = 0;
    177e:	c7 05 ac 1f 00 00 00 	movl   $0x0,0x1fac
    1785:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17db:	a3 b0 1f 00 00       	mov    %eax,0x1fb0
      return (void*)(p + 1);
    ...
    if(p == freep)
    17e8:	a1 b0 1f 00 00       	mov    0x1fb0,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    if (inQ == 0) {
    18a0:	0f b6 05 b4 1f 00 00 	movzbl 0x1fb4,%eax
    18a7:	84 c0                	test   %al,%al
    18a9:	75 1c                	jne    18c7 <thread_create+0x42>
        init_q(thQ2);
    18ab:	a1 bc 1f 00 00       	mov    0x1fbc,%eax
    18b0:	89 04 24             	mov    %eax,(%esp)
    18b3:	e8 b2 01 00 00       	call   1a6a <init_q>
        inQ++;
    18b8:	0f b6 05 b4 1f 00 00 	movzbl 0x1fb4,%eax
    18bf:	83 c0 01             	add    $0x1,%eax
    18c2:	a2 b4 1f 00 00       	mov    %al,0x1fb4
    }
    ...
    18ed:	c7 44 24 04 9a 1b 00 	movl   $0x1b9a,0x4(%esp)
    18f4:	00 
    ...
    1935:	c7 44 24 04 a8 1b 00 	movl   $0x1ba8,0x4(%esp)
    193c:	00 
    ...
    1975:	c7 44 24 04 b5 1b 00 	movl   $0x1bb5,0x4(%esp)
    197c:	00 
...
void thread_yield2(){
    ...
    int tid2 = getpid();
    19c1:	e8 60 f9 ff ff       	call   1326 <getpid>
    ...
    1a3b:	e8 1e f9 ff ff       	call   135e <twakeup>
    tsleep();
    1a40:	e8 11 f9 ff ff       	call   1356 <tsleep>
...
void thread_yield_last(){
    ...
    1a63:	e8 f6 f8 ff ff       	call   135e <twakeup>
    1a68:	c9                   	leave  
    1a69:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1a99:	e8 a4 fc ff ff       	call   1742 <malloc>
...
int pop_q(struct queue *q){
    ...
    1b44:	e8 c0 fa ff ff       	call   1609 <free>
       q->size--;
