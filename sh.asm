...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    101b:	8b 04 85 e0 27 00 00 	mov    0x27e0(,%eax,4),%eax
    1022:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
    1024:	c7 04 24 b4 27 00 00 	movl   $0x27b4,(%esp)
  ...
  case EXEC:
    ...
    1067:	c7 44 24 04 bb 27 00 	movl   $0x27bb,0x4(%esp)
    106e:	00 
  ...
  case REDIR:
    ...
    10ba:	c7 44 24 04 cb 27 00 	movl   $0x27cb,0x4(%esp)
    10c1:	00 
  ...
  case PIPE:
    ...
    112e:	79 0c                	jns    113c <runcmd+0x13c>
      panic("pipe");
    1130:	c7 04 24 db 27 00 00 	movl   $0x27db,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
    1211:	c7 44 24 04 f8 27 00 	movl   $0x27f8,0x4(%esp)
    1218:	00 
    ...
    1287:	eb 1f                	jmp    12a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1290:	00 
    1291:	c7 04 24 fb 27 00 00 	movl   $0x27fb,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    12ad:	0f b6 05 00 2f 00 00 	movzbl 0x2f00,%eax
    12b4:	3c 63                	cmp    $0x63,%al
    12b6:	75 5c                	jne    1314 <main+0xab>
    12b8:	0f b6 05 01 2f 00 00 	movzbl 0x2f01,%eax
    12bf:	3c 64                	cmp    $0x64,%al
    12c1:	75 51                	jne    1314 <main+0xab>
    12c3:	0f b6 05 02 2f 00 00 	movzbl 0x2f02,%eax
    12ca:	3c 20                	cmp    $0x20,%al
    12cc:	75 46                	jne    1314 <main+0xab>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
    12ce:	c7 04 24 00 2f 00 00 	movl   $0x2f00,(%esp)
    12d5:	e8 b3 0a 00 00       	call   1d8d <strlen>
    12da:	83 e8 01             	sub    $0x1,%eax
    12dd:	c6 80 00 2f 00 00 00 	movb   $0x0,0x2f00(%eax)
      if(chdir(buf+3) < 0)
    12e4:	c7 04 24 03 2f 00 00 	movl   $0x2f03,(%esp)
    12eb:	e8 e1 0c 00 00       	call   1fd1 <chdir>
    12f0:	85 c0                	test   %eax,%eax
    12f2:	79 1e                	jns    1312 <main+0xa9>
        printf(2, "cannot cd %s\n", buf+3);
    12f4:	c7 44 24 08 03 2f 00 	movl   $0x2f03,0x8(%esp)
    12fb:	00 
    12fc:	c7 44 24 04 03 28 00 	movl   $0x2803,0x4(%esp)
    1303:	00 
    ...
    131b:	75 14                	jne    1331 <main+0xc8>
      runcmd(parsecmd(buf));
    131d:	c7 04 24 00 2f 00 00 	movl   $0x2f00,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    133d:	00 
    133e:	c7 04 24 00 2f 00 00 	movl   $0x2f00,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
    ...
    1364:	c7 44 24 04 11 28 00 	movl   $0x2811,0x4(%esp)
    136b:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
    1391:	c7 04 24 15 28 00 00 	movl   $0x2815,(%esp)
    ...
    1542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    155b:	c7 04 24 c4 2e 00 00 	movl   $0x2ec4,(%esp)
  ...
  default:
    ...
    1605:	c7 04 24 c4 2e 00 00 	movl   $0x2ec4,(%esp)
    ...
    1622:	c7 04 24 ca 2e 00 00 	movl   $0x2eca,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    1660:	c7 04 24 c4 2e 00 00 	movl   $0x2ec4,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    16a6:	c7 04 24 c4 2e 00 00 	movl   $0x2ec4,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
    1721:	c7 44 24 08 1a 28 00 	movl   $0x281a,0x8(%esp)
    1728:	00 
  ...
  if(s != es){
    ...
    174a:	c7 44 24 04 1b 28 00 	movl   $0x281b,0x4(%esp)
    1751:	00 
    1752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1759:	e8 b3 09 00 00       	call   2111 <printf>
    panic("syntax");
    175e:	c7 04 24 2a 28 00 00 	movl   $0x282a,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
    17cb:	c7 44 24 08 31 28 00 	movl   $0x2831,0x8(%esp)
    17d2:	00 
  ...
  if(peek(ps, es, ";")){
    17e9:	c7 44 24 08 33 28 00 	movl   $0x2833,0x8(%esp)
    17f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
    186d:	c7 44 24 08 35 28 00 	movl   $0x2835,0x8(%esp)
    1874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    192b:	c7 04 24 37 28 00 00 	movl   $0x2837,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    19d7:	c7 44 24 08 54 28 00 	movl   $0x2854,0x8(%esp)
    19de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    1a04:	c7 44 24 08 57 28 00 	movl   $0x2857,0x8(%esp)
    1a0b:	00 
    ...
    panic("parseblock");
    1a22:	c7 04 24 59 28 00 00 	movl   $0x2859,(%esp)
  ...
  if(!peek(ps, es, ")"))
    1a65:	c7 44 24 08 64 28 00 	movl   $0x2864,0x8(%esp)
    1a6c:	00 
    ...
    1a83:	c7 04 24 66 28 00 00 	movl   $0x2866,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    1ad8:	c7 44 24 08 57 28 00 	movl   $0x2857,0x8(%esp)
    1adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    1b75:	74 0c                	je     1b83 <parseexec+0xb1>
      panic("syntax");
    1b77:	c7 04 24 2a 28 00 00 	movl   $0x282a,(%esp)
    ...
    1ba8:	7e 0c                	jle    1bb6 <parseexec+0xe4>
      panic("too many args");
    1baa:	c7 04 24 79 28 00 00 	movl   $0x2879,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
    1bd2:	c7 44 24 08 87 28 00 	movl   $0x2887,0x8(%esp)
    1bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1c3c:	8b 04 85 8c 28 00 00 	mov    0x288c(,%eax,4),%eax
    1c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    20aa:	0f b6 80 d2 2e 00 00 	movzbl 0x2ed2(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    2207:	75 09                	jne    2212 <printf+0x101>
          s = "(null)";
    2209:	c7 45 f4 a4 28 00 00 	movl   $0x28a4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    22d3:	a1 6c 2f 00 00       	mov    0x2f6c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    239e:	a3 6c 2f 00 00       	mov    %eax,0x2f6c
}
    23a3:	c9                   	leave  
    23a4:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    23f6:	a1 6c 2f 00 00       	mov    0x2f6c,%eax
}
    23fb:	c9                   	leave  
    23fc:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    2412:	a1 6c 2f 00 00       	mov    0x2f6c,%eax
    2417:	89 45 f0             	mov    %eax,-0x10(%ebp)
    241a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    241e:	75 23                	jne    2443 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    2420:	c7 45 f0 64 2f 00 00 	movl   $0x2f64,-0x10(%ebp)
    2427:	8b 45 f0             	mov    -0x10(%ebp),%eax
    242a:	a3 6c 2f 00 00       	mov    %eax,0x2f6c
    242f:	a1 6c 2f 00 00       	mov    0x2f6c,%eax
    2434:	a3 64 2f 00 00       	mov    %eax,0x2f64
    base.s.size = 0;
    2439:	c7 05 68 2f 00 00 00 	movl   $0x0,0x2f68
    2440:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    2496:	a3 6c 2f 00 00       	mov    %eax,0x2f6c
      return (void*)(p + 1);
    ...
    if(p == freep)
    24a3:	a1 6c 2f 00 00       	mov    0x2f6c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    if (inQ == 0) {
    255b:	0f b6 05 70 2f 00 00 	movzbl 0x2f70,%eax
    2562:	84 c0                	test   %al,%al
    2564:	75 1c                	jne    2582 <thread_create+0x42>
        init_q(thQ2);
    2566:	a1 74 2f 00 00       	mov    0x2f74,%eax
    256b:	89 04 24             	mov    %eax,(%esp)
    256e:	e8 2c 01 00 00       	call   269f <init_q>
        inQ++;
    2573:	0f b6 05 70 2f 00 00 	movzbl 0x2f70,%eax
    257a:	83 c0 01             	add    $0x1,%eax
    257d:	a2 70 2f 00 00       	mov    %al,0x2f70
    }
    ...
    25a8:	c7 44 24 04 ab 28 00 	movl   $0x28ab,0x4(%esp)
    25af:	00 
    ...
    25f0:	c7 44 24 04 b9 28 00 	movl   $0x28b9,0x4(%esp)
    25f7:	00 
    ...
    2630:	c7 44 24 04 c6 28 00 	movl   $0x28c6,0x4(%esp)
    2637:	00 
...
int random(int max){
    ...
    264e:	a1 e4 2e 00 00       	mov    0x2ee4,%eax
    2653:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    2659:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    265e:	a3 e4 2e 00 00       	mov    %eax,0x2ee4
    return (int)(rands % max);
    2663:	a1 e4 2e 00 00       	mov    0x2ee4,%eax
...
void thread_yield2(){
    ...
    2679:	83 ec 18             	sub    $0x18,%esp
    printf(1,"My PID: %d \n", proc->pid);
    267c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    2682:	8b 40 10             	mov    0x10(%eax),%eax
    2685:	89 44 24 08          	mov    %eax,0x8(%esp)
    2689:	c7 44 24 04 d7 28 00 	movl   $0x28d7,0x4(%esp)
    2690:	00 
    2691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2698:	e8 74 fa ff ff       	call   2111 <printf>
    */
    //add_q(thQ2, tid2);
    //proc->state = RUNNABLE;
...
void init_q(struct queue *q){
    ...
    26a5:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    26ab:	8b 45 08             	mov    0x8(%ebp),%eax
    26ae:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    26b5:	8b 45 08             	mov    0x8(%ebp),%eax
    26b8:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    26bf:	5d                   	pop    %ebp
    26c0:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    26c1:	55                   	push   %ebp
    26c2:	89 e5                	mov    %esp,%ebp
    26c4:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    26c7:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    26ce:	e8 2a fd ff ff       	call   23fd <malloc>
    26d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    26d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    26d9:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    26e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    26e3:	8b 55 0c             	mov    0xc(%ebp),%edx
    26e6:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    26e8:	8b 45 08             	mov    0x8(%ebp),%eax
    26eb:	8b 40 04             	mov    0x4(%eax),%eax
    26ee:	85 c0                	test   %eax,%eax
    26f0:	75 0b                	jne    26fd <add_q+0x3c>
        q->head = n;
    26f2:	8b 45 08             	mov    0x8(%ebp),%eax
    26f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    26f8:	89 50 04             	mov    %edx,0x4(%eax)
    26fb:	eb 0c                	jmp    2709 <add_q+0x48>
    }else{
        q->tail->next = n;
    26fd:	8b 45 08             	mov    0x8(%ebp),%eax
    2700:	8b 40 08             	mov    0x8(%eax),%eax
    2703:	8b 55 f4             	mov    -0xc(%ebp),%edx
    2706:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    2709:	8b 45 08             	mov    0x8(%ebp),%eax
    270c:	8b 55 f4             	mov    -0xc(%ebp),%edx
    270f:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    2712:	8b 45 08             	mov    0x8(%ebp),%eax
    2715:	8b 00                	mov    (%eax),%eax
    2717:	8d 50 01             	lea    0x1(%eax),%edx
    271a:	8b 45 08             	mov    0x8(%ebp),%eax
    271d:	89 10                	mov    %edx,(%eax)
}
    271f:	c9                   	leave  
    2720:	c3                   	ret    
...
int pop_q(struct queue *q){
    273b:	55                   	push   %ebp
    273c:	89 e5                	mov    %esp,%ebp
    273e:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    2741:	8b 45 08             	mov    0x8(%ebp),%eax
    2744:	89 04 24             	mov    %eax,(%esp)
    2747:	e8 d5 ff ff ff       	call   2721 <empty_q>
    274c:	85 c0                	test   %eax,%eax
    274e:	75 5d                	jne    27ad <pop_q+0x72>
       val = q->head->value; 
    2750:	8b 45 08             	mov    0x8(%ebp),%eax
    2753:	8b 40 04             	mov    0x4(%eax),%eax
    2756:	8b 00                	mov    (%eax),%eax
    2758:	89 45 f4             	mov    %eax,-0xc(%ebp)
       destroy = q->head;
    275b:	8b 45 08             	mov    0x8(%ebp),%eax
    275e:	8b 40 04             	mov    0x4(%eax),%eax
    2761:	89 45 f0             	mov    %eax,-0x10(%ebp)
       q->head = q->head->next;
    2764:	8b 45 08             	mov    0x8(%ebp),%eax
    2767:	8b 40 04             	mov    0x4(%eax),%eax
    276a:	8b 50 04             	mov    0x4(%eax),%edx
    276d:	8b 45 08             	mov    0x8(%ebp),%eax
    2770:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    2773:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2776:	89 04 24             	mov    %eax,(%esp)
    2779:	e8 46 fb ff ff       	call   22c4 <free>
       q->size--;
    277e:	8b 45 08             	mov    0x8(%ebp),%eax
    2781:	8b 00                	mov    (%eax),%eax
    2783:	8d 50 ff             	lea    -0x1(%eax),%edx
    2786:	8b 45 08             	mov    0x8(%ebp),%eax
    2789:	89 10                	mov    %edx,(%eax)
       if(q->size == 0){
    278b:	8b 45 08             	mov    0x8(%ebp),%eax
    278e:	8b 00                	mov    (%eax),%eax
    2790:	85 c0                	test   %eax,%eax
    2792:	75 14                	jne    27a8 <pop_q+0x6d>
            q->head = 0;
    2794:	8b 45 08             	mov    0x8(%ebp),%eax
    2797:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    279e:	8b 45 08             	mov    0x8(%ebp),%eax
    27a1:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    27a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    27ab:	eb 05                	jmp    27b2 <pop_q+0x77>
    }
    return -1;
