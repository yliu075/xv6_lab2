...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 4a 0b 00 	movl   $0xb4a,0x4(%esp)
  16:	00 
  ...
  66:	c7 44 24 04 5e 0b 00 	movl   $0xb5e,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 440:	0f b6 80 5c 0f 00 00 	movzbl 0xf5c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 59d:	75 09                	jne    5a8 <printf+0x101>
          s = "(null)";
 59f:	c7 45 f4 77 0b 00 00 	movl   $0xb77,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 669:	a1 7c 0f 00 00       	mov    0xf7c,%eax
...
free(void *ap)
{
 ...
 734:	a3 7c 0f 00 00       	mov    %eax,0xf7c
}
 739:	c9                   	leave  
 73a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 787:	e8 ce fe ff ff       	call   65a <free>
  return freep;
 78c:	a1 7c 0f 00 00       	mov    0xf7c,%eax
}
 791:	c9                   	leave  
 792:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7a5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7a8:	a1 7c 0f 00 00       	mov    0xf7c,%eax
 7ad:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7b0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7b4:	75 23                	jne    7d9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 45 f0 74 0f 00 00 	movl   $0xf74,-0x10(%ebp)
 7bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c0:	a3 7c 0f 00 00       	mov    %eax,0xf7c
 7c5:	a1 7c 0f 00 00       	mov    0xf7c,%eax
 7ca:	a3 74 0f 00 00       	mov    %eax,0xf74
    base.s.size = 0;
 7cf:	c7 05 78 0f 00 00 00 	movl   $0x0,0xf78
 7d6:	00 00 00 
  }
 ...
 82c:	a3 7c 0f 00 00       	mov    %eax,0xf7c
      return (void*)(p + 1);
 ...
 837:	eb 38                	jmp    871 <malloc+0xde>
    ...
    if(p == freep)
 839:	a1 7c 0f 00 00       	mov    0xf7c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8ee:	89 45 f0             	mov    %eax,-0x10(%ebp)
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    if (inQ == 0) {
 8f1:	0f b6 05 80 0f 00 00 	movzbl 0xf80,%eax
 8f8:	84 c0                	test   %al,%al
 8fa:	75 1c                	jne    918 <thread_create+0x42>
        init_q(thQ2);
 8fc:	a1 84 0f 00 00       	mov    0xf84,%eax
 901:	89 04 24             	mov    %eax,(%esp)
 904:	e8 2c 01 00 00       	call   a35 <init_q>
        inQ++;
 909:	0f b6 05 80 0f 00 00 	movzbl 0xf80,%eax
 910:	83 c0 01             	add    $0x1,%eax
 913:	a2 80 0f 00 00       	mov    %al,0xf80
    }
 ...
 93e:	c7 44 24 04 7e 0b 00 	movl   $0xb7e,0x4(%esp)
 945:	00 
 ...
 986:	c7 44 24 04 8c 0b 00 	movl   $0xb8c,0x4(%esp)
 98d:	00 
 ...
 9c6:	c7 44 24 04 99 0b 00 	movl   $0xb99,0x4(%esp)
 9cd:	00 
...
int random(int max){
 ...
 9e4:	a1 70 0f 00 00       	mov    0xf70,%eax
 9e9:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 9ef:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 9f4:	a3 70 0f 00 00       	mov    %eax,0xf70
    return (int)(rands % max);
 9f9:	a1 70 0f 00 00       	mov    0xf70,%eax
...
void thread_yield2(){
 ...
 a1f:	c7 44 24 04 aa 0b 00 	movl   $0xbaa,0x4(%esp)
 a26:	00 
 a27:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a2e:	e8 74 fa ff ff       	call   4a7 <printf>
    */
    //add_q(thQ2, tid2);
    //proc->state = RUNNABLE;
...
void init_q(struct queue *q){
 ...
 a3b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
 a41:	8b 45 08             	mov    0x8(%ebp),%eax
 a44:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
 a4b:	8b 45 08             	mov    0x8(%ebp),%eax
 a4e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
 a55:	5d                   	pop    %ebp
 a56:	c3                   	ret    
...
int empty_q(struct queue *q){
 ...
 ac1:	75 07                	jne    aca <empty_q+0x13>
        return 1;
 ac3:	b8 01 00 00 00       	mov    $0x1,%eax
 ac8:	eb 05                	jmp    acf <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
 ...
 add:	e8 d5 ff ff ff       	call   ab7 <empty_q>
 ae2:	85 c0                	test   %eax,%eax
 ae4:	75 5d                	jne    b43 <pop_q+0x72>
       val = q->head->value; 
 ...
 b0f:	e8 46 fb ff ff       	call   65a <free>
       q->size--;
 b14:	8b 45 08             	mov    0x8(%ebp),%eax
 b17:	8b 00                	mov    (%eax),%eax
 b19:	8d 50 ff             	lea    -0x1(%eax),%edx
 ...
 b28:	75 14                	jne    b3e <pop_q+0x6d>
            q->head = 0;
 b2a:	8b 45 08             	mov    0x8(%ebp),%eax
 b2d:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
 b34:	8b 45 08             	mov    0x8(%ebp),%eax
 b37:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
 b3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b41:	eb 05                	jmp    b48 <pop_q+0x77>
    }
    return -1;
