...
int main(int argc, char *argv[]){
   ...
   9:	c7 44 24 04 2b 0b 00 	movl   $0xb2b,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 d2 04 00 00       	call   4ef <printf>

   printf(1,"before thread_create n = %d\n",n);
  1d:	a1 74 0f 00 00       	mov    0xf74,%eax
  22:	89 44 24 08          	mov    %eax,0x8(%esp)
  26:	c7 44 24 04 46 0b 00 	movl   $0xb46,0x4(%esp)
  2d:	00 
  ...
  61:	c7 44 24 04 63 0b 00 	movl   $0xb63,0x4(%esp)
  68:	00 
  ...
  7a:	eb 1d                	jmp    99 <main+0x99>
   printf(1,"\nback to parent n = %d\n",n);
  7c:	a1 74 0f 00 00       	mov    0xf74,%eax
  81:	89 44 24 08          	mov    %eax,0x8(%esp)
  85:	c7 44 24 04 70 0b 00 	movl   $0xb70,0x4(%esp)
  8c:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 488:	0f b6 80 78 0f 00 00 	movzbl 0xf78(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5e5:	75 09                	jne    5f0 <printf+0x101>
          s = "(null)";
 5e7:	c7 45 f4 9e 0b 00 00 	movl   $0xb9e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 98 0f 00 00       	mov    0xf98,%eax
...
free(void *ap)
{
 ...
 77c:	a3 98 0f 00 00       	mov    %eax,0xf98
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7cf:	e8 ce fe ff ff       	call   6a2 <free>
  return freep;
 7d4:	a1 98 0f 00 00       	mov    0xf98,%eax
}
 7d9:	c9                   	leave  
 7da:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ed:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7f0:	a1 98 0f 00 00       	mov    0xf98,%eax
 7f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7f8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7fc:	75 23                	jne    821 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7fe:	c7 45 f0 90 0f 00 00 	movl   $0xf90,-0x10(%ebp)
 805:	8b 45 f0             	mov    -0x10(%ebp),%eax
 808:	a3 98 0f 00 00       	mov    %eax,0xf98
 80d:	a1 98 0f 00 00       	mov    0xf98,%eax
 812:	a3 90 0f 00 00       	mov    %eax,0xf90
    base.s.size = 0;
 817:	c7 05 94 0f 00 00 00 	movl   $0x0,0xf94
 81e:	00 00 00 
  }
 ...
 874:	a3 98 0f 00 00       	mov    %eax,0xf98
      return (void*)(p + 1);
 ...
 87f:	eb 38                	jmp    8b9 <malloc+0xde>
    ...
    if(p == freep)
 881:	a1 98 0f 00 00       	mov    0xf98,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 95f:	c7 44 24 04 a5 0b 00 	movl   $0xba5,0x4(%esp)
 966:	00 
 ...
 9a4:	c7 44 24 04 b3 0b 00 	movl   $0xbb3,0x4(%esp)
 9ab:	00 
 ...
 9d0:	c7 44 24 04 c0 0b 00 	movl   $0xbc0,0x4(%esp)
 9d7:	00 
...
int random(int max){
 ...
 9ee:	a1 8c 0f 00 00       	mov    0xf8c,%eax
 9f3:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 9f9:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 9fe:	a3 8c 0f 00 00       	mov    %eax,0xf8c
    return (int)(rands % max);
 a03:	a1 8c 0f 00 00       	mov    0xf8c,%eax
 a08:	8b 4d 08             	mov    0x8(%ebp),%ecx
 a0b:	ba 00 00 00 00       	mov    $0x0,%edx
 a10:	f7 f1                	div    %ecx
 a12:	89 d0                	mov    %edx,%eax
}
 a14:	5d                   	pop    %ebp
 a15:	c3                   	ret    
...
int empty_q(struct queue *q){
 ...
 aa2:	75 07                	jne    aab <empty_q+0x13>
        return 1;
 aa4:	b8 01 00 00 00       	mov    $0x1,%eax
 aa9:	eb 05                	jmp    ab0 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
 ...
 abe:	e8 d5 ff ff ff       	call   a98 <empty_q>
 ac3:	85 c0                	test   %eax,%eax
 ac5:	75 5d                	jne    b24 <pop_q+0x72>
       val = q->head->value; 
 ...
 af0:	e8 ad fb ff ff       	call   6a2 <free>
       q->size--;
 af5:	8b 45 08             	mov    0x8(%ebp),%eax
 af8:	8b 00                	mov    (%eax),%eax
 afa:	8d 50 ff             	lea    -0x1(%eax),%edx
 ...
 b09:	75 14                	jne    b1f <pop_q+0x6d>
            q->head = 0;
 b0b:	8b 45 08             	mov    0x8(%ebp),%eax
 b0e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
 b15:	8b 45 08             	mov    0x8(%ebp),%eax
 b18:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
 b1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b22:	eb 05                	jmp    b29 <pop_q+0x77>
    }
    return -1;
